...
.method public run()V
    ...
    invoke-direct {v3, v1, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh$o$a;-><init>(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh$o;LSi/d;)V

    invoke-interface {v2, v3}, Ljava/lang/Iterable;->forEach(Ljava/util/function/Consumer;)V

    invoke-virtual {v0}, LSi/d;->g()I

    move-result v2

    if-lez v2, :cond_5

    invoke-virtual {v0}, LSi/d;->f()V

    new-instance v2, LEi/y;

    invoke-direct {v2}, LEi/y;-><init>()V

    iget-object v3, v2, LEi/y;->a:[F

    invoke-virtual {v0}, LSi/d;->b()[F
    ...
    iput v3, v2, LEi/y;->d:I

    new-instance v11, LEi/v;

    invoke-direct {v11, v2}, LEi/v;-><init>(LEi/y;)V

    new-instance v36, LRi/t;
    ...
    invoke-static {v2, v3}, LRi/t;->a(FF)I

    move-result v16

    sget-object v17, LRi/u$a;->WATERSHED:LRi/u$a;
    ...
    invoke-direct/range {v12 .. v35}, LRi/t;-><init>(ZIIILRi/u$a;FFFZZZFFFFFFFIZFFLRi/a;)V

    new-instance v12, LEi/T;

    invoke-direct {v12}, LEi/T;-><init>()V

    invoke-virtual {v0}, LSi/d;->b()[F

    move-result-object v13

    invoke-virtual {v0}, LSi/d;->c()[F
    ...
    invoke-static {v13, v14, v2, v3, v4}, LRi/m;->c([F[FFII)[I
    ...
    invoke-direct/range {v3 .. v8}, LRi/q;-><init>(LRi/t;[F[FII)V
    ...
    invoke-virtual/range {v2 .. v10}, LEi/T;->b(LSi/c;LRi/q;FFFIIZ)LEi/q;
    ...
    :try_start_1
    invoke-virtual {v11, v2, v15, v3, v4}, LEi/v;->c(LEi/q;IJ)J
    :try_end_1
    ...
    :goto_4
    invoke-virtual {v11}, LEi/v;->x()I

    move-result v3

    if-ge v15, v3, :cond_4

    invoke-virtual {v11, v15}, LEi/v;->I(I)LEi/s;
    ...
    invoke-virtual {v11}, LEi/v;->N()I

    move-result v4

    invoke-static {v3, v11, v4, v2}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->access$1200(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;LEi/v;II)V
    ...
    invoke-static {v3, v11, v4, v2}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->access$1300(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;LEi/v;II)V

    new-instance v3, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh$o$c;

    invoke-direct {v3, v1, v11, v2, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh$o$c;-><init>(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh$o;LEi/v;ILSi/d;)V
