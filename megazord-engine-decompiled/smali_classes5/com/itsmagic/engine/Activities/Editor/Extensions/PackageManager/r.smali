...
.method public static b(Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r$b;)I
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r$b;->u()I

    move-result v2

    if-ge v1, v2, :cond_0

    invoke-virtual {p0, v1}, Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r$b;->s(I)Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r$b;
...
.method public static f(Ljava/lang/String;ZLjava/util/Map;Ljava/util/List;Ljava/util/Set;)V
    ...
    :cond_8
    invoke-virtual {v1, v5}, Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r$b;->r(Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r$b;)V
...
.method public static h(Ljava/io/File;)Ljava/util/List;
    ...
    invoke-direct {v3, p0}, LMg/a;-><init>(Ljava/io/File;)V
    :try_end_0
    ...
    invoke-static {v5, v0, v2, v1}, Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r;->k(LTg/j;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;)V
    :try_end_1
...
.method public static i(Ljava/io/InputStream;)Ljava/util/List;
    ...
    invoke-direct {v3, v0}, LMg/a;-><init>(Ljava/io/File;)V
    ...
    invoke-static {v5, v1, p0, v2}, Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/r;->k(LTg/j;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;)V
    :try_end_1
...
.method public static k(LTg/j;Ljava/util/Map;Ljava/util/List;Ljava/util/Set;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
