...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v6}, Lqh/m;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILkotlin/jvm/internal/x;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    invoke-direct {p0, p1, p2}, Lqh/m;->C(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public synthetic constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILkotlin/jvm/internal/x;)V
    ...
    .line 5
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lqh/m;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final C(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Lqh/m;->n1:Landroid/graphics/drawable/Drawable;
...
.method public d0()V
    ...
    iget-object v1, p0, Lqh/m;->n1:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_0

    invoke-static {v1}, Lkotlin/jvm/internal/M;->m(Ljava/lang/Object;)V

    invoke-virtual {p0}, Lqh/v;->getViewLeft()F
    ...
    invoke-virtual {p0}, Lqh/v;->getViewTop()F
    ...
    invoke-virtual {p0}, Lqh/v;->getViewRight()F
    ...
    invoke-virtual {p0}, Lqh/v;->getViewBottom()F
...
.method public final getImageSpeedometer()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lqh/m;->n1:Landroid/graphics/drawable/Drawable;
...
.method public o0()V
    ...
    invoke-virtual {p0, v0}, Lqh/v;->setBackgroundCircleColor(I)V
...
.method public final setImageSpeedometer(I)V
    ...
    invoke-virtual {p0, p1}, Lqh/m;->setImageSpeedometer(Landroid/graphics/drawable/Drawable;)V
...
.method public final setImageSpeedometer(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0, v0}, Lqh/m;->setImageSpeedometer(Landroid/graphics/drawable/Drawable;)V
...
.method public final setImageSpeedometer(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2
    iput-object p1, p0, Lqh/m;->n1:Landroid/graphics/drawable/Drawable;
