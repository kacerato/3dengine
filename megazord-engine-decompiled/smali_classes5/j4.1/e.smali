...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj4/e;->a:Ljava/util/List;
...
.method public static a(Ljava/lang/String;Lcom/itsmagic/engine/Core/Components/PackageBuilder/BuilderUtils/BuildDictionary;Ljava/io/File;Lj4/e$e;)V
    .locals 7
    ...
    :cond_1
    invoke-static {p0, p1, v3, p3}, Lj4/e;->a(Ljava/lang/String;Lcom/itsmagic/engine/Core/Components/PackageBuilder/BuilderUtils/BuildDictionary;Ljava/io/File;Lj4/e$e;)V
    ...
    invoke-interface {p3, v3}, Lj4/e$e;->a(Ljava/io/File;)V
    ...
    invoke-virtual {v4, p1}, Lcom/itsmagic/engine/Engines/Engine/World/World;->v(Lcom/itsmagic/engine/Core/Components/PackageBuilder/BuilderUtils/BuildDictionary;)V
    ...
    invoke-static {v4, v5, v1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->c0(Ljava/lang/String;ZZ)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    invoke-static {v3, v4}, Lp8/a;->i(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->z(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Material/Material;
    ...
    invoke-virtual {v4, v0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->k0(Landroid/content/Context;)Ljava/lang/String;
...
.method public static b(Ljava/io/File;Ljava/io/File;Lj4/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {v0, p0, p1}, Lj4/e$c;-><init>(Ljava/io/File;Ljava/io/File;)V

    invoke-static {v0, p2}, Lj4/e;->c(Ljava/util/List;Lj4/a;)V

    return-void
.end method

.method public static c(Ljava/util/List;Lj4/a;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {v2, p1, v0, p0}, Lj4/b;-><init>(Lj4/a;Ljava/lang/String;Ljava/util/List;)V

    sget-object p0, Lj4/e;->a:Ljava/util/List;
...
.method public static d()I
    ...
    sget-object v0, Lj4/e;->b:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lj4/e;->a:Ljava/util/List;
...
.method public static e(Ljava/io/File;Ljava/lang/String;Lj4/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    new-instance p1, Lj4/e$b;

    invoke-direct {p1, p0, v0}, Lj4/e$b;-><init>(Ljava/io/File;Ljava/io/File;)V

    invoke-static {p1, p2}, Lj4/e;->c(Ljava/util/List;Lj4/a;)V

    return-void
.end method

.method public static f(Ljava/lang/String;Lcom/itsmagic/engine/Core/Components/PackageBuilder/BuilderUtils/BuildDictionary;Ljava/io/File;ZLj4/e$e;)V
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p3, p1}, Lcom/itsmagic/engine/Engines/Engine/World/World;->v(Lcom/itsmagic/engine/Core/Components/PackageBuilder/BuilderUtils/BuildDictionary;)V
    ...
    invoke-interface {p4, v3}, Lj4/e$e;->a(Ljava/io/File;)V
    ...
    :cond_5
    invoke-static {p0, p1, p2, p4}, Lj4/e;->a(Ljava/lang/String;Lcom/itsmagic/engine/Core/Components/PackageBuilder/BuilderUtils/BuildDictionary;Ljava/io/File;Lj4/e$e;)V

    if-eqz p3, :cond_6

    new-instance p0, Lj4/e$d;

    invoke-direct {p0, v2}, Lj4/e$d;-><init>(Ljava/lang/String;)V
...
.method public static g()V
    ...
    sget-object v3, Lj4/e;->c:Lj4/f;

    iput-object v3, v2, Lj4/c;->c:Lj4/f;

    iget-boolean v3, v2, Lj4/c;->a:Z

    if-nez v3, :cond_0

    invoke-virtual {v2}, Lj4/c;->d()V

    new-instance v3, Lj4/d;

    invoke-direct {v3, v2}, Lj4/d;-><init>(Lj4/c;)V

    invoke-static {v3}, Lga/b;->d(Ljava/lang/Runnable;)V

    const/4 v3, 0x1

    iput-boolean v3, v2, Lj4/c;->a:Z
    ...
    :cond_0
    invoke-virtual {v2}, Lj4/c;->f()V

    :goto_0
    invoke-virtual {v2}, Lj4/c;->c()Z
