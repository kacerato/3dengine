...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LD5/d$h;->onClick(Landroid/view/View;Landroid/content/Context;Le8/c;)V
.end annotation
...
# instance fields
.field public final synthetic b:LD5/d$h;


# direct methods
.method public constructor <init>(LD5/d$h;)V
    .locals 0
    ...
    iput-object p1, p0, LD5/d$h$a;->b:LD5/d$h;
...
.method public run()V
    ...
    iget-object v6, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v6, v6, LD5/d$h;->a:LD5/d;

    invoke-static {v6}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
    ...
    iget-object v7, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v7, v7, LD5/d$h;->a:LD5/d;

    invoke-static {v7}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;

    move-result-object v7

    iget v7, v7, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;->maxHeight:F

    iget-object v8, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v8, v8, LD5/d$h;->a:LD5/d;

    invoke-static {v8}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
    ...
    iget-object v4, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v4, v4, LD5/d$h;->a:LD5/d;

    invoke-static {v4}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
    ...
    iget-object v5, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v5, v5, LD5/d$h;->a:LD5/d;

    invoke-static {v5}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
    ...
    iget-object v2, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v2, v2, LD5/d$h;->a:LD5/d;

    invoke-static {v2}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
    ...
    iget-object v3, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v3, v3, LD5/d$h;->a:LD5/d;

    invoke-static {v3}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;->getWorldY(FF)F
    ...
    iget-object v1, p0, LD5/d$h$a;->b:LD5/d$h;

    iget-object v1, v1, LD5/d$h;->a:LD5/d;

    invoke-static {v1}, LD5/d;->H(LD5/d;)Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Terrain/Terrain;
