...
.method private isNegativePressed()Z
    ...
    invoke-virtual {v0, v1}, LKc/a$f;->l(Ljava/lang/String;)Z
...
.method private setAxisValue(F)V
    ...
    invoke-virtual {v0, v3, p1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    goto :goto_0

    :cond_1
    invoke-virtual {v0, p1, v3}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V
...
.method public parallelUpdate()V
    ...
    invoke-static {v0}, LKc/a;->D(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Input/Axis;
