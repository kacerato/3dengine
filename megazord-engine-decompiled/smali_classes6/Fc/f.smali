...
.method public static synthetic b(Z)Z
    ...
    sput-boolean p0, LFc/f;->a:Z

    return p0
.end method

.method public static c(Ljava/io/File;LFc/f$c;)V
    .locals 1
    ...
    invoke-static {p0}, Lxc/b;->n(Ljava/io/File;)V
    ...
    :try_start_0
    invoke-interface {p1, v0}, LFc/f$c;->a(I)V

    invoke-static {}, LM9/b;->l()V

    invoke-interface {p1}, LFc/f$c;->b()V

    invoke-static {}, LM9/b;->n()V

    invoke-interface {p1}, LFc/f$c;->b()V

    invoke-static {}, LM9/b;->p()V
    ...
    invoke-static {}, LG9/a;->g()V

    invoke-interface {p1}, LFc/f$c;->b()V

    invoke-static {}, Lma/g;->e()V

    invoke-interface {p1}, LFc/f$c;->b()V

    invoke-static {}, Lyc/d;->d()V
    ...
    invoke-direct {v0, p1}, LFc/f$a;-><init>(LFc/f$c;)V

    invoke-static {v0}, Lnc/d;->c(Lnc/d$c;)V
    :try_end_0
...
.method public static d(LFc/f$c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-interface {p0, v0}, LFc/f$c;->a(I)V

    sget-boolean v0, LFc/f;->a:Z
    ...
    invoke-direct {v0, p0}, LFc/f$b;-><init>(LFc/f$c;)V

    invoke-static {v0}, Lnc/d;->b(Le6/b$b;)V
    ...
    :cond_0
    sget-boolean v0, LFc/f;->b:Z

    if-nez v0, :cond_1

    invoke-static {}, LM9/b;->b()V

    sput-boolean v1, LFc/f;->b:Z
    ...
    invoke-interface {p0}, LFc/f$c;->b()V

    return v1

    :cond_1
    sget-boolean v0, LFc/f;->c:Z

    if-nez v0, :cond_2

    invoke-static {}, LM9/b;->c()V

    sput-boolean v1, LFc/f;->c:Z
    ...
    :cond_2
    sget-boolean v0, LFc/f;->d:Z

    if-nez v0, :cond_3

    invoke-static {}, LM9/b;->a()V

    sput-boolean v1, LFc/f;->d:Z
