...
.field private objectReference:Lna/p;
    .annotation runtime Lcom/google/gson/annotations/Expose;
    .end annotation
.end field
...
.field private rectObject:Lka/b;
    .annotation runtime Lcom/google/gson/annotations/Expose;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    .line 3
    sget-object v1, Lka/b;->MySelf:Lka/b;

    iput-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->M:Loa/c;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->R:Lna/k;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->objectReference:Lna/p;
...
.method public static synthetic access$502(Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;Lka/b;)Lka/b;
    .locals 0

    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;

    return-object p1
.end method

.method private addSelectedTouch(LMc/h;ILka/c;)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iput-object p3, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->P:Lka/c;
...
.method private clearSelectedTouches()V
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->P:Lka/c;
...
.method private processLocalTouch(LMc/h;ILcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;Z)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->removeSelectedTouch(LMc/h;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/itsmagic/engine/Activities/Editor/Interface/PanelsController;->W(LMc/h;)Z
    ...
    invoke-virtual {p3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;->getControllerScreenRect()Loa/c;

    move-result-object p3

    iget-object p4, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->M:Loa/c;

    invoke-static {p1, p3, p4}, Lna/m;->e(LMc/h;Loa/c;Loa/c;)Z

    move-result p3

    if-eqz p3, :cond_5

    iget-object p3, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->P:Lka/c;

    invoke-direct {p0, p1, p2, p3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->addSelectedTouch(LMc/h;ILka/c;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->isSelectedTouch(LMc/h;)Z
...
.method private removeSelectedTouch(LMc/h;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method private updateListeners()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->getFirstTouch()LMc/h;
    ...
    invoke-virtual {v2, v0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/BaseComponents/ImGuiRenderableComponent;->onSelectedTouchChanged(LMc/h;)V
...
.method public afterTouchUpdate()V
    ...
    invoke-direct {p0, v3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->removeSelectedTouch(LMc/h;)Z
    ...
    :cond_3
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->R:Lna/k;

    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->isOver()Z

    move-result v1

    invoke-virtual {v0, v1}, Lna/k;->d(Z)V

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->R:Lna/k;

    invoke-virtual {v0}, Lna/k;->e()Z
...
.method public clone()Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;
    ...
    .line 4
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;

    iput-object v1, v0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;

    .line 5
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->objectReference:Lna/p;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lna/p;->k()Lna/p;
    ...
    :goto_0
    iput-object v1, v0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->objectReference:Lna/p;
...
.method public createRectRef(Landroid/content/Context;Ljava/lang/String;)LW5/b;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-object p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;

    sget-object v0, Lka/b;->MySelf:Lka/b;

    if-eq p2, v0, :cond_1

    sget-object v0, Lka/b;->Parent:Lka/b;
    ...
    invoke-direct {p2, v2, v0, v1}, LW5/b;-><init>(Ljava/lang/String;LW5/b$a;[LW5/b;)V

    iget-object v0, p2, LW5/b;->p:[LW5/b;

    sget-object v1, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->TARGET:LUc/b;
    ...
    invoke-virtual {p0, v1, p1, v2}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->createRectType(Ljava/lang/String;Landroid/content/Context;LW5/b$a;)LW5/b;
    ...
    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->RECT:LUc/b;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/itsmagic/engine/Engines/Engine/ComponentUtils/ObjectReference;->d(Ljava/lang/String;Lj9/e;)LW5/b;
    ...
    :cond_1
    :goto_0
    sget-object p2, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->TARGET:LUc/b;
    ...
    invoke-virtual {p0, p2, p1, v0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->createRectType(Ljava/lang/String;Landroid/content/Context;LW5/b$a;)LW5/b;
...
.method public createRectType(Ljava/lang/String;Landroid/content/Context;LW5/b$a;)LW5/b;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p1, v0, p2, p3}, LZ5/c;->i(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;LZ5/c$r0;)LW5/b;
...
.method public getControllerRect()Loa/c;
    .locals 1
...
.method public getFirstTouch()LMc/h;
    .locals 2
...
.method public getInspectorEntries(Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->CLICKABLE:LUc/b;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->IGNORE_SLIDE_FROM_OUTSIDE_TO_INSIDE:LUc/b;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->DISPATCH_TOUCH_WHEN_OUTSIDE_RECT:LUc/b;
    ...
    sget-object v1, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->TARGET_RECT:LUc/b;

    invoke-static {v1}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->l(LUc/b;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, p1, v1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->createRectRef(Landroid/content/Context;Ljava/lang/String;)LW5/b;
...
.method public getObjectReference()Lna/p;
    .locals 1

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->objectReference:Lna/p;

    return-object v0
.end method

.method public getRectObject()Lka/b;
    .locals 1

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;
...
.method public getScreenRect()Loa/c;
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->M:Loa/c;

    return-object v0
.end method

.method public getSelectedTouch()LMc/h;
    .locals 1
...
.method public getSelectedTouchAt(I)LMc/h;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public isSelectedTouch(LMc/h;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public onDeserialized()V
    ...
    iget-object v1, v0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/InputSystem/UIEventEntry;->rectObject:Lka/b;

    iput-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;

    iget-object v1, v0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/InputSystem/UIEventEntry;->objectReference:Lna/p;

    iput-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->objectReference:Lna/p;
...
.method public onTouchEnter(LMc/h;ILka/c;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public onTouchExit(LMc/h;ILka/c;)Z
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iput-object p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->P:Lka/c;
...
.method public setRectObject(Lka/b;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public updateTouch(Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;I)V
    ...
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->rectObject:Lka/b;

    sget-object v3, Lka/b;->MySelf:Lka/b;

    if-ne v2, v3, :cond_2

    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->M:Loa/c;

    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIRect;->getScreenRect()Loa/c;

    move-result-object v0

    invoke-virtual {v2, v0}, Loa/c;->i(Loa/c;)V

    goto :goto_0

    :cond_2
    sget-object v3, Lka/b;->Parent:Lka/b;
    ...
    invoke-virtual {v0, v2}, Loa/c;->i(Loa/c;)V
    ...
    :cond_4
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->objectReference:Lna/p;
    ...
    invoke-virtual {v2}, Lna/p;->l()Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIRect;
    ...
    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->R:Lna/k;

    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->isOver()Z

    move-result v0

    invoke-virtual {p1, v0}, Lna/k;->d(Z)V
    ...
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->processLocalTouch(LMc/h;ILcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;Z)Z
    ...
    invoke-virtual {p1, v0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;->getVirtualToucheAt(I)LMc/h;
    ...
    iget-object v4, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->M:Loa/c;

    invoke-static {v0, v3, v4}, Lna/m;->e(LMc/h;Loa/c;Loa/c;)Z

    move-result v3

    if-nez v3, :cond_e

    invoke-direct {p0, v0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->removeSelectedTouch(LMc/h;)Z
