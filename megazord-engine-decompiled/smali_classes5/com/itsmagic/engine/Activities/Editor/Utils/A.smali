...
.method public static a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, LY8/a;->j()LY8/a$a;

    move-result-object v4

    invoke-virtual {v3}, LY8/a;->j()LY8/a$a;

    move-result-object v5

    if-ne v4, v5, :cond_1

    invoke-virtual {v1}, LY8/a;->h()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3}, LY8/a;->h()Ljava/lang/String;
    ...
    invoke-virtual {v3}, LY8/a;->f()Ljava/util/List;

    move-result-object v2

    invoke-virtual {v1}, LY8/a;->f()Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, LY8/a;->k(Ljava/util/List;)V
...
.method public static b(Landroid/content/Context;Landroid/view/View;LY8/a;Lcom/itsmagic/engine/Activities/Editor/Utils/B;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p2, v2, v3}, Lwd/b;-><init>(Ljava/lang/String;Lwd/d;)V
    ...
    invoke-direct {v6, v7, v5}, Lv8/p;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v2, Lhc/a$b;->a:Lcom/itsmagic/engine/Engines/Graphics/MaterialShader/Dictionary/ShaderTemplates;
    ...
    invoke-virtual {v3}, Lv8/p;->a()LY8/a;
    ...
    :cond_3
    invoke-virtual {p2}, LY8/a;->f()Ljava/util/List;
    ...
    invoke-virtual {v2}, LY8/a;->j()LY8/a$a;
    ...
    invoke-virtual {v2}, LY8/a;->h()Ljava/lang/String;

    move-result-object v4

    invoke-static {p0, p1, v2, p3}, Lcom/itsmagic/engine/Activities/Editor/Utils/A;->b(Landroid/content/Context;Landroid/view/View;LY8/a;Lcom/itsmagic/engine/Activities/Editor/Utils/B;)Ljava/util/List;

    move-result-object v2

    invoke-direct {v3, v4, v2}, Lwd/b;-><init>(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {v5, v2, p3}, Lcom/itsmagic/engine/Activities/Editor/Utils/A$b;-><init>(LY8/a;Lcom/itsmagic/engine/Activities/Editor/Utils/B;)V
...
.method public static c(Landroid/content/Context;Landroid/view/View;Lcom/itsmagic/engine/Activities/Editor/Utils/B;)V
    ...
    invoke-static {p0, p1, v1, p2}, Lcom/itsmagic/engine/Activities/Editor/Utils/A;->b(Landroid/content/Context;Landroid/view/View;LY8/a;Lcom/itsmagic/engine/Activities/Editor/Utils/B;)Ljava/util/List;

    move-result-object p0

    invoke-static {p1, v0, p0}, Lq7/a;->D1(Landroid/view/View;LL4/a$e;Ljava/util/List;)V
