...
# direct methods
.method public constructor <init>(Lokhttp3/a;Lch/d;Lokhttp3/e;Lokhttp3/r;)V
    .locals 1
    ...
    iput-object v0, p0, Lch/e;->h:Ljava/util/List;

    iput-object p1, p0, Lch/e;->a:Lokhttp3/a;

    iput-object p2, p0, Lch/e;->b:Lch/d;

    iput-object p3, p0, Lch/e;->c:Lokhttp3/e;

    iput-object p4, p0, Lch/e;->d:Lokhttp3/r;
    ...
    invoke-virtual {p0, p2, p1}, Lch/e;->h(Lokhttp3/v;Ljava/net/Proxy;)V
...
.method public a(Lokhttp3/G;Ljava/io/IOException;)V
    ...
    iget-object v0, p0, Lch/e;->a:Lokhttp3/a;
    ...
    iget-object v1, p0, Lch/e;->a:Lokhttp3/a;
    ...
    :cond_0
    iget-object p2, p0, Lch/e;->b:Lch/d;

    invoke-virtual {p2, p1}, Lch/d;->b(Lokhttp3/G;)V
...
.method public c()Z
    ...
    invoke-virtual {p0}, Lch/e;->d()Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v0, p0, Lch/e;->h:Ljava/util/List;
...
.method public e()Lch/e$a;
    ...
    invoke-virtual {p0}, Lch/e;->f()Ljava/net/Proxy;

    move-result-object v1

    iget-object v2, p0, Lch/e;->g:Ljava/util/List;
    ...
    iget-object v5, p0, Lch/e;->a:Lokhttp3/a;
    ...
    iget-object v5, p0, Lch/e;->b:Lch/d;

    invoke-virtual {v5, v4}, Lch/d;->c(Lokhttp3/G;)Z

    move-result v5

    if-eqz v5, :cond_1

    iget-object v5, p0, Lch/e;->h:Ljava/util/List;
    ...
    iget-object v1, p0, Lch/e;->h:Ljava/util/List;
    ...
    invoke-direct {v1, v0}, Lch/e$a;-><init>(Ljava/util/List;)V
...
.method public final f()Ljava/net/Proxy;
    ...
    invoke-virtual {p0, v0}, Lch/e;->g(Ljava/net/Proxy;)V
    ...
    iget-object v2, p0, Lch/e;->a:Lokhttp3/a;
...
.method public final g(Ljava/net/Proxy;)V
    ...
    invoke-static {v0}, Lch/e;->b(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    :cond_3
    iget-object p1, p0, Lch/e;->d:Lokhttp3/r;

    iget-object v2, p0, Lch/e;->c:Lokhttp3/e;

    invoke-virtual {p1, v2, v1}, Lokhttp3/r;->j(Lokhttp3/e;Ljava/lang/String;)V

    iget-object p1, p0, Lch/e;->a:Lokhttp3/a;
    ...
    iget-object v2, p0, Lch/e;->d:Lokhttp3/r;

    iget-object v3, p0, Lch/e;->c:Lokhttp3/e;
    ...
    iget-object v4, p0, Lch/e;->g:Ljava/util/List;
...
.method public final h(Lokhttp3/v;Ljava/net/Proxy;)V
    ...
    iput-object p1, p0, Lch/e;->e:Ljava/util/List;

    goto :goto_1

    :cond_0
    iget-object p2, p0, Lch/e;->a:Lokhttp3/a;
    ...
    invoke-static {p1}, LYg/c;->u(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1}, LYg/c;->v([Ljava/lang/Object;)Ljava/util/List;
