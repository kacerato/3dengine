...
.method public static synthetic o1(LQ4/a;)LP7/f;
    .locals 0

    iget-object p0, p0, LQ4/a;->X:LP7/f;
...
.method public B0()Landroid/view/View;
    ...
    invoke-direct {v2, v3}, LP7/f;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, LQ4/a;->X:LP7/f;
    ...
    invoke-direct {v1, v3, v2}, LP7/c;-><init>(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V
    ...
    invoke-direct {v2, v4, v3}, LP7/c;-><init>(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V

    iget-object v3, p0, LQ4/a;->X:LP7/f;

    invoke-virtual {v3, v1}, LP7/f;->k(LP7/c;)V

    iget-object v1, p0, LQ4/a;->X:LP7/f;

    invoke-virtual {v1, v2}, LP7/f;->k(LP7/c;)V
    ...
    new-instance v5, LQ4/a$a;

    invoke-direct {v5, p0}, LQ4/a$a;-><init>(LQ4/a;)V

    sget-object v6, Le8/c$b;->Disconnected:Le8/c$b;

    const v7, 0x7f0701b3

    invoke-direct {v4, v7, v5, v6, v3}, Le8/c;-><init>(ILe8/d;Le8/c$b;Landroid/content/Context;)V

    const v5, 0x7f050188

    invoke-virtual {v4, v5}, Le8/c;->S(I)Le8/c;

    move-result-object v4

    const v5, 0x7f05008f

    invoke-virtual {v4, v5}, Le8/c;->K(I)Le8/c;

    move-result-object v4

    sget-object v5, Lcom/itsmagic/engine/Activities/Editor/Extensions/ThemeSystem/Theme$T;->BACKGROUND:LUc/b;
    ...
    invoke-virtual {v4, v5, v6}, Le8/c;->a0(IZ)Le8/c;
    ...
    invoke-virtual {v4, v5}, Le8/c;->j0(I)Le8/c;
    ...
    invoke-virtual {v4, v3}, Le8/c;->X(I)Le8/c;
...
.method public m1()V
    ...
    iget-object v0, p0, LQ4/a;->X:LP7/f;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, LP7/f;->z(Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;)V
