...
.method static constructor <clinit>()V
    ...
    sput-object v0, LG3/c;->C:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LG3/c;->E:Ljava/nio/charset/Charset;
...
.method public constructor <init>(Landroid/content/Context;LA3/b;)V
    ...
    iput-object p1, p0, LG3/c;->b:Landroid/content/Context;

    iput-object p2, p0, LG3/c;->c:LA3/b;

    new-instance p1, LG3/e;

    invoke-direct {p1}, LG3/e;-><init>()V

    iput-object p1, p0, LG3/c;->d:LG3/e;
...
.method public static l(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0}, LG3/c;->p(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, LG3/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static n(Ljava/lang/String;)J
    ...
    sget-object v0, LG3/c;->C:Ljava/util/regex/Pattern;
...
.method public static p(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    sget-object v4, LG3/c;->E:Ljava/nio/charset/Charset;
...
# virtual methods
.method public d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)LG3/d;
    .locals 7
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v0, p0, LG3/c;->d:LG3/e;

    invoke-virtual {v0}, LG3/e;->b()Z
    ...
    invoke-virtual {p0, v0}, LG3/c;->h(Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-virtual {p0, v0, p1}, LG3/c;->m(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    :cond_0
    :goto_1
    invoke-virtual {p0, v4, p2, p4}, LG3/c;->r(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v3

    iget-object v5, p0, LG3/c;->d:LG3/e;

    invoke-virtual {v5, v3}, LG3/e;->f(I)V

    invoke-static {v3}, LG3/c;->j(I)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-virtual {p0, v4}, LG3/c;->o(Ljava/net/HttpURLConnection;)LG3/d;
    ...
    :cond_1
    :try_start_1
    invoke-static {v4, p4, p1, p3}, LG3/c;->l(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_2
    :try_start_2
    invoke-static {}, LG3/c;->k()V

    invoke-static {}, LG3/d;->a()LG3/d$a;

    move-result-object v3

    sget-object v5, LG3/d$b;->BAD_CONFIG:LG3/d$b;

    invoke-virtual {v3, v5}, LG3/d$a;->e(LG3/d$b;)LG3/d$a;

    move-result-object v3

    invoke-virtual {v3}, LG3/d$a;->a()LG3/d;
...
.method public e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, LG3/c;->h(Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-virtual {p0, p2, p1}, LG3/c;->m(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v1, v3, p1, p3}, LG3/c;->l(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)LG3/f;
    .locals 7
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, v3}, LG3/c;->s(Ljava/net/HttpURLConnection;)V

    invoke-virtual {v3}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v2

    iget-object v4, p0, LG3/c;->d:LG3/e;

    invoke-virtual {v4, v2}, LG3/e;->f(I)V

    invoke-static {v2}, LG3/c;->j(I)Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {p0, v3}, LG3/c;->q(Ljava/net/HttpURLConnection;)LG3/f;
    ...
    :try_start_1
    invoke-static {v3, v4, p1, p3}, LG3/c;->l(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/AssertionError; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sget-object v4, LG3/f$b;->BAD_CONFIG:LG3/f$b;

    invoke-virtual {v2, v4}, LG3/f$a;->b(LG3/f$b;)LG3/f$a;

    move-result-object v2

    invoke-virtual {v2}, LG3/f$a;->a()LG3/f;
    ...
    sget-object v4, LG3/f$b;->AUTH_ERROR:LG3/f$b;
...
.method public final g()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, LG3/c;->b:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3}, Lk1/a;->a(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    iget-object v3, p0, LG3/c;->b:Landroid/content/Context;
    ...
    invoke-static {v2, v3}, Lk1/n;->c([BZ)Ljava/lang/String;
    ...
    iget-object v4, p0, LG3/c;->b:Landroid/content/Context;
...
.method public final m(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, LG3/c;->c:LA3/b;
    ...
    invoke-interface {v2}, Lz3/j;->a()LQ1/k;

    move-result-object v2

    invoke-static {v2}, LQ1/n;->a(LQ1/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, LG3/c;->g()Ljava/lang/String;
...
.method public final o(Ljava/net/HttpURLConnection;)LG3/d;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v2, LG3/c;->E:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {v2, v3}, LG3/d$a;->f(Ljava/lang/String;)LG3/d$a;
    ...
    invoke-virtual {v2, v3}, LG3/d$a;->c(Ljava/lang/String;)LG3/d$a;
    ...
    invoke-virtual {v2, v3}, LG3/d$a;->d(Ljava/lang/String;)LG3/d$a;
    ...
    invoke-virtual {v1, v3}, LG3/f$a;->c(Ljava/lang/String;)LG3/f$a;
    ...
    invoke-static {v3}, LG3/c;->n(Ljava/lang/String;)J

    move-result-wide v3

    invoke-virtual {v1, v3, v4}, LG3/f$a;->d(J)LG3/f$a;
    ...
    invoke-virtual {v2, v3}, LG3/d$a;->b(LG3/f;)LG3/d$a;
    ...
    sget-object p1, LG3/d$b;->OK:LG3/d$b;

    invoke-virtual {v2, p1}, LG3/d$a;->e(LG3/d$b;)LG3/d$a;

    move-result-object p1

    invoke-virtual {p1}, LG3/d$a;->a()LG3/d;
...
.method public final q(Ljava/net/HttpURLConnection;)LG3/f;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/AssertionError;,
    ...
    invoke-virtual {v1, v2}, LG3/f$a;->c(Ljava/lang/String;)LG3/f$a;
    ...
    invoke-static {v2}, LG3/c;->n(Ljava/lang/String;)J

    move-result-wide v2

    invoke-virtual {v1, v2, v3}, LG3/f$a;->d(J)LG3/f$a;
    ...
    sget-object p1, LG3/f$b;->OK:LG3/f$b;

    invoke-virtual {v1, p1}, LG3/f$a;->b(LG3/f$b;)LG3/f$a;

    move-result-object p1

    invoke-virtual {p1}, LG3/f$a;->a()LG3/f;
...
.method public final r(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2, p3}, LG3/c;->b(Ljava/lang/String;Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object p2

    invoke-static {p2}, LG3/c;->i(Lorg/json/JSONObject;)[B

    move-result-object p2

    invoke-static {p1, p2}, LG3/c;->t(Ljava/net/URLConnection;[B)V
...
.method public final s(Ljava/net/HttpURLConnection;)V
    ...
    invoke-static {}, LG3/c;->c()Lorg/json/JSONObject;

    move-result-object v0

    invoke-static {v0}, LG3/c;->i(Lorg/json/JSONObject;)[B

    move-result-object v0

    invoke-static {p1, v0}, LG3/c;->t(Ljava/net/URLConnection;[B)V
