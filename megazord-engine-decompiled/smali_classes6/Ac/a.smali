...
.method static constructor <clinit>()V
    ...
    sput-object v0, LAc/a;->a:[F

    new-instance v0, Lcom/jme3/math/Vector4f;

    invoke-direct {v0}, Lcom/jme3/math/Vector4f;-><init>()V

    sput-object v0, LAc/a;->b:Lcom/jme3/math/Vector4f;

    new-instance v0, LUb/f;

    invoke-direct {v0}, LUb/f;-><init>()V

    sput-object v0, LAc/a;->c:LUb/f;

    const/16 v0, 0x10

    new-array v0, v0, [F

    sput-object v0, LAc/a;->f:[F

    const/4 v0, 0x0

    sput-object v0, LAc/a;->g:Ljava/util/List;

    sput-object v0, LAc/a;->h:Ljava/util/List;
...
.method public static b(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Camera/Camera;)V
    ...
    sget-object v3, LAc/a;->c:LUb/f;

    invoke-virtual {v3, v2}, LUb/f;->K0([F)V
    ...
    :goto_2
    :try_start_0
    sget-object v7, LAc/a;->h:Ljava/util/List;
    ...
    invoke-virtual {v7, v6}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->V(I)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;
    ...
    invoke-virtual {v3, v10}, Lmc/a;->a(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentView;)V
    ...
    invoke-static {v6, v6}, Ljc/a;->b(ZZ)V

    invoke-static {v10}, Ljc/a;->o(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentView;)V

    invoke-static {v4}, LI6/d;->I1(LI6/g;)V

    invoke-virtual {v3}, Lmc/a;->z()V
    ...
    :goto_7
    :try_start_1
    sget-object v6, LAc/a;->h:Ljava/util/List;
    ...
    invoke-virtual {v4}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->X()I
    ...
    invoke-virtual {v4, v11}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->V(I)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Camera/Camera;->getCacheBuffer()Lmc/a;
    ...
    :cond_e
    invoke-static {v3}, Lhc/a$a;->b(Lmc/a;)V
...
.method public static c(Lcom/itsmagic/engine/Engines/Engine/World/World;)V
    ...
    sput-object p0, LAc/a;->h:Ljava/util/List;
    ...
    sput-object p0, LAc/a;->g:Ljava/util/List;
    ...
    :goto_1
    :try_start_0
    sget-object v3, LAc/a;->h:Ljava/util/List;
    ...
    :goto_4
    sget-object v2, LAc/a;->g:Ljava/util/List;
    ...
    invoke-static {v2}, LAc/a;->b(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Camera/Camera;)V
