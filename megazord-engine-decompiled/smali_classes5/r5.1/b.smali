...
.method public constructor <init>(Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;Lr5/a;Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Components/EditorCamera;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Base/Panel3DView;)V
    ...
    iput p3, p0, Lr5/b;->d:F

    iput-object p1, p0, Lr5/b;->e:Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;
    ...
    new-instance p5, LMb/n;

    const/16 v0, 0x80

    invoke-direct {p5, v0, v0, p1}, LMb/n;-><init>(IILcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;)V

    iput-object p5, p0, Lr5/b;->a:LMb/n;

    iput-object p2, p0, Lr5/b;->b:Lr5/a;

    new-instance p1, LJAVARuntime/GizmoObject;

    invoke-direct {p1}, LJAVARuntime/GizmoObject;-><init>()V

    iput-object p1, p0, Lr5/b;->c:LJAVARuntime/GizmoObject;
    ...
    iget-object p1, p0, Lr5/b;->c:LJAVARuntime/GizmoObject;
...
.method public c(Lcom/itsmagic/engine/Engines/Engine/Quaternion/Quaternion;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V
    ...
    iget-object p2, p0, Lr5/b;->c:LJAVARuntime/GizmoObject;
...
.method public d(Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Components/EditorCamera;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Base/Panel3DView;)V
    ...
    iget-object p1, p0, Lr5/b;->b:Lr5/a;

    invoke-virtual {p1}, Lr5/a;->d()F

    move-result p1

    iget p3, p0, Lr5/b;->d:F
    ...
    :goto_0
    iget-object v6, p0, Lr5/b;->a:LMb/n;

    invoke-virtual {v6}, LMb/p;->getWidth()I
    ...
    :goto_1
    iget-object v7, p0, Lr5/b;->a:LMb/n;

    invoke-virtual {v7}, LMb/p;->getHeight()I
    ...
    iget-object v8, p0, Lr5/b;->a:LMb/n;

    invoke-virtual {v8}, LMb/p;->getWidth()I
    ...
    iget-object v9, p0, Lr5/b;->a:LMb/n;

    invoke-virtual {v9}, LMb/p;->getHeight()I
    ...
    invoke-virtual {v0, v7, v8}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    invoke-virtual {v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->Q(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)F

    move-result v7

    invoke-virtual {v0, v1, v3}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->N0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;

    invoke-virtual {v3}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->G0()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;

    cmpg-float v7, v7, v2

    if-gtz v7, :cond_4

    iget v7, p0, Lr5/b;->d:F
    ...
    invoke-static {v7, v10}, Lgd/b;->t(FF)F

    move-result v7

    invoke-static {p1, v7}, Lr5/b;->a(FF)F

    move-result v7

    add-float/2addr v7, p3

    iget v10, p0, Lr5/b;->d:F
    ...
    iget-object v8, p0, Lr5/b;->e:Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;

    invoke-virtual {v7, v5, v6, v8}, LMb/n;->k0(IILcom/itsmagic/engine/Engines/Engine/Color/ColorINT;)V
    ...
    invoke-static {}, Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;->t0()Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;
    ...
    :cond_6
    iget-object p1, p0, Lr5/b;->a:LMb/n;

    invoke-virtual {p1}, LMb/n;->apply()V

    :cond_7
    invoke-virtual {p0, p2}, Lr5/b;->b(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;)F
    ...
    iget-object p3, p0, Lr5/b;->c:LJAVARuntime/GizmoObject;
    ...
    invoke-static {v0, p2, p3}, Lgd/b;->E(FFF)F
    ...
    iget-object p2, p0, Lr5/b;->a:LMb/n;
