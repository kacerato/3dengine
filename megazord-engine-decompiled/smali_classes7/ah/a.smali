...
.method public constructor <init>(Lah/f;)V
    ...
    iput-object p1, p0, Lah/a;->a:Lah/f;
...
.method public static c(Lokhttp3/u;Lokhttp3/u;)Lokhttp3/u;
    ...
    :cond_0
    invoke-static {v4}, Lah/a;->d(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_1

    invoke-static {v4}, Lah/a;->e(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lah/a;->d(Ljava/lang/String;)Z

    move-result v3

    if-nez v3, :cond_4

    invoke-static {v1}, Lah/a;->e(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v0, v1, v4}, LYg/a;->b(Lokhttp3/u$a;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static f(Lokhttp3/E;)Lokhttp3/E;
    ...
    invoke-virtual {p0}, Lokhttp3/E;->s()Lokhttp3/E$a;
...
.method public a(Lokhttp3/w$a;)Lokhttp3/E;
    ...
    iget-object v0, p0, Lah/a;->a:Lah/f;
    ...
    invoke-interface {v0, v1}, Lah/f;->e(Lokhttp3/C;)Lokhttp3/E;
    ...
    invoke-direct {v3, v1, v2, v4, v0}, Lah/c$a;-><init>(JLokhttp3/C;Lokhttp3/E;)V

    invoke-virtual {v3}, Lah/c$a;->c()Lah/c;

    move-result-object v1

    iget-object v2, v1, Lah/c;->a:Lokhttp3/C;

    iget-object v3, v1, Lah/c;->b:Lokhttp3/E;

    iget-object v4, p0, Lah/a;->a:Lah/f;

    if-eqz v4, :cond_1

    invoke-interface {v4, v1}, Lah/f;->c(Lah/c;)V
    ...
    sget-object v0, LYg/c;->c:Lokhttp3/F;
    ...
    invoke-virtual {v3}, Lokhttp3/E;->s()Lokhttp3/E$a;

    move-result-object p1

    invoke-static {v3}, Lah/a;->f(Lokhttp3/E;)Lokhttp3/E;
    ...
    invoke-virtual {v3}, Lokhttp3/E;->n()Lokhttp3/u;
    ...
    invoke-static {v1, v2}, Lah/a;->c(Lokhttp3/u;Lokhttp3/u;)Lokhttp3/u;
    ...
    invoke-static {p1}, Lah/a;->f(Lokhttp3/E;)Lokhttp3/E;
    ...
    iget-object p1, p0, Lah/a;->a:Lah/f;

    invoke-interface {p1}, Lah/f;->d()V

    iget-object p1, p0, Lah/a;->a:Lah/f;

    invoke-interface {p1, v3, v0}, Lah/f;->f(Lokhttp3/E;Lokhttp3/E;)V
    ...
    :cond_7
    invoke-virtual {p1}, Lokhttp3/E;->s()Lokhttp3/E$a;
    ...
    invoke-static {p1, v2}, Lah/c;->a(Lokhttp3/E;Lokhttp3/C;)Z
    ...
    invoke-interface {v0, p1}, Lah/f;->b(Lokhttp3/E;)Lah/b;

    move-result-object v0

    invoke-virtual {p0, v0, p1}, Lah/a;->b(Lah/b;Lokhttp3/E;)Lokhttp3/E;
    ...
    invoke-static {v0}, Ldh/f;->a(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, v2}, Lah/f;->a(Lokhttp3/C;)V
    :try_end_1
...
.method public final b(Lah/b;Lokhttp3/E;)Lokhttp3/E;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-interface {p1}, Lah/b;->b()Llh/x;
    ...
    invoke-virtual {v1}, Lokhttp3/F;->o()Llh/e;
    ...
    invoke-direct {v2, p0, v1, p1, v0}, Lah/a$a;-><init>(Lah/a;Llh/e;Lah/b;Llh/d;)V
    ...
    invoke-virtual {p2}, Lokhttp3/E;->s()Lokhttp3/E$a;

    move-result-object p2

    new-instance v3, Ldh/h;

    invoke-static {v2}, Llh/p;->d(Llh/y;)Llh/e;

    move-result-object v2

    invoke-direct {v3, p1, v0, v1, v2}, Ldh/h;-><init>(Ljava/lang/String;JLlh/e;)V
