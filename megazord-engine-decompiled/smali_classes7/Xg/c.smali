...
.method static constructor <clinit>()V
    ...
    sput-object v1, LXg/c;->a:[B

    new-array v0, v0, [B

    fill-array-data v0, :array_1

    sput-object v0, LXg/c;->b:[B
...
.method public static C(ZBI)B
    ...
    invoke-static {p1, p2}, LXg/a;->b(BI)B
...
.method public static D(Ljava/nio/file/Path;[B)V
    ...
    invoke-static {p0, p1}, LXg/c;->c(Ljava/nio/file/Path;[B)V

    goto :goto_0

    :cond_1
    invoke-static {}, LXg/c;->v()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-static {}, LXg/c;->y()Z
    ...
    :cond_2
    invoke-static {p0, p1}, LXg/c;->b(Ljava/nio/file/Path;[B)V
...
.method public static E(Ljava/nio/file/Path;J)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, LXg/h;->f(J)J
...
.method public static a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V
    ...
    invoke-static {p0, p1}, LXg/a;->a(BI)Z
...
.method public static b(Ljava/nio/file/Path;[B)V
    ...
    invoke-static {v3, v5, v1, v4}, LXg/c;->a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V
    ...
    invoke-static {v3, v6, v1, v4}, LXg/c;->a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V
    ...
    invoke-static {v3, v2, v1, v4}, LXg/c;->a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V

    aget-byte v2, p1, v0

    sget-object v3, Ljava/nio/file/attribute/PosixFilePermission;->OTHERS_READ:Ljava/nio/file/attribute/PosixFilePermission;

    invoke-static {v2, v0, v1, v3}, LXg/c;->a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V
    ...
    invoke-static {v2, v4, v1, v3}, LXg/c;->a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V

    aget-byte p1, p1, v0

    sget-object v0, Ljava/nio/file/attribute/PosixFilePermission;->OTHERS_EXECUTE:Ljava/nio/file/attribute/PosixFilePermission;

    invoke-static {p1, v5, v1, v0}, LXg/c;->a(BILjava/util/Set;Ljava/nio/file/attribute/PosixFilePermission;)V
...
.method public static c(Ljava/nio/file/Path;[B)V
    ...
    invoke-static {v1, v0}, LXg/a;->a(BI)Z
    ...
    invoke-static {v1, v2}, LXg/a;->a(BI)Z
    ...
    invoke-static {p1, v0}, LXg/a;->a(BI)Z
...
.method public static e(Ljava/util/List;LTg/s$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, LXg/c;->x(Ljava/io/File;)Z

    move-result v1

    if-eqz v1, :cond_2

    sget-object v1, LTg/s$a;->INCLUDE_LINK_AND_LINKED_FILE:LTg/s$a;
    ...
    sget-object v1, LTg/s$a;->INCLUDE_LINKED_FILE_ONLY:LTg/s$a;
    ...
    :cond_1
    invoke-static {v0}, LXg/c;->f(Ljava/io/File;)V

    goto :goto_0

    :cond_2
    invoke-static {v0}, LXg/c;->d(Ljava/io/File;)V
...
.method public static f(Ljava/io/File;)V
    ...
    invoke-static {p0}, LXg/c;->B(Ljava/io/File;)Ljava/lang/String;
...
.method public static g(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;JJLVg/a;I)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lnet/lingala/zip4j/exception/ZipException;
    ...
    invoke-virtual {p6, v2, v3}, LVg/a;->x(J)V

    invoke-virtual {p6}, LVg/a;->l()Z

    move-result p3

    if-eqz p3, :cond_3

    sget-object p0, LVg/a$a;->CANCELLED:LVg/a$a;

    invoke-virtual {p6, p0}, LVg/a;->u(LVg/a$a;)V
...
.method public static h(Ljava/io/File;)[Ljava/io/File;
    ...
    invoke-static {v0}, LXg/c;->m(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v0}, LXg/c$a;-><init>(Ljava/lang/String;)V
...
.method public static i(Z)[B
    ...
    invoke-static {p0, v0}, LXg/a;->b(BI)B
...
.method public static k(Ljava/io/File;)[B
    ...
    invoke-static {p0}, LXg/c;->t(Ljava/nio/file/Path;)[B
    ...
    :cond_3
    :goto_0
    invoke-static {p0}, LXg/c;->q(Ljava/nio/file/Path;)[B
...
.method public static n(Ljava/io/File;LTg/s;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v4, v3}, LTg/h;->a(Ljava/io/File;)Z
    ...
    invoke-static {v3}, LXg/c;->x(Ljava/io/File;)Z

    move-result v5

    if-eqz v5, :cond_3

    sget-object v6, LTg/s$a;->INCLUDE_LINK_ONLY:LTg/s$a;
    ...
    :cond_4
    invoke-static {v3, p1}, LXg/c;->n(Ljava/io/File;LTg/s;)Ljava/util/List;
...
.method public static o(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, LXg/c;->x(Ljava/io/File;)Z
...
.method public static p(I)Ljava/lang/String;
    ...
    invoke-static {p0}, LXg/c;->j(I)Ljava/lang/String;
...
.method public static q(Ljava/nio/file/Path;)[B
    ...
    invoke-static {p0, v5}, LXg/a;->b(BI)B

    move-result p0

    aput-byte p0, v1, v7

    invoke-static {p0, v4}, LXg/a;->c(BI)B
    ...
    invoke-static {v8, v9, v5}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v8, v4}, LXg/c;->C(ZBI)B
    ...
    invoke-static {v3, p0, v8}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v3, v6}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v9, v5}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v5, v4}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v4, v8}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v4, v0}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v0, v7}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v0, v3}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v0, v4}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v0, v6}, LXg/c;->C(ZBI)B
...
.method public static r(Ljava/io/File;LTg/s;)Ljava/lang/String;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lnet/lingala/zip4j/exception/ZipException;
    ...
    invoke-static {v1}, LXg/h;->j(Ljava/lang/String;)Z
    ...
    sget-object v4, LXg/d;->s:Ljava/lang/String;
    ...
    invoke-static {v4, v0}, LXg/c;->o(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v0}, LXg/c;->o(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, LXg/d;->s:Ljava/lang/String;
    ...
    :cond_8
    invoke-static {v0}, LXg/h;->j(Ljava/lang/String;)Z
...
.method public static s(LTg/r;)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static t(Ljava/nio/file/Path;)[B
    ...
    invoke-static {v2, v3, v3}, LXg/c;->C(ZBI)B
    ...
    invoke-static {v4, v2, v5}, LXg/c;->C(ZBI)B
    ...
    invoke-static {v4, v2, v0}, LXg/c;->C(ZBI)B
    ...
    invoke-static {p0, v0, v2}, LXg/c;->C(ZBI)B
...
.method public static u(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, LXg/h;->j(Ljava/lang/String;)Z
