...
.method public constructor <init>(LTe/I;JLjava/util/concurrent/TimeUnit;LTe/J$c;)V
    ...
    iput-object p1, p0, Lgf/z1$c;->b:LTe/I;

    iput-wide p2, p0, Lgf/z1$c;->c:J

    iput-object p4, p0, Lgf/z1$c;->d:Ljava/util/concurrent/TimeUnit;

    iput-object p5, p0, Lgf/z1$c;->e:LTe/J$c;

    new-instance p1, LYe/h;

    invoke-direct {p1}, LYe/h;-><init>()V

    iput-object p1, p0, Lgf/z1$c;->f:LYe/h;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lgf/z1$c;->g:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public a()V
    ...
    iget-object v0, p0, Lgf/z1$c;->f:LYe/h;

    invoke-virtual {v0}, LYe/h;->dispose()V

    iget-object v0, p0, Lgf/z1$c;->b:LTe/I;

    invoke-interface {v0}, LTe/I;->a()V

    iget-object v0, p0, Lgf/z1$c;->e:LTe/J$c;
...
.method public b(J)V
    ...
    iget-object p1, p0, Lgf/z1$c;->g:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {p1}, LYe/d;->a(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object p1, p0, Lgf/z1$c;->b:LTe/I;

    new-instance p2, Ljava/util/concurrent/TimeoutException;

    iget-wide v0, p0, Lgf/z1$c;->c:J

    iget-object v2, p0, Lgf/z1$c;->d:Ljava/util/concurrent/TimeUnit;
    ...
    iget-object p1, p0, Lgf/z1$c;->e:LTe/J$c;
...
.method public d()Z
    ...
    iget-object v0, p0, Lgf/z1$c;->g:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public f(J)V
    ...
    iget-object v1, p0, Lgf/z1$c;->e:LTe/J$c;

    new-instance v2, Lgf/z1$e;

    invoke-direct {v2, p1, p2, p0}, Lgf/z1$e;-><init>(JLgf/z1$d;)V

    iget-wide p1, p0, Lgf/z1$c;->c:J

    iget-object v3, p0, Lgf/z1$c;->d:Ljava/util/concurrent/TimeUnit;
...
.method public g(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2, v3}, Lgf/z1$c;->f(J)V
