...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lv1/u;->l:Lcom/google/android/gms/common/api/a$g;

    new-instance v1, Lv1/l;

    invoke-direct {v1}, Lv1/l;-><init>()V

    sput-object v1, Lv1/u;->m:Lcom/google/android/gms/common/api/a$a;
    ...
    sput-object v2, Lv1/u;->n:Lcom/google/android/gms/common/api/a;
...
.method public constructor <init>(Landroid/app/Activity;Lcom/google/android/gms/auth/api/identity/M;)V
    ...
    .line 1
    sget-object v0, Lv1/u;->n:Lcom/google/android/gms/common/api/a;
    ...
    iput-object p1, p0, Lv1/u;->k:Ljava/lang/String;
...
# virtual methods
.method public final A(Lcom/google/android/gms/auth/api/identity/g;)LQ1/k;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lv1/s;-><init>(Lv1/u;Lcom/google/android/gms/auth/api/identity/g;)V
...
.method public final C()LQ1/k;
    ...
    invoke-direct {v1, p0}, Lv1/q;-><init>(Lv1/u;)V

    invoke-virtual {v0, v1}, LU0/r$a;->c(LU0/n;)LU0/r$a;

    move-result-object v0

    invoke-virtual {v0, v2}, LU0/r$a;->d(Z)LU0/r$a;
...
.method public final E(Lcom/google/android/gms/auth/api/identity/c;)LQ1/k;
    .locals 5
    ...
    invoke-static {p1}, Lcom/google/android/gms/auth/api/identity/c;->A0(Lcom/google/android/gms/auth/api/identity/c;)Lcom/google/android/gms/auth/api/identity/c$a;

    move-result-object p1

    iget-object v0, p0, Lv1/u;->k:Ljava/lang/String;
    ...
    invoke-direct {v1, p0, p1}, Lv1/t;-><init>(Lv1/u;Lcom/google/android/gms/auth/api/identity/c;)V
...
.method public final d(Lcom/google/android/gms/auth/api/identity/h;)LQ1/k;
    .locals 2
    ...
    invoke-static {p1}, Lcom/google/android/gms/auth/api/identity/h;->s0(Lcom/google/android/gms/auth/api/identity/h;)Lcom/google/android/gms/auth/api/identity/h$a;
    ...
    invoke-direct {v1, p0, p1}, Lv1/r;-><init>(Lv1/u;Lcom/google/android/gms/auth/api/identity/h;)V
...
.method public final f(Landroid/content/Intent;)Lcom/google/android/gms/auth/api/identity/n;
    .locals 2
...
.method public final synthetic g0(Lv1/v;LQ1/l;)V
    .locals 2

    new-instance v0, Lv1/n;

    invoke-direct {v0, p0, p2}, Lv1/n;-><init>(Lv1/u;LQ1/l;)V
    ...
    iget-object v1, p0, Lv1/u;->k:Ljava/lang/String;

    invoke-virtual {p2, v0, v1, p1}, Lv1/i0;->f1(Lcom/google/android/gms/common/api/internal/e;Ljava/lang/String;Lcom/google/android/gms/common/api/b;)V

    return-void
.end method

.method public final synthetic h0(Lcom/google/android/gms/auth/api/identity/g;Lv1/v;LQ1/l;)V
    .locals 2

    new-instance v0, Lv1/p;

    invoke-direct {v0, p0, p3}, Lv1/p;-><init>(Lv1/u;LQ1/l;)V

    invoke-virtual {p2}, LX0/f;->M()Landroid/os/IInterface;

    move-result-object p3

    check-cast p3, Lv1/i0;

    invoke-virtual {p2}, LX0/f;->G()Landroid/content/Context;

    move-result-object p2

    invoke-static {p2}, Lv1/A;->a(Landroid/content/Context;)Lcom/google/android/gms/common/api/b;

    move-result-object p2

    iget-object v1, p0, Lv1/u;->k:Ljava/lang/String;

    invoke-virtual {p3, v0, p1, v1, p2}, Lv1/i0;->M1(Lv1/b0;Lcom/google/android/gms/auth/api/identity/g;Ljava/lang/String;Lcom/google/android/gms/common/api/b;)V

    return-void
.end method

.method public final u(Landroid/content/Intent;)Ljava/lang/String;
    .locals 2
    .param p1    # Landroid/content/Intent;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
