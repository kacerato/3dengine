...
.field public static final d:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final e:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final f:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final g:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final h:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final i:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final j:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final k:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public static final l:Lsg/v;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, LT6/d$a;-><init>(Lkotlin/jvm/internal/x;)V

    sput-object v0, LT6/d;->a:LT6/d$a;
    ...
    invoke-static {v0}, LHf/z0;->u([Ljava/lang/Object;)Ljava/util/Set;

    move-result-object v0

    sput-object v0, LT6/d;->b:Ljava/util/Set;
    ...
    sput-object v0, LT6/d;->c:Ljava/util/Set;

    new-instance v0, Lsg/v;

    const-string v1, "#\\s*\\w+"

    invoke-direct {v0, v1}, Lsg/v;-><init>(Ljava/lang/String;)V

    sput-object v0, LT6/d;->d:Lsg/v;
    ...
    sput-object v0, LT6/d;->e:Lsg/v;

    new-instance v0, Lsg/v;

    const-string v1, "/\\*.*?\\*/"

    sget-object v2, Lsg/x;->DOT_MATCHES_ALL:Lsg/x;

    invoke-direct {v0, v1, v2}, Lsg/v;-><init>(Ljava/lang/String;Lsg/x;)V

    sput-object v0, LT6/d;->f:Lsg/v;
...
.method public static final a(Ljava/util/List;Ljava/util/List;Lsg/r;I)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2}, Lsg/r;->getRange()Lng/l;

    move-result-object p3

    invoke-virtual {p3}, Lng/j;->c()I
...
.method public static final b(Ljava/util/List;I)Z
    ...
    invoke-virtual {v0}, Lng/j;->c()I

    move-result v2

    invoke-virtual {v0}, Lng/j;->d()I
...
.method public execute(Ljava/lang/String;Lorg/blacksquircle/ui/language/base/model/ColorScheme;)Ljava/util/List;
    ...
    invoke-static {v5, v0, v6, v7, v8}, Lsg/v;->g(Lsg/v;Ljava/lang/CharSequence;IILjava/lang/Object;)Lpg/m;

    move-result-object v5

    invoke-interface {v5}, Lpg/m;->iterator()Ljava/util/Iterator;
    ...
    invoke-interface {v9}, Lsg/r;->b()Ljava/util/List;
    ...
    invoke-static {v1, v3, v9, v11}, LT6/d;->a(Ljava/util/List;Ljava/util/List;Lsg/r;I)V

    goto :goto_1

    :cond_1
    sget-object v5, LT6/d;->e:Lsg/v;
    ...
    invoke-interface {v9}, Lsg/r;->getRange()Lng/l;

    move-result-object v11

    invoke-virtual {v11}, Lng/j;->c()I

    move-result v11

    invoke-static {v3, v11}, LT6/d;->b(Ljava/util/List;I)Z
    ...
    invoke-interface {v6}, Lsg/r;->getRange()Lng/l;

    move-result-object v9

    invoke-virtual {v9}, Lng/j;->c()I

    move-result v9

    invoke-static {v3, v9}, LT6/d;->b(Ljava/util/List;I)Z
    ...
    invoke-virtual {v7}, Lng/j;->c()I

    move-result v7

    invoke-static {v3, v7}, LT6/d;->b(Ljava/util/List;I)Z
    ...
    invoke-interface {v6}, Lsg/r;->getValue()Ljava/lang/String;

    move-result-object v7

    sget-object v9, LT6/d;->b:Ljava/util/Set;
    ...
    :cond_c
    sget-object v9, LT6/d;->c:Ljava/util/Set;
    ...
    invoke-direct {v3, v5}, Lsg/v;-><init>(Ljava/lang/String;)V

    const/4 v5, 0x0

    const/4 v6, 0x2

    invoke-static {v3, v0, v5, v6, v8}, Lsg/v;->g(Lsg/v;Ljava/lang/CharSequence;IILjava/lang/Object;)Lpg/m;

    move-result-object v3

    invoke-interface {v3}, Lpg/m;->iterator()Ljava/util/Iterator;
    ...
    invoke-interface {v5}, Lsg/r;->getRange()Lng/l;
    ...
    invoke-interface {v3}, Lsg/r;->b()Ljava/util/List;
    ...
    sget-object v6, LT6/d;->c:Ljava/util/Set;
    ...
    invoke-interface {v3}, Lsg/r;->getRange()Lng/l;
