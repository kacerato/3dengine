...
.method static constructor <clinit>()V
    ...
    sput-object v0, LB4/k;->o:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, LB4/k;->q:Ljava/util/List;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, LB4/k;->a:Ljava/lang/Object;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, LB4/k;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, LB4/k;->e:Ljava/util/Set;

    const/4 v0, 0x0

    iput v0, p0, LB4/k;->f:F

    new-instance v0, LB4/k$c;

    invoke-direct {v0, p0}, LB4/k$c;-><init>(LB4/k;)V

    iput-object v0, p0, LB4/k;->h:LB4/m;

    new-instance v0, LB4/k$d;

    invoke-direct {v0, p0}, LB4/k$d;-><init>(LB4/k;)V

    iput-object v0, p0, LB4/k;->i:Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;

    iput-object p1, p0, LB4/k;->b:Ljava/lang/String;

    new-instance v0, Ljava/lang/Thread;

    new-instance v1, LB4/k$e;

    invoke-direct {v1, p0, p1}, LB4/k$e;-><init>(LB4/k;Ljava/lang/String;)V
...
.method public static A(Ljava/lang/String;)LB4/k;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    :cond_0
    sget-object v0, LB4/k;->q:Ljava/util/List;
    ...
    invoke-virtual {v2}, LB4/g;->a()LB4/k;

    move-result-object v2

    iget-object v3, v2, LB4/k;->b:Ljava/lang/String;
    ...
    invoke-direct {v1, p0}, LB4/k;-><init>(Ljava/lang/String;)V

    sget-object p0, LB4/k;->q:Ljava/util/List;

    new-instance v2, LB4/g;

    invoke-direct {v2, v1}, LB4/g;-><init>(LB4/k;)V
...
.method public static synthetic E(LB4/g;)Z
    .locals 0

    invoke-virtual {p0}, LB4/g;->b()Z
...
.method public static K()V
    ...
    invoke-direct {v0}, LB4/k$b;-><init>()V
...
.method public static synthetic a(LB4/g;)Z
    .locals 0

    invoke-static {p0}, LB4/k;->E(LB4/g;)Z
...
.method public static synthetic b()LB4/k;
    .locals 1

    sget-object v0, LB4/k;->p:LB4/k;

    return-object v0
.end method

.method public static synthetic c(LB4/k;)LB4/k;
    .locals 0

    sput-object p0, LB4/k;->p:LB4/k;
...
.method public static synthetic e(LB4/k;)V
    .locals 0

    invoke-virtual {p0}, LB4/k;->u()V

    return-void
.end method

.method public static synthetic f(LB4/k;)Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;
    .locals 0

    iget-object p0, p0, LB4/k;->i:Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;

    return-object p0
.end method

.method public static synthetic g(LB4/k;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 0

    iget-object p0, p0, LB4/k;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-object p0
.end method

.method public static synthetic h(LB4/k;Ljava/io/File;Ljava/lang/String;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, LB4/k;->J(Ljava/io/File;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic i(LB4/k;Ljava/io/File;Ljava/text/SimpleDateFormat;)Ljava/util/Date;
    .locals 0

    invoke-virtual {p0, p1, p2}, LB4/k;->y(Ljava/io/File;Ljava/text/SimpleDateFormat;)Ljava/util/Date;
...
.method public static synthetic j(LB4/k;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, LB4/k;->b:Ljava/lang/String;
...
.method public static synthetic k()Ljava/util/List;
    ...
    sget-object v0, LB4/k;->o:Ljava/util/List;

    return-object v0
.end method

.method public static synthetic l(LB4/k;)V
    .locals 0

    invoke-virtual {p0}, LB4/k;->x()V

    return-void
.end method

.method public static synthetic m(LB4/k;)Ljava/io/File;
    .locals 0

    invoke-virtual {p0}, LB4/k;->D()Ljava/io/File;
...
.method public static synthetic n(LB4/k;)Ljava/lang/Object;
    .locals 0

    iget-object p0, p0, LB4/k;->a:Ljava/lang/Object;

    return-object p0
.end method

.method public static synthetic o(LB4/k;)LB4/f;
    .locals 0

    iget-object p0, p0, LB4/k;->c:LB4/f;

    return-object p0
.end method

.method public static synthetic p(LB4/k;LB4/f;)LB4/f;
    .locals 0

    iput-object p1, p0, LB4/k;->c:LB4/f;

    return-object p1
.end method

.method public static synthetic q(LB4/k;)LB4/m;
    .locals 0

    iget-object p0, p0, LB4/k;->h:LB4/m;

    return-object p0
.end method

.method public static synthetic r(LB4/k;)V
    .locals 0

    invoke-virtual {p0}, LB4/k;->s()V

    return-void
.end method

.method public static z()LB4/k;
    .locals 1
    ...
    invoke-static {v0}, LB4/k;->A(Ljava/lang/String;)LB4/k;
...
.method public final B()Ljava/util/List;
    ...
    new-instance v2, LB4/k$i;

    invoke-direct {v2, p0, v1}, LB4/k$i;-><init>(LB4/k;Ljava/text/SimpleDateFormat;)V
...
.method public final D()Ljava/io/File;
    ...
    iget-object v1, p0, LB4/k;->b:Ljava/lang/String;
...
.method public F(Ljava/io/File;ZLB4/k$j;)V
    .locals 16
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {v3}, Lp8/a;->x(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct/range {v2 .. v7}, LB4/k$g;-><init>(LB4/k;Ljava/io/File;Lcom/itsmagic/engine/Activities/Editor/Extensions/VCS/FileVersionData;Ljava/io/File;Ljava/lang/String;)V

    invoke-interface {v0, v15}, LB4/k$j;->a(LB4/d;)V
    ...
    invoke-static {v4}, Lp8/a;->x(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct/range {v2 .. v8}, LB4/k$h;-><init>(LB4/k;Ljava/io/File;Lcom/itsmagic/engine/Activities/Editor/Extensions/VCS/FileVersionData;Ljava/io/File;Ljava/lang/String;Ljava/io/File;)V

    invoke-interface {v0, v12}, LB4/k$j;->a(LB4/d;)V
...
.method public G(Ljava/io/File;I)V
    ...
    invoke-virtual {p0, p1, p2, v0}, LB4/k;->H(Ljava/io/File;ILjava/lang/String;)V
...
.method public H(Ljava/io/File;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, LB4/k;->I(Ljava/io/File;ILjava/lang/String;Ljava/lang/String;)V
...
.method public I(Ljava/io/File;ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, LB4/k;->b:Ljava/lang/String;
    ...
    iget-object v1, p0, LB4/k;->e:Ljava/util/Set;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, LB4/k;->e:Ljava/util/Set;
    ...
    invoke-static {v3, p3}, Lp8/a;->i(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v0}, LBd/a;->a(Ljava/io/File;Ljava/io/File;)Z
    ...
    iget-object v0, p0, LB4/k;->b:Ljava/lang/String;
    ...
    invoke-static {p1, p3}, LBd/a;->a(Ljava/io/File;Ljava/io/File;)Z
...
.method public final J(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, LB4/k;->I(Ljava/io/File;ILjava/lang/String;Ljava/lang/String;)V
...
.method public final s()V
    ...
    invoke-static {v0}, LBd/a;->j(Ljava/io/File;)J
    ...
    invoke-virtual {p0}, LB4/k;->B()Ljava/util/List;
    ...
    invoke-static {v3}, LBd/a;->i(Ljava/io/File;)Z
...
.method public t()V
    ...
    new-instance v1, LB4/k$f;

    invoke-direct {v1, p0}, LB4/k$f;-><init>(LB4/k;)V
...
.method public final u()V
    ...
    :cond_1
    invoke-static {v3}, LBd/a;->g(Ljava/io/File;)Z
...
.method public v(Ljava/io/File;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-static {v1}, LBd/a;->i(Ljava/io/File;)Z
...
.method public w()V
    ...
    iget-object v0, p0, LB4/k;->i:Lcom/itsmagic/engine/Engines/Engine/Modules/UpdateModule;
...
.method public final x()V
    ...
    iget-object v0, p0, LB4/k;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
