...
.method static constructor <clinit>()V
    ...
    sput-object v0, LDf/g;->t:Ljava/util/logging/Logger;
...
.method public constructor <init>(II)V
    ...
    .line 2
    invoke-direct/range {v0 .. v6}, LDf/g;-><init>(IIFFFZ)V
...
.method public constructor <init>(IIFFFZ)V
    ...
    invoke-static {p1, v0, v1, v2}, LAf/E;->i(ILjava/lang/String;II)Z

    .line 5
    iput p1, p0, LDf/g;->j:I
    ...
    invoke-static {p2, p1, v0, v2}, LAf/E;->i(ILjava/lang/String;II)Z

    .line 7
    iput p2, p0, LDf/g;->i:I

    .line 8
    const-string p1, "topU"

    invoke-static {p3, p1}, LAf/E;->f(FLjava/lang/String;)Z

    .line 9
    iput p3, p0, LDf/g;->e:F

    .line 10
    const-string p1, "topV"

    invoke-static {p4, p1}, LAf/E;->f(FLjava/lang/String;)Z

    .line 11
    iput p4, p0, LDf/g;->f:F
    ...
    .line 12
    iput p5, p0, LDf/g;->g:F

    .line 13
    iput-boolean p6, p0, LDf/g;->c:Z

    const p1, 0x40c90fdb

    .line 14
    iput p1, p0, LDf/g;->d:F

    const p1, 0x3fc90fdb

    .line 15
    iput p1, p0, LDf/g;->h:F

    .line 16
    invoke-virtual {p0}, LDf/g;->h()V
    ...
    .line 18
    :cond_0
    sget-object p1, LDf/g;->t:Ljava/util/logging/Logger;
...
.method private l()V
    ...
    :cond_0
    sget-object v7, LDf/g;->t:Ljava/util/logging/Logger;
...
.method public a(Lcom/jme3/math/Vector3f;)Lcom/jme3/math/Vector2f;
    ...
    invoke-static {p1, v0}, LAf/E;->A(Lcom/jme3/math/Vector3f;Ljava/lang/String;)Z
    ...
    iget v0, p0, LDf/g;->e:F

    iget v1, p0, LDf/g;->f:F
    ...
    iget p1, p0, LDf/g;->e:F

    mul-float/2addr v0, v1

    add-float/2addr p1, v0

    iget v0, p0, LDf/g;->f:F
...
.method public b(FF)F
    ...
    invoke-static {p1, v0}, LAf/E;->f(FLjava/lang/String;)Z

    const-string v0, "v"

    invoke-static {p2, v0}, LAf/E;->f(FLjava/lang/String;)Z
    ...
    invoke-static {v0}, LBf/f;->r([F)F

    move-result p1

    iget p2, p0, LDf/g;->g:F
...
.method public f(F)V
    ...
    :cond_0
    sget-object v0, LDf/g;->t:Ljava/util/logging/Logger;
...
.method public final h()V
    ...
    invoke-virtual {p0}, LDf/g;->j()V

    invoke-virtual {p0}, LDf/g;->i()V

    invoke-virtual {p0}, LDf/g;->k()V

    invoke-direct {p0}, LDf/g;->l()V
...
.method public final i()V
    ...
    iget-boolean v4, v0, LDf/g;->b:Z

    if-eqz v4, :cond_0

    iget v4, v0, LDf/g;->j:I
    ...
    :cond_0
    iget v4, v0, LDf/g;->d:F

    iget v5, v0, LDf/g;->j:I
    ...
    iget v13, v0, LDf/g;->j:I

    mul-int/2addr v13, v6

    add-int/2addr v13, v10

    sget-object v14, LDf/g;->t:Ljava/util/logging/Logger;
    ...
    invoke-virtual {v0, v4}, LDf/g;->a(Lcom/jme3/math/Vector3f;)Lcom/jme3/math/Vector2f;
    ...
    :cond_2
    iget v3, v0, LDf/g;->l:I

    add-int/lit8 v3, v3, -0x1

    sget-object v4, LDf/g;->t:Ljava/util/logging/Logger;
    ...
    iget v5, v0, LDf/g;->e:F

    iget v6, v0, LDf/g;->f:F
...
.method public final j()V
    ...
    iget v0, p0, LDf/g;->j:I

    const/4 v1, 0x3

    if-lt v0, v1, :cond_2

    iget v1, p0, LDf/g;->i:I

    const/4 v2, 0x2

    if-lt v1, v2, :cond_1

    iget v3, p0, LDf/g;->d:F
    ...
    iget v3, p0, LDf/g;->j:I

    mul-int/2addr v1, v3

    add-int/2addr v1, v4

    iput v1, p0, LDf/g;->l:I
    ...
    :cond_2
    sget-object v1, LDf/g;->t:Ljava/util/logging/Logger;
...
.method public final k()V
    ...
    iget-boolean v3, v0, LDf/g;->b:Z

    if-eqz v3, :cond_0

    iget v3, v0, LDf/g;->j:I
    ...
    sget-object v5, LDf/g;->t:Ljava/util/logging/Logger;
    ...
    sget-object v8, LDf/g;->t:Ljava/util/logging/Logger;
