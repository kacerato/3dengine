...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lq7/a;->C1(IILjava/util/List;Landroid/content/Context;Lq7/b;)V
.end annotation
...
# direct methods
.method public constructor <init>(Ljava/util/List;Lq7/b;FFLandroid/content/Context;)V
    .locals 0
    ...
    iput-object p1, p0, Lq7/a$b;->a:Ljava/util/List;

    iput-object p2, p0, Lq7/a$b;->b:Lq7/b;

    iput p3, p0, Lq7/a$b;->c:F

    iput p4, p0, Lq7/a$b;->d:F

    iput-object p5, p0, Lq7/a$b;->e:Landroid/content/Context;
...
.method public a(Lcom/itsmagic/engine/Activities/Editor/Utils/E;)V
    ...
    iget-object v1, p0, Lq7/a$b;->a:Ljava/util/List;

    iget-object v2, p0, Lq7/a$b;->b:Lq7/b;
    ...
    iget v0, p0, Lq7/a$b;->c:F

    iget v1, p0, Lq7/a$b;->d:F

    iget-object v2, p0, Lq7/a$b;->a:Ljava/util/List;

    invoke-static {v2}, Lq7/a;->o1(Ljava/util/List;)F

    move-result v2

    iget-object v3, p0, Lq7/a$b;->a:Ljava/util/List;

    iget-object v4, p0, Lq7/a$b;->e:Landroid/content/Context;

    invoke-static {v3, v4}, Lq7/a;->p1(Ljava/util/List;Landroid/content/Context;)F

    move-result v3

    invoke-static {v6, v0, v1, v2, v3}, LL4/a;->n(Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;FFFF)Lcom/itsmagic/engine/Activities/Editor/Interface/FloatingPanel/FloatingPanelArea;
    ...
    invoke-direct {v0, p0, v6, p1}, Lq7/a$b$a;-><init>(Lq7/a$b;Lq7/a;Lcom/itsmagic/engine/Activities/Editor/Utils/E;)V
