...
.method public constructor <init>()V
    ...
    invoke-direct {v1, v2, v3}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;-><init>(LUc/b;Z)V
...
.method public b(LUc/b;)Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object v3, v2, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->guid:LUc/b;

    invoke-virtual {v3, p1}, LUc/b;->q0(LUc/b;)Z
...
.method public c(LUc/b;)Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object v3, v2, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->name:LUc/b;
...
.method public d()LUc/b;
    ...
    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/PhysicsSettings;->c(LUc/b;)Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;
    ...
    invoke-virtual {v0, v2}, LUc/b;->J0(Ljava/lang/String;)V
...
.method public e(Landroid/content/Context;Lcom/itsmagic/engine/Engines/Engine/Settings/c;)Ljava/util/List;
    ...
    invoke-direct {v0, v1, p1, v2}, LW5/b;-><init>(LX5/e;ILjava/lang/Object;)V
...
.method public g(Landroid/content/Context;Lcom/itsmagic/engine/Engines/Engine/Settings/c;)Ljava/util/List;
    ...
    iget-object v6, v3, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->name:LUc/b;

    invoke-virtual {v6}, LUc/b;->toString()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->w()Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;

    move-result-object v7

    const/4 v8, 0x1

    invoke-direct {v5, v6, v8, v7}, LW5/a;-><init>(Ljava/lang/String;ZLcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;)V
    ...
    sget-object v9, LW5/b$a;->SLString:LW5/b$a;

    invoke-direct {v6, v7, v8, v9, v1}, LW5/b;-><init>(LX5/h;Ljava/lang/String;LW5/b$a;Z)V
    ...
    sget-object v8, LW5/b$a;->Button:LW5/b$a;

    invoke-direct {v6, v7, v3, v8}, LW5/b;-><init>(LX5/b;Ljava/lang/String;LW5/b$a;)V
    ...
    invoke-direct {v1, v2, p1, p2}, LW5/b;-><init>(LX5/b;Ljava/lang/String;LW5/b$a;)V
...
.method public k()V
    ...
    invoke-direct {v4, v5}, LUc/b;-><init>(Ljava/lang/String;)V

    invoke-direct {v3, v4, v1}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;-><init>(LUc/b;Z)V
    ...
    invoke-static {v0}, Lfd/f;->a(Ljava/util/List;)V
    ...
    :goto_1
    invoke-virtual {v4}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->y()I

    move-result v6

    if-ge v5, v6, :cond_3

    invoke-virtual {v4, v5}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->v(I)LUc/b;

    move-result-object v6

    invoke-virtual {p0, v6}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/PhysicsSettings;->b(LUc/b;)Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;
    ...
    invoke-virtual {v4, v6}, Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;->D(LUc/b;)V
