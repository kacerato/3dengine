...
.field public final j:LUb/f;

.field public final synthetic k:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;


# direct methods
.method public constructor <init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;LAb/a;ZZZFFF)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->j:LUb/f;
    ...
    .line 6
    iput-object p3, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->c:LAb/a;
...
.method public synthetic constructor <init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;LAb/a;ZZZFFFLcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$k;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p9}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;LAb/a;ZZZFFF)V

    return-void
.end method

.method public static synthetic a(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;)LAb/a;
    .locals 0

    iget-object p0, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->c:LAb/a;
...
.method public e()V
    ...
    invoke-static {v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->x(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/TransformMiniFloatArrayJP;
    ...
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->j:LUb/f;

    invoke-virtual {v1, v0}, LUb/f;->L0([F)V

    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->c:LAb/a;

    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->j:LUb/f;

    invoke-interface {v1, v2}, LAb/a;->a(LUb/f;)V
    :try_end_1
    ...
    invoke-static {v1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->x(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/TransformMiniFloatArrayJP;
    ...
    invoke-static {v2}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->x(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/TransformMiniFloatArrayJP;
...
.method public g()V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->c:LAb/a;

    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform$D;->j:LUb/f;

    invoke-interface {v0, v1}, LAb/a;->a(LUb/f;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public h()J
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->g0()J
