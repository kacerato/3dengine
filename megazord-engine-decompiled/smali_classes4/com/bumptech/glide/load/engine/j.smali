...
.method public constructor <init>(LF/j;LF/a$a;LG/a;LG/a;LG/a;LG/a;Lcom/bumptech/glide/load/engine/q;Lcom/bumptech/glide/load/engine/n;Lcom/bumptech/glide/load/engine/a;Lcom/bumptech/glide/load/engine/j$b;Lcom/bumptech/glide/load/engine/j$a;Lcom/bumptech/glide/load/engine/w;Z)V
    .locals 11
    ...
    .line 3
    iput-object v8, v7, Lcom/bumptech/glide/load/engine/j;->c:LF/j;
    ...
    invoke-direct {v9, p2}, Lcom/bumptech/glide/load/engine/j$c;-><init>(LF/a$a;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/bumptech/glide/load/engine/j$b;-><init>(LG/a;LG/a;LG/a;LG/a;Lcom/bumptech/glide/load/engine/l;Lcom/bumptech/glide/load/engine/o$a;)V
    ...
    .line 18
    invoke-interface {p1, p0}, LF/j;->d(LF/j$a;)V

    return-void
.end method

.method public constructor <init>(LF/j;LF/a$a;LG/a;LG/a;LG/a;LG/a;Z)V
    .locals 14
...
.method public static k(Ljava/lang/String;JLB/e;)V
    ...
    invoke-static {p1, p2}, LX/g;->a(J)D
...
.method public b(LB/e;Lcom/bumptech/glide/load/engine/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->d(LB/e;)V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/j;->c:LF/j;

    invoke-interface {v0, p1, p2}, LF/j;->g(LB/e;Lcom/bumptech/glide/load/engine/t;)Lcom/bumptech/glide/load/engine/t;
...
.method public declared-synchronized c(Lcom/bumptech/glide/load/engine/k;LB/e;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p1}, Lcom/bumptech/glide/load/engine/q;->e(LB/e;Lcom/bumptech/glide/load/engine/k;)V
    :try_end_0
...
.method public declared-synchronized d(Lcom/bumptech/glide/load/engine/k;LB/e;Lcom/bumptech/glide/load/engine/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p3}, Lcom/bumptech/glide/load/engine/a;->a(LB/e;Lcom/bumptech/glide/load/engine/o;)V
    ...
    invoke-virtual {p3, p2, p1}, Lcom/bumptech/glide/load/engine/q;->e(LB/e;Lcom/bumptech/glide/load/engine/k;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public e()V
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/load/engine/j$c;->a()LF/a;
...
.method public final f(LB/e;)Lcom/bumptech/glide/load/engine/o;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p1}, LF/j;->f(LB/e;)Lcom/bumptech/glide/load/engine/t;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/bumptech/glide/load/engine/o;-><init>(Lcom/bumptech/glide/load/engine/t;ZZLB/e;Lcom/bumptech/glide/load/engine/o$a;)V
...
.method public g(Lcom/bumptech/glide/d;Ljava/lang/Object;LB/e;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/h;Lcom/bumptech/glide/load/engine/i;Ljava/util/Map;ZZLB/h;ZZZZLT/i;Ljava/util/concurrent/Executor;)Lcom/bumptech/glide/load/engine/j$d;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual/range {v0 .. v8}, Lcom/bumptech/glide/load/engine/n;->a(Ljava/lang/Object;LB/e;IILjava/util/Map;Ljava/lang/Class;Ljava/lang/Class;LB/h;)Lcom/bumptech/glide/load/engine/m;
    ...
    invoke-virtual/range {v1 .. v23}, Lcom/bumptech/glide/load/engine/j;->n(Lcom/bumptech/glide/d;Ljava/lang/Object;LB/e;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/h;Lcom/bumptech/glide/load/engine/i;Ljava/util/Map;ZZLB/h;ZZZZLT/i;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/m;J)Lcom/bumptech/glide/load/engine/j$d;
    ...
    invoke-interface {v2, v1, v0}, LT/i;->c(Lcom/bumptech/glide/load/engine/t;LB/a;)V
...
.method public final h(LB/e;)Lcom/bumptech/glide/load/engine/o;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->e(LB/e;)Lcom/bumptech/glide/load/engine/o;
...
.method public final i(LB/e;)Lcom/bumptech/glide/load/engine/o;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/j;->f(LB/e;)Lcom/bumptech/glide/load/engine/o;
    ...
    invoke-virtual {v1, p1, v0}, Lcom/bumptech/glide/load/engine/a;->a(LB/e;Lcom/bumptech/glide/load/engine/o;)V
...
.method public final j(Lcom/bumptech/glide/load/engine/m;ZJ)Lcom/bumptech/glide/load/engine/o;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/j;->h(LB/e;)Lcom/bumptech/glide/load/engine/o;
    ...
    invoke-static {v0, p3, p4, p1}, Lcom/bumptech/glide/load/engine/j;->k(Ljava/lang/String;JLB/e;)V

    :cond_1
    return-object p2

    :cond_2
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/j;->i(LB/e;)Lcom/bumptech/glide/load/engine/o;
...
.method public final n(Lcom/bumptech/glide/d;Ljava/lang/Object;LB/e;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/h;Lcom/bumptech/glide/load/engine/i;Ljava/util/Map;ZZLB/h;ZZZZLT/i;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/m;J)Lcom/bumptech/glide/load/engine/j$d;
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual {v3, v15, v12}, Lcom/bumptech/glide/load/engine/q;->a(LB/e;Z)Lcom/bumptech/glide/load/engine/k;

    move-result-object v3

    if-eqz v3, :cond_1

    invoke-virtual {v3, v1, v2}, Lcom/bumptech/glide/load/engine/k;->e(LT/i;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {v2, v13, v14, v15}, Lcom/bumptech/glide/load/engine/j;->k(Ljava/lang/String;JLB/e;)V

    :cond_0
    new-instance v2, Lcom/bumptech/glide/load/engine/j$d;

    invoke-direct {v2, v0, v1, v3}, Lcom/bumptech/glide/load/engine/j$d;-><init>(Lcom/bumptech/glide/load/engine/j;LT/i;Lcom/bumptech/glide/load/engine/k;)V
    ...
    invoke-virtual/range {v3 .. v8}, Lcom/bumptech/glide/load/engine/j$b;->a(LB/e;ZZZZ)Lcom/bumptech/glide/load/engine/k;
    ...
    invoke-virtual/range {v3 .. v19}, Lcom/bumptech/glide/load/engine/j$a;->a(Lcom/bumptech/glide/d;Ljava/lang/Object;Lcom/bumptech/glide/load/engine/m;LB/e;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/h;Lcom/bumptech/glide/load/engine/i;Ljava/util/Map;ZZZLB/h;Lcom/bumptech/glide/load/engine/g$b;)Lcom/bumptech/glide/load/engine/g;

    move-result-object v3

    iget-object v4, v0, Lcom/bumptech/glide/load/engine/j;->a:Lcom/bumptech/glide/load/engine/q;

    invoke-virtual {v4, v2, v1}, Lcom/bumptech/glide/load/engine/q;->d(LB/e;Lcom/bumptech/glide/load/engine/k;)V
    ...
    invoke-virtual {v5, v1, v2}, Lcom/bumptech/glide/load/engine/k;->e(LT/i;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {v2, v6, v7, v4}, Lcom/bumptech/glide/load/engine/j;->k(Ljava/lang/String;JLB/e;)V

    :cond_2
    new-instance v2, Lcom/bumptech/glide/load/engine/j$d;

    invoke-direct {v2, v0, v1, v5}, Lcom/bumptech/glide/load/engine/j$d;-><init>(Lcom/bumptech/glide/load/engine/j;LT/i;Lcom/bumptech/glide/load/engine/k;)V
