...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LG2/m;->a:Z

    iput-boolean v0, p0, LG2/m;->b:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, LG2/m;->c:Z

    new-instance v0, LG2/m$e;

    invoke-direct {v0}, LG2/m$e;-><init>()V

    iput-object v0, p0, LG2/m;->e:LG2/m$d;
...
.method public static synthetic a(Landroid/view/Window;)V
    ...
    invoke-static {p0}, LG2/m;->h(Landroid/view/Window;)V
...
.method public static synthetic b(Landroid/view/Window;)V
    ...
    invoke-static {p0}, LG2/m;->i(Landroid/view/Window;)V
...
.method public static synthetic c()Ljava/lang/ref/WeakReference;
    ...
    sget-object v0, LG2/m;->f:Ljava/lang/ref/WeakReference;
...
.method public static synthetic d(Ljava/lang/ref/WeakReference;)Ljava/lang/ref/WeakReference;
    ...
    sput-object p0, LG2/m;->f:Ljava/lang/ref/WeakReference;
...
.method public static o(Landroid/view/Window;LG2/l;)V
    .locals 4
...
# virtual methods
.method public e()LG2/m$d;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object v0, p0, LG2/m;->e:LG2/m$d;
...
.method public j(LG2/m$d;)V
    ...
    iput-object p1, p0, LG2/m;->e:LG2/m$d;
...
.method public final m(Landroid/view/Window;)V
    ...
    instance-of v1, v0, LG2/l;

    if-eqz v1, :cond_1

    check-cast v0, LG2/l;

    iget-boolean v1, p0, LG2/m;->c:Z
    ...
    invoke-static {p1, v0}, LG2/m;->o(Landroid/view/Window;LG2/l;)V

    new-instance v1, LG2/m$a;

    invoke-direct {v1, p0, p1}, LG2/m$a;-><init>(LG2/m;Landroid/view/Window;)V
...
.method public final n(Landroid/app/Activity;Landroid/view/Window;)V
    ...
    invoke-virtual {v0, v1}, LG2/l;->W(Z)V

    new-instance v1, LG2/m$b;

    invoke-direct {v1, p0, p1}, LG2/m$b;-><init>(LG2/m;Landroid/app/Activity;)V

    invoke-virtual {v0, v1}, Landroid/transition/Transition;->addListener(Landroid/transition/Transition$TransitionListener;)Landroid/transition/Transition;

    iget-boolean p1, p0, LG2/m;->b:Z

    if-eqz p1, :cond_0

    invoke-static {p2, v0}, LG2/m;->o(Landroid/view/Window;LG2/l;)V

    new-instance p1, LG2/m$c;

    invoke-direct {p1, p0, p2}, LG2/m$c;-><init>(LG2/m;Landroid/view/Window;)V
...
.method public onCaptureSharedElementSnapshot(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    ...
    sput-object v0, LG2/m;->f:Ljava/lang/ref/WeakReference;
...
.method public onCreateSnapshotView(Landroid/content/Context;Landroid/os/Parcelable;)Landroid/view/View;
    ...
    sget-object p2, LG2/m;->f:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v0, p2}, LG2/m$d;->a(Landroid/view/View;)Lv2/o;

    move-result-object p2

    if-eqz p2, :cond_0

    sget v0, LR1/a$h;->e3:I
...
.method public onMapSharedElements(Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, p2}, LG2/m;->m(Landroid/view/Window;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, LG2/m;->n(Landroid/app/Activity;Landroid/view/Window;)V
...
.method public onSharedElementEnd(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p1}, LG2/v;->i(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object p1

    iput-object p1, p0, LG2/m;->d:Landroid/graphics/Rect;

    :cond_1
    iput-boolean p3, p0, LG2/m;->a:Z
...
.method public onSharedElementStart(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object p1, p0, LG2/m;->d:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, LG2/m;->d:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, LG2/m;->d:Landroid/graphics/Rect;
