...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LY6/g;->d:Landroid/text/TextWatcher;

    return-void
.end method

.method public static synthetic o(LY6/g;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, LY6/g;->c:Ljava/lang/String;
...
.method private r()V
    ...
    new-instance v2, LY6/g$a;

    invoke-direct {v2, p0}, LY6/g$a;-><init>(LY6/g;)V

    invoke-direct {v1, v2}, LY6/a;-><init>(LX6/b;)V
...
.method private s()V
    ...
    new-instance v0, LY6/g$b;

    invoke-direct {v0, p0}, LY6/g$b;-><init>(LY6/g;)V
...
.method public inflateTopBarElements(Landroid/content/Context;Ljava/util/List;)V
    ...
    new-instance v1, LY6/g$d;

    invoke-direct {v1, p0}, LY6/g$d;-><init>(LY6/g;)V
...
.method public onClose(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, LY6/g;->hasScript()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, LY6/g;->saveScript(Landroid/content/Context;)Z

    :cond_0
    invoke-virtual {p0}, LY6/g;->unload()V
...
.method public openScript(LCd/b;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, LY6/g;->q(Ljava/lang/String;)V
...
.method public q(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, LY6/g;->init()V
    ...
    iput-object v0, p0, LY6/g;->c:Ljava/lang/String;
    ...
    iput-object v0, p0, LY6/g;->a:Ljava/lang/String;

    iput-object p1, p0, LY6/g;->b:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, LY6/g;->p(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p1, p0, LY6/g;->d:Landroid/text/TextWatcher;

    if-nez p1, :cond_1

    new-instance p1, LY6/g$c;

    invoke-direct {p1, p0}, LY6/g$c;-><init>(LY6/g;)V

    iput-object p1, p0, LY6/g;->d:Landroid/text/TextWatcher;
...
.method public replaceScript(LCd/b;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p2}, LY6/g;->saveScript(Landroid/content/Context;)Z
...
.method public saveScript(Landroid/content/Context;)Z
    ...
    :try_start_0
    iget-object v1, p0, LY6/g;->a:Ljava/lang/String;
    ...
    iput-object v1, p0, LY6/g;->a:Ljava/lang/String;

    iget-object v2, p0, LY6/g;->b:Ljava/lang/String;
...
.method public unload()V
    ...
    iput-object v0, p0, LY6/g;->b:Ljava/lang/String;
