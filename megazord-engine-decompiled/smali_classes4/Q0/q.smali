...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Lb1/a;-><init>(Ljava/lang/String;[Ljava/lang/String;)V

    sput-object v0, LQ0/q;->a:Lb1/a;
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v2, v1}, Lb1/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static b(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1}, LQ0/q;->a(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
...
.method public static d(Lcom/google/android/gms/common/api/l;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;Z)Lcom/google/android/gms/common/api/o;
    ...
    invoke-virtual {v0, v2, v3}, Lb1/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {p2}, LX0/A;->r(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p1}, LQ0/r;->a(Landroid/content/Context;)LQ0/r;

    move-result-object v2

    invoke-virtual {v2}, LQ0/r;->e()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->A0()Z
    ...
    :cond_4
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->s0()Z

    move-result v4

    if-eqz v4, :cond_6

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->s0()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->k0()Ljava/lang/String;

    move-result-object v5

    invoke-static {v4, v5}, LX0/y;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->e0()Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->e0()Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, LQ0/r;->d()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    move-result-object v2

    if-eqz v2, :cond_0

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->M0()Z
    ...
    invoke-direct {v4, v2, v5}, LP0/d;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, p2, p1}, Lb1/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v3, p2}, LP0/d;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, v1, p3}, Lb1/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance p3, LQ0/k;

    invoke-direct {p3, p0, p1, p2}, LQ0/k;-><init>(Lcom/google/android/gms/common/api/l;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)V
    ...
    invoke-direct {p1, p0}, LU0/l;-><init>(Lcom/google/android/gms/common/api/p;)V
...
.method public static e(Lcom/google/android/gms/common/api/l;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/p;
    ...
    invoke-static {p1}, LQ0/q;->h(Landroid/content/Context;)V
    ...
    invoke-direct {p1, p0}, LQ0/m;-><init>(Lcom/google/android/gms/common/api/l;)V
...
.method public static f(Lcom/google/android/gms/common/api/l;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/p;
    ...
    invoke-static {p1}, LQ0/c;->b(Landroid/content/Context;)LQ0/c;

    move-result-object v0

    invoke-virtual {v0}, LQ0/c;->e()Ljava/lang/String;
    ...
    invoke-static {v0}, LQ0/f;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/p;
    ...
    invoke-direct {p1, p0}, LQ0/o;-><init>(Lcom/google/android/gms/common/api/l;)V
...
.method public static g(Landroid/content/Intent;)LP0/d;
    .locals 3
    ...
    invoke-direct {p0, v0, v1}, LP0/d;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-direct {v0, p0, v1}, LP0/d;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
...
.method public static h(Landroid/content/Context;)V
    ...
    invoke-static {p0}, LQ0/r;->a(Landroid/content/Context;)LQ0/r;

    move-result-object p0

    invoke-virtual {p0}, LQ0/r;->b()V
