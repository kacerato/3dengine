...
.method public constructor <init>(Lokhttp3/z$b;)V
    ...
    invoke-static {v1}, LYg/c;->u(Ljava/util/List;)Ljava/util/List;
    ...
    .line 13
    iget-object v1, p1, Lokhttp3/z$b;->k:Lah/f;

    iput-object v1, p0, Lokhttp3/z;->l:Lah/f;
    ...
    .line 18
    :cond_3
    invoke-static {}, LYg/c;->D()Ljavax/net/ssl/X509TrustManager;
    ...
    .line 20
    invoke-static {v0}, Ljh/c;->b(Ljavax/net/ssl/X509TrustManager;)Ljh/c;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/z;->o:Ljh/c;
    ...
    .line 22
    iget-object v0, p1, Lokhttp3/z$b;->n:Ljh/c;
    ...
    invoke-virtual {v0, v1}, Lhh/f;->g(Ljavax/net/ssl/SSLSocketFactory;)V
    ...
    iget-object v1, p0, Lokhttp3/z;->o:Ljh/c;

    invoke-virtual {v0, v1}, Lokhttp3/g;->g(Ljh/c;)Lokhttp3/g;
...
.method public static u(Ljavax/net/ssl/X509TrustManager;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v0}, Lhh/f;->m()Ljavax/net/ssl/SSLContext;
    ...
    invoke-static {v0, p0}, LYg/c;->b(Ljava/lang/String;Ljava/lang/Exception;)Ljava/lang/AssertionError;
...
.method public b(Lokhttp3/C;Lokhttp3/J;)Lokhttp3/I;
    ...
    invoke-direct/range {v0 .. v5}, Lkh/a;-><init>(Lokhttp3/C;Lokhttp3/J;Ljava/util/Random;J)V

    invoke-virtual {v6, p0}, Lkh/a;->m(Lokhttp3/z;)V
...
.method public r()Lah/f;
    ...
    iget-object v0, v0, Lokhttp3/c;->b:Lah/f;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lokhttp3/z;->l:Lah/f;
