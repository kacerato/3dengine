...
.method public static a(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    invoke-static {p0, p1, v0}, LAi/c;->b(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
...
.method public static b(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
    ...
    invoke-direct {v0, p0}, LBi/a;-><init>(Ljava/io/InputStream;)V

    new-instance p0, LBi/b;

    invoke-direct {p0, p1}, LBi/b;-><init>(Ljava/io/OutputStream;)V

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {v0}, LBi/a;->readInt()I
    ...
    invoke-virtual {p0, v3}, LBi/b;->l(I)V

    const/4 v3, 0x2

    invoke-static {v0, p0, v3}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-virtual {v0}, LBi/a;->readShort()S

    move-result v1

    invoke-virtual {p0, v1}, LBi/b;->o(I)V
    ...
    invoke-virtual {p0, v7}, LBi/b;->o(I)V
    ...
    :goto_2
    invoke-static {v0, p0, v4}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-virtual {v0}, LBi/a;->readInt()I

    move-result v4

    invoke-virtual {p0, v4}, LBi/b;->l(I)V

    const/4 v8, 0x4

    invoke-static {v0, p0, v8}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-virtual {v0}, LBi/a;->readShort()S

    move-result v9

    invoke-virtual {p0, v9}, LBi/b;->o(I)V
    ...
    invoke-virtual {p0, v12}, LBi/b;->o(I)V

    goto :goto_4

    :cond_3
    invoke-virtual {p0, v10}, LBi/b;->o(I)V

    :goto_4
    invoke-static {v0, p0, v9}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-static {v0, p0, v10}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
    ...
    :cond_6
    invoke-virtual {v0}, LBi/a;->readByte()B

    move-result v1

    invoke-virtual {p0, v1}, LBi/b;->write(I)V
    ...
    invoke-static {v0, p0, v2}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {p0, v3}, LBi/b;->o(I)V
    ...
    invoke-virtual {p0, v8}, LBi/b;->o(I)V

    invoke-static {v0, p0, v4}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-virtual {v0}, LBi/a;->readInt()I

    invoke-virtual {p0, v1}, LBi/b;->l(I)V

    invoke-static {v0, p0, v3}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-static {v0, p0, v7}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {p0, p1}, LBi/b;->l(I)V

    invoke-static {v0, p0, v2}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V

    invoke-virtual {v0}, LBi/a;->readInt()I

    invoke-virtual {p0, p2}, LBi/b;->l(I)V

    invoke-virtual {v0}, LBi/a;->readShort()S

    move-result p1

    invoke-virtual {p0, p1}, LBi/b;->o(I)V

    invoke-static {v0, p0, p1}, LAi/c;->h(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
...
.method public static c(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;)V
    ...
    invoke-static {p0, p1, v0, v1}, LAi/c;->f(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;IZ)V
...
.method public static d(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;I)V
    ...
    invoke-static {p0, p1, p2, v0}, LAi/c;->f(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;IZ)V
...
.method public static e(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;II)V
    ...
    invoke-direct {v12, v8}, LAi/b;-><init>(Ljava/nio/ByteBuffer;)V

    invoke-virtual {v12}, LAi/b;->c()I

    move-result v8

    invoke-virtual {v12}, LAi/b;->a()J
    ...
    invoke-direct {v11, v10}, LAi/b;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v11, v7}, LAi/b;->d(I)I

    move-result v7

    const/16 v8, 0x1e

    invoke-virtual {v11, v8}, LAi/b;->d(I)I
    ...
    invoke-virtual {v11, v9}, LAi/b;->d(I)I
    ...
    invoke-virtual {v11, v5}, LAi/b;->b(I)J
    ...
    invoke-direct {v1, v8, v9, v12, v13}, LAi/c$b;-><init>(JJ)V
    ...
    invoke-direct {v8, v1}, LAi/b;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct/range {v35 .. v40}, LAi/c$a;-><init>(IJSI)V
    ...
    invoke-direct {v12, v11}, LAi/b;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct/range {v31 .. v36}, LAi/c$a;-><init>(IJSI)V
    ...
    check-cast v2, LAi/c$a;

    iget-wide v5, v2, LAi/c$a;->b:J
    ...
    invoke-static {v0, v3, v5, v6}, LAi/c;->i(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;J)V

    :cond_f
    iget-short v5, v2, LAi/c$a;->c:S
    ...
    iget v4, v2, LAi/c$a;->d:I

    int-to-long v4, v4

    invoke-static {v0, v3, v4, v5}, LAi/c;->i(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;J)V

    iget v2, v2, LAi/c$a;->a:I
    ...
    check-cast v2, LAi/c$b;

    iget-wide v9, v2, LAi/c$b;->a:J
    ...
    invoke-static {v0, v3, v9, v10}, LAi/c;->i(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;J)V

    iget-wide v9, v2, LAi/c$b;->b:J
    ...
    invoke-static {v0, v3, v1, v2}, LAi/c;->i(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;J)V
...
.method public static f(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;IZ)V
    ...
    invoke-static {p0, p1, p2, p3}, LAi/c;->e(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;II)V
...
.method public static g(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;Z)V
    ...
    invoke-static {p0, p1, v0, p2}, LAi/c;->f(Ljava/io/RandomAccessFile;Ljava/io/OutputStream;IZ)V
