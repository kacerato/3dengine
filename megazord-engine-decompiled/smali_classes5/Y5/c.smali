...
.method public static synthetic a(LW5/b;Landroid/view/View;Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, LY5/c;->c(LW5/b;Landroid/view/View;Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z
...
.method public static synthetic c(LW5/b;Landroid/view/View;Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z
    .locals 2
    ...
    invoke-static {p2, p3}, Lmd/b;->f(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-interface {p0, p3}, LX5/h;->set(Lcom/itsmagic/engine/Engines/Utils/Variable;)V
...
# virtual methods
.method public b(LW5/b;Landroid/view/View;Landroid/widget/TextView;I)V
    .locals 1
    ...
    iget-object p3, p1, LW5/b;->b:LX5/h;
    ...
    iget-object v0, p1, LW5/b;->f:LX5/i;

    if-eqz v0, :cond_0

    new-instance v0, LY5/c$a;

    invoke-direct {v0, p0, p1, p4}, LY5/c$a;-><init>(LY5/c;LW5/b;I)V
    ...
    invoke-interface {p3}, LX5/h;->get()Lcom/itsmagic/engine/Engines/Utils/Variable;
    ...
    invoke-static {p3, p4}, Lmd/b;->f(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p3

    invoke-static {p3, p2}, Lcom/itsmagic/engine/Activities/Editor/Utils/F;->d(Ljava/lang/String;Landroid/view/View;)V

    new-instance p3, LY5/c$b;

    invoke-direct {p3, p0, p1, p2}, LY5/c$b;-><init>(LY5/c;LW5/b;Landroid/view/View;)V
    ...
    :cond_1
    :goto_0
    new-instance p4, LY5/b;

    invoke-direct {p4, p1, p2}, LY5/b;-><init>(LW5/b;Landroid/view/View;)V
    ...
    new-instance p4, LY5/c$c;

    invoke-direct {p4, p0, p1, p2}, LY5/c$c;-><init>(LY5/c;LW5/b;Landroid/view/View;)V
    ...
    new-instance p4, LY5/c$d;

    invoke-direct {p4, p0, p1, p2}, LY5/c$d;-><init>(LY5/c;LW5/b;Landroid/view/View;)V
