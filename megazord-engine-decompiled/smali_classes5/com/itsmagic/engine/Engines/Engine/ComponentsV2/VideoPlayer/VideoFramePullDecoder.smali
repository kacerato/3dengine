...
.method private static native nativeConvertYuv420888ToRgb(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IIIIIIIILjava/nio/ByteBuffer;IIZIIIFI)V
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
            0x0,
...
.method public final c()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->x:LT9/c;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    iget-object v1, v1, LT9/c;->a:Ljava/nio/ByteBuffer;

    iput-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->x:LT9/c;
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->s(Ljava/nio/ByteBuffer;)V
...
.method public final d(Landroid/media/Image;Ljava/nio/ByteBuffer;II)V
    .locals 24
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-boolean v2, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->f:Z

    move/from16 v17, v2

    iget v2, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->g:I

    move/from16 v18, v2

    iget v2, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->h:I

    move/from16 v19, v2

    iget v2, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->i:I

    move/from16 v20, v2

    iget v2, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->j:F

    move/from16 v21, v2

    iget v2, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->k:I
    ...
    invoke-static/range {v3 .. v22}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->nativeConvertYuv420888ToRgb(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IIIIIIIILjava/nio/ByteBuffer;IIZIIIFI)V
...
.method public final e()V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->f()LT9/c;
    ...
    :cond_3
    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->g(LT9/c;)V

    goto :goto_0

    :cond_4
    :goto_1
    iget-object v0, v0, LT9/c;->a:Ljava/nio/ByteBuffer;

    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->s(Ljava/nio/ByteBuffer;)V
...
.method public final f()LT9/c;
    ...
    :cond_e
    iget-object v8, v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder$a;->a:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v2, v8, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->d(Landroid/media/Image;Ljava/nio/ByteBuffer;II)V
    ...
    invoke-direct/range {v7 .. v12}, LT9/c;-><init>(Ljava/nio/ByteBuffer;IIJ)V
...
.method public final g(LT9/c;)V
    ...
    :goto_0
    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->x:LT9/c;
    ...
    invoke-virtual {p0, v1}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->s(Ljava/nio/ByteBuffer;)V
...
.method public final h()V
    ...
    invoke-direct {v1, p0}, LT9/d;-><init>(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;)V
...
.method public j()LT9/c;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->x:LT9/c;

    iput-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder;->x:LT9/c;
...
.method public s(Ljava/nio/ByteBuffer;)V
    ...
    iget-object v6, v5, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/VideoPlayer/VideoFramePullDecoder$a;->a:Ljava/nio/ByteBuffer;
