...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, LYg/c;->v([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lfh/e;->o:Ljava/util/List;
    ...
    sput-object v0, Lfh/e;->p:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lokhttp3/z;Lokhttp3/w$a;Lch/f;Lfh/f;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lfh/e;->b:Lokhttp3/w$a;

    iput-object p3, p0, Lfh/e;->c:Lch/f;

    iput-object p4, p0, Lfh/e;->d:Lfh/f;
    ...
    :goto_0
    iput-object p2, p0, Lfh/e;->f:Lokhttp3/A;
...
.method public static g(Lokhttp3/C;)Ljava/util/List;
    ...
    sget-object v3, Lfh/b;->k:Llh/f;

    invoke-virtual {p0}, Lokhttp3/C;->g()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lfh/b;-><init>(Llh/f;Ljava/lang/String;)V

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v2, Lfh/b;

    sget-object v3, Lfh/b;->l:Llh/f;

    invoke-virtual {p0}, Lokhttp3/C;->k()Lokhttp3/v;

    move-result-object v4

    invoke-static {v4}, Ldh/i;->c(Lokhttp3/v;)Ljava/lang/String;
    ...
    sget-object v4, Lfh/b;->n:Llh/f;

    invoke-direct {v3, v4, v2}, Lfh/b;-><init>(Llh/f;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, p0}, Lfh/b;-><init>(Llh/f;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Llh/f;->m(Ljava/lang/String;)Llh/f;

    move-result-object v3

    sget-object v4, Lfh/e;->o:Ljava/util/List;
    ...
    invoke-direct {v4, v3, v5}, Lfh/b;-><init>(Llh/f;Ljava/lang/String;)V
...
.method public static h(Lokhttp3/u;Lokhttp3/A;)Lokhttp3/E$a;
    ...
    invoke-static {v2}, Ldh/k;->b(Ljava/lang/String;)Ldh/k;
    ...
    :cond_0
    sget-object v6, Lfh/e;->p:Ljava/util/List;
    ...
    invoke-virtual {v6, v0, v4, v5}, LYg/a;->b(Lokhttp3/u$a;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget p1, v2, Ldh/k;->b:I

    invoke-virtual {p0, p1}, Lokhttp3/E$a;->g(I)Lokhttp3/E$a;

    move-result-object p0

    iget-object p1, v2, Ldh/k;->c:Ljava/lang/String;
...
.method public a()V
    ...
    iget-object v0, p0, Lfh/e;->e:Lfh/h;

    invoke-virtual {v0}, Lfh/h;->l()Llh/x;
...
.method public b(Lokhttp3/C;J)Llh/x;
    ...
    iget-object p1, p0, Lfh/e;->e:Lfh/h;

    invoke-virtual {p1}, Lfh/h;->l()Llh/x;
...
.method public c(Lokhttp3/C;)V
    ...
    :goto_0
    invoke-static {p1}, Lfh/e;->g(Lokhttp3/C;)Ljava/util/List;

    move-result-object p1

    iget-object v1, p0, Lfh/e;->d:Lfh/f;

    invoke-virtual {v1, p1, v0}, Lfh/f;->o(Ljava/util/List;Z)Lfh/h;

    move-result-object p1

    iput-object p1, p0, Lfh/e;->e:Lfh/h;

    invoke-virtual {p1}, Lfh/h;->p()Llh/z;

    move-result-object p1

    iget-object v0, p0, Lfh/e;->b:Lokhttp3/w$a;
    ...
    invoke-virtual {p1, v0, v1, v2}, Llh/z;->h(JLjava/util/concurrent/TimeUnit;)Llh/z;

    iget-object p1, p0, Lfh/e;->e:Lfh/h;

    invoke-virtual {p1}, Lfh/h;->y()Llh/z;

    move-result-object p1

    iget-object v0, p0, Lfh/e;->b:Lokhttp3/w$a;

    invoke-interface {v0}, Lokhttp3/w$a;->e()I
...
.method public d(Lokhttp3/E;)Lokhttp3/F;
    ...
    iget-object v0, p0, Lfh/e;->c:Lch/f;
    ...
    iget-object v3, p0, Lfh/e;->e:Lfh/h;

    invoke-virtual {v3}, Lfh/h;->m()Llh/y;

    move-result-object v3

    invoke-direct {p1, p0, v3}, Lfh/e$a;-><init>(Lfh/e;Llh/y;)V
...
.method public e(Z)Lokhttp3/E$a;
    ...
    invoke-virtual {v0}, Lfh/h;->v()Lokhttp3/u;

    move-result-object v0

    iget-object v1, p0, Lfh/e;->f:Lokhttp3/A;

    invoke-static {v0, v1}, Lfh/e;->h(Lokhttp3/u;Lokhttp3/A;)Lokhttp3/E$a;
    ...
    invoke-virtual {p1, v0}, LYg/a;->d(Lokhttp3/E$a;)I
...
.method public f()V
    ...
    iget-object v0, p0, Lfh/e;->d:Lfh/f;
