...
# static fields
.field public static final d:Lj0/r$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lj0/r$a;-><init>(Lkotlin/jvm/internal/x;)V

    sput-object v0, Lj0/r;->d:Lj0/r$a;
    ...
    filled-new-array/range {v2 .. v7}, [LFf/Z;

    move-result-object v0

    invoke-static {v0}, LHf/o0;->W([LFf/Z;)Ljava/util/Map;

    move-result-object v0

    sput-object v0, Lj0/r;->e:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(Ljava/lang/Object;Log/h;Z)V
    .locals 1
    ...
    iput-object p1, p0, Lj0/r;->a:Ljava/lang/Object;

    iput-object p2, p0, Lj0/r;->b:Log/h;

    iput-boolean p3, p0, Lj0/r;->c:Z
...
.method public static synthetic c(Lkotlin/reflect/KClass;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Lj0/r;->h(Lkotlin/reflect/KClass;)Ljava/lang/CharSequence;
...
.method public a()Lcom/google/gson/JsonObject;
    ...
    iget-object v0, p0, Lj0/r;->b:Log/h;

    invoke-interface {v0}, Log/b;->getAnnotations()Ljava/util/List;
    ...
    :cond_3
    invoke-interface {v1}, Lj0/v;->description()Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lj0/r;->c:Z

    if-eqz v3, :cond_4

    iget-object v3, p0, Lj0/r;->b:Log/h;

    invoke-interface {v3}, Log/c;->getName()Ljava/lang/String;

    move-result-object v3

    invoke-static {v3}, Lj0/z;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0}, Log/c;->getParameters()Ljava/util/List;
    ...
    invoke-static {v0, v4}, LHf/S;->g2(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-interface {v6}, Log/b;->getAnnotations()Ljava/util/List;
    ...
    :goto_5
    invoke-interface {v6}, Log/m;->getType()Log/r;

    move-result-object v7

    invoke-virtual {p0, v7}, Lj0/r;->g(Log/r;)Lcom/google/gson/JsonObject;

    move-result-object v7

    if-eqz v8, :cond_8

    invoke-interface {v8}, Lj0/B;->description()Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {p0, v6}, Lj0/r;->j(Log/m;)Ljava/lang/String;
    ...
    invoke-interface {v3}, Log/m;->S()Z

    move-result v5

    if-nez v5, :cond_b

    invoke-virtual {p0, v3}, Lj0/r;->j(Log/m;)Ljava/lang/String;
...
.method public b(Lcom/google/gson/JsonObject;)Ljava/lang/Object;
    ...
    invoke-static {v2}, LHf/n0;->j(I)I

    move-result v2

    const/16 v3, 0x10

    invoke-static {v2, v3}, Lng/u;->w(II)I
    ...
    invoke-interface {v3}, Log/m;->getIndex()I

    move-result v4

    if-nez v4, :cond_0

    iget-object v3, p0, Lj0/r;->a:Ljava/lang/Object;

    goto :goto_1

    :cond_0
    invoke-interface {v3}, Log/m;->getName()Ljava/lang/String;
    ...
    invoke-interface {v3}, Log/m;->getType()Log/r;

    move-result-object v3

    invoke-virtual {p0, v4, v3}, Lj0/r;->d(Lcom/google/gson/JsonElement;Log/r;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Log/c;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public final d(Lcom/google/gson/JsonElement;Log/r;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-interface {p2}, Log/r;->w()Log/f;
    ...
    invoke-interface {p2}, Log/r;->getArguments()Ljava/util/List;

    move-result-object p2

    invoke-static {p2}, LHf/S;->L2(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Log/t;->g()Log/r;
    ...
    invoke-static {p1, v1}, LHf/I;->d0(Ljava/lang/Iterable;I)I
    ...
    invoke-virtual {p0, v1, p2}, Lj0/r;->d(Lcom/google/gson/JsonElement;Log/r;)Ljava/lang/Object;
...
.method public final e()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lj0/r;->a:Ljava/lang/Object;

    return-object v0
.end method

.method public final f()Log/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final g(Log/r;)Lcom/google/gson/JsonObject;
    .locals 11
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-interface {p1}, Log/r;->w()Log/f;

    move-result-object v0

    sget-object v1, Lj0/r;->e:Ljava/util/Map;
    ...
    invoke-interface {p1}, Log/r;->getArguments()Ljava/util/List;

    move-result-object p1

    invoke-static {p1}, LHf/S;->L2(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Log/t;->g()Log/r;
    ...
    invoke-virtual {p0, p1}, Lj0/r;->g(Log/r;)Lcom/google/gson/JsonObject;
...
.method public final i()Z
    ...
    iget-boolean v0, p0, Lj0/r;->c:Z

    return v0
.end method

.method public final j(Log/m;)Ljava/lang/String;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-interface {p1}, Log/m;->getName()Ljava/lang/String;
    ...
    invoke-static {p1}, Lj0/z;->c(Ljava/lang/String;)Ljava/lang/String;
