...
.method public static c(Ljava/io/File;Landroid/content/Context;)Lbd/k;
    .locals 4
    ...
    invoke-static {v0, p1}, Lp8/a;->z(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->w1()V

    invoke-virtual {v2, p1, v1, p0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->G0(Landroid/content/Context;Lbd/k;Ljava/io/File;)V
    ...
    invoke-static {v0, v1, v3}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->c0(Ljava/lang/String;ZZ)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    move-result-object v0

    if-eqz v0, :cond_4

    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->w1()V

    new-instance v1, Lbd/k;

    invoke-direct {v1}, Lbd/k;-><init>()V

    invoke-virtual {v0, p1, v1, p0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->G0(Landroid/content/Context;Lbd/k;Ljava/io/File;)V
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->getDependencyFiles(Lbd/h;)Lbd/k;
    ...
    :try_start_0
    invoke-static {p0}, LOb/e;->f(Ljava/io/File;)Lcom/itsmagic/engine/Engines/Engine/Texture/Cubemap/CubemapConfig;
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Engines/Graphics/ShaderGraph/VulkanGraph;->c(Lbd/h;)Lbd/k;
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeGraph;->c(Lbd/h;)Lbd/k;
...
.method public static d(Ljava/io/File;Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Utils/h;->c(Ljava/io/File;Landroid/content/Context;)Lbd/k;

    move-result-object p0

    if-eqz p0, :cond_3

    iget-object p1, p0, Lbd/k;->a:Ljava/util/List;
    ...
    :goto_0
    iget-object v1, p0, Lbd/k;->a:Ljava/util/List;
...
.method public static e(Landroid/content/Context;Lcom/itsmagic/engine/Activities/Editor/Utils/h$b;)Ljava/util/LinkedHashSet;
    ...
    invoke-virtual {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/Settings/GameSettings;->c(Lbd/h;)Lbd/k;
...
.method public static f(Ljava/io/File;Ljava/util/List;Lcom/itsmagic/engine/Activities/Editor/Utils/h$b;)V
    ...
    invoke-static {v3}, Lmd/b;->t(Ljava/lang/String;)Ljava/lang/String;
...
.method public static n(Landroid/content/Context;Lcom/itsmagic/engine/Activities/Editor/Utils/h$b;)Lcom/itsmagic/engine/Activities/Editor/Utils/h$c;
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Engines/Engine/Settings/GameSettings;->c(Lbd/h;)Lbd/k;
