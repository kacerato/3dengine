...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v1}, Lhh/f;->l()Ljava/lang/String;
...
.method public constructor <init>(Llh/y;)V
    ...
    .line 3
    invoke-interface {v0}, Llh/e;->E1()Ljava/lang/String;
    ...
    .line 6
    invoke-static {v0}, Lokhttp3/c;->o(Llh/e;)I
    ...
    invoke-static {v1}, Ldh/k;->b(Ljava/lang/String;)Ldh/k;

    move-result-object v1

    .line 10
    iget-object v2, v1, Ldh/k;->a:Lokhttp3/A;

    iput-object v2, p0, Lokhttp3/c$e;->d:Lokhttp3/A;

    .line 11
    iget v2, v1, Ldh/k;->b:I

    iput v2, p0, Lokhttp3/c$e;->e:I

    .line 12
    iget-object v1, v1, Ldh/k;->c:Ljava/lang/String;
    ...
    .line 30
    invoke-virtual {p0, v0}, Lokhttp3/c$e;->c(Llh/e;)Ljava/util/List;
    ...
    .line 38
    :goto_4
    invoke-interface {p1}, Llh/y;->close()V
...
.method public constructor <init>(Lokhttp3/E;)V
    ...
    .line 41
    invoke-static {p1}, Ldh/e;->u(Lokhttp3/E;)Lokhttp3/u;
    ...
    .line 43
    invoke-virtual {p1}, Lokhttp3/E;->v()Lokhttp3/A;
    ...
    .line 46
    invoke-virtual {p1}, Lokhttp3/E;->n()Lokhttp3/u;
    ...
    .line 48
    invoke-virtual {p1}, Lokhttp3/E;->y()J
    ...
    .line 49
    invoke-virtual {p1}, Lokhttp3/E;->w()J
...
.method public b(Lokhttp3/C;Lokhttp3/E;)Z
    ...
    invoke-static {p2, v0, p1}, Ldh/e;->v(Lokhttp3/E;Lokhttp3/u;Lokhttp3/C;)Z
...
.method public final c(Llh/e;)Ljava/util/List;
    .locals 6
    ...
    invoke-static {p1}, Lokhttp3/c;->o(Llh/e;)I
    ...
    invoke-interface {p1}, Llh/e;->E1()Ljava/lang/String;
    ...
    invoke-static {v4}, Llh/f;->g(Ljava/lang/String;)Llh/f;

    move-result-object v4

    invoke-virtual {v5, v4}, Llh/c;->h0(Llh/f;)Llh/c;

    invoke-virtual {v5}, Llh/c;->g2()Ljava/io/InputStream;
...
.method public d(Lah/d$f;)Lokhttp3/E;
    .locals 5
    ...
    invoke-direct {v3, p1, v0, v1}, Lokhttp3/c$d;-><init>(Lah/d$f;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final e(Llh/d;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Llh/d;->O(J)Llh/d;

    move-result-object v0

    const/16 v1, 0xa

    invoke-interface {v0, v1}, Llh/d;->writeByte(I)Llh/d;
    ...
    invoke-static {v3}, Llh/f;->I([B)Llh/f;
    ...
    invoke-interface {p1, v3}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v3

    invoke-interface {v3, v1}, Llh/d;->writeByte(I)Llh/d;
    :try_end_0
...
.method public f(Lah/d$d;)V
    ...
    invoke-virtual {p1, v0}, Lah/d$d;->e(I)Llh/x;
    ...
    invoke-interface {p1, v3, v4}, Llh/d;->O(J)Llh/d;
    ...
    invoke-interface {p1, v5}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v5

    invoke-interface {v5, v4}, Llh/d;->J(Ljava/lang/String;)Llh/d;
    ...
    invoke-interface {v4, v5}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v4

    invoke-interface {v4, v2}, Llh/d;->writeByte(I)Llh/d;
    ...
    invoke-direct {v1, v3, v5, v6}, Ldh/k;-><init>(Lokhttp3/A;ILjava/lang/String;)V

    invoke-virtual {v1}, Ldh/k;->toString()Ljava/lang/String;
    ...
    invoke-interface {p1, v5, v6}, Llh/d;->O(J)Llh/d;
    ...
    invoke-interface {v3, v4}, Llh/d;->J(Ljava/lang/String;)Llh/d;
    ...
    invoke-interface {v3, v5}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v3

    invoke-interface {v3, v2}, Llh/d;->writeByte(I)Llh/d;
    ...
    invoke-interface {v0, v5, v6}, Llh/d;->O(J)Llh/d;
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/c$e;->e(Llh/d;Ljava/util/List;)V
    ...
    :cond_2
    invoke-interface {p1}, Llh/x;->close()V
