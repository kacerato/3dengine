...
.method public static a(Ljava/nio/ByteBuffer;III)I
    ...
    invoke-static {p0, p2}, Lnet/jpountz/util/a;->j(Ljava/nio/ByteBuffer;I)J

    move-result-wide v1

    invoke-static {p0, p1}, Lnet/jpountz/util/a;->j(Ljava/nio/ByteBuffer;I)J
    ...
    invoke-static {p0, p1}, Lnet/jpountz/util/a;->g(Ljava/nio/ByteBuffer;I)B

    move-result p1

    add-int/lit8 v2, p2, 0x1

    invoke-static {p0, p2}, Lnet/jpountz/util/a;->g(Ljava/nio/ByteBuffer;I)B
...
.method public static b(Ljava/nio/ByteBuffer;IIII)I
    .locals 3
...
.method public static c(Lnet/jpountz/lz4/c$a;Lnet/jpountz/lz4/c$a;)V
    .locals 1
...
.method public static d(Ljava/nio/ByteBuffer;IIIILjava/nio/ByteBuffer;II)I
    .locals 5
    ...
    invoke-static {v4, p5, v1}, Lnet/jpountz/lz4/c;->o(ILjava/nio/ByteBuffer;I)I
    ...
    :goto_0
    invoke-static {p0, p1, p5, v1, v0}, Lnet/jpountz/lz4/c;->m(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II)V
    ...
    invoke-static {p4, p5, p1}, Lnet/jpountz/lz4/c;->o(ILjava/nio/ByteBuffer;I)I
...
.method public static e(Ljava/nio/ByteBuffer;I)I
    ...
    invoke-static {p0, p1}, Lnet/jpountz/util/a;->h(Ljava/nio/ByteBuffer;I)I

    move-result p0

    invoke-static {p0}, Lnet/jpountz/lz4/C;->b(I)I
...
.method public static g(Ljava/nio/ByteBuffer;I)I
    ...
    invoke-static {p0}, Lnet/jpountz/lz4/C;->e(I)I
...
.method public static h(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;II)I
    .locals 2
    ...
    invoke-static {p4, p3, p5}, Lnet/jpountz/lz4/c;->o(ILjava/nio/ByteBuffer;I)I
    ...
    :goto_0
    invoke-static {p0, p1, p3, p4, p2}, Lnet/jpountz/lz4/c;->j(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II)V
...
.method public static j(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II)V
    .locals 3
...
.method public static k(Ljava/nio/ByteBuffer;III)V
    .locals 3
...
.method public static m(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;II)V
    .locals 4
...
.method public static n(Ljava/nio/ByteBuffer;III)V
    .locals 8
    ...
    invoke-static {p0, v5}, Lnet/jpountz/util/a;->g(Ljava/nio/ByteBuffer;I)B

    move-result v5

    invoke-static {p0, v4, v5}, Lnet/jpountz/util/a;->n(Ljava/nio/ByteBuffer;II)V
    ...
    :goto_1
    invoke-static {p0, v3}, Lnet/jpountz/util/a;->h(Ljava/nio/ByteBuffer;I)I

    move-result p1

    invoke-static {p0, v2, p1}, Lnet/jpountz/util/a;->o(Ljava/nio/ByteBuffer;II)V
    ...
    invoke-static {p0, p2, v2, v3}, Lnet/jpountz/util/a;->p(Ljava/nio/ByteBuffer;IJ)V
...
.method public static o(ILjava/nio/ByteBuffer;I)I
    .locals 2
