...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LXg/f;->a:[B

    const/4 v0, 0x4

    new-array v0, v0, [B

    iput-object v0, p0, LXg/f;->b:[B

    const/16 v0, 0x8

    new-array v0, v0, [B

    iput-object v0, p0, LXg/f;->c:[B
...
.method public final a(Ljava/io/InputStream;[BI)V
    ...
    invoke-static {p1, p2, v0, p3}, LXg/h;->m(Ljava/io/InputStream;[BII)I
...
.method public b(Ljava/io/InputStream;)I
    ...
    iget-object v0, p0, LXg/f;->b:[B

    const/4 v1, 0x4

    invoke-virtual {p0, p1, v0, v1}, LXg/f;->a(Ljava/io/InputStream;[BI)V

    iget-object p1, p0, LXg/f;->b:[B

    invoke-virtual {p0, p1}, LXg/f;->d([B)I
...
.method public d([B)I
    ...
    invoke-virtual {p0, p1, v0}, LXg/f;->e([BI)I
...
.method public f(Ljava/io/InputStream;)J
    ...
    iget-object v0, p0, LXg/f;->c:[B

    array-length v1, v0

    invoke-virtual {p0, p1, v0, v1}, LXg/f;->a(Ljava/io/InputStream;[BI)V

    iget-object p1, p0, LXg/f;->c:[B

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, LXg/f;->j([BI)J
...
.method public g(Ljava/io/InputStream;I)J
    ...
    invoke-virtual {p0, v0}, LXg/f;->n([B)V

    iget-object v0, p0, LXg/f;->c:[B

    invoke-virtual {p0, p1, v0, p2}, LXg/f;->a(Ljava/io/InputStream;[BI)V

    iget-object p1, p0, LXg/f;->c:[B

    const/4 p2, 0x0

    invoke-virtual {p0, p1, p2}, LXg/f;->j([BI)J
...
.method public i(Ljava/io/RandomAccessFile;I)J
    ...
    invoke-virtual {p0, p1, v1}, LXg/f;->j([BI)J
...
.method public k(Ljava/io/InputStream;)I
    ...
    iget-object v0, p0, LXg/f;->a:[B

    array-length v1, v0

    invoke-virtual {p0, p1, v0, v1}, LXg/f;->a(Ljava/io/InputStream;[BI)V

    iget-object p1, p0, LXg/f;->a:[B

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, LXg/f;->m([BI)I
...
.method public o(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {p0, v0, v1, p2}, LXg/f;->p([BII)V

    iget-object p2, p0, LXg/f;->b:[B
...
.method public q(Ljava/io/OutputStream;J)V
    ...
    invoke-virtual {p0, v0, v1, p2, p3}, LXg/f;->r([BIJ)V

    iget-object p2, p0, LXg/f;->c:[B
...
.method public s(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {p0, v0, v1, p2}, LXg/f;->t([BII)V

    iget-object p2, p0, LXg/f;->a:[B
