...
# static fields
.field public static final d1:F = 5.0f

.field public static final e1:Ljava/lang/String; = "UIPinchDetector"

.field public static final f1:Ljava/lang/Class;


# instance fields
.field public D0:LMc/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->f1:Ljava/lang/Class;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Z0:F

    const/high16 v0, 0x41700000    # 15.0f

    iput v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->a1:F

    return-void
.end method

.method private calculate(LMc/h;LMc/h;)V
    .locals 13
    ...
    invoke-virtual {p1, v0}, LMc/h;->h(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->calculateTouchSlide(LMc/h;ZLcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V
    ...
    invoke-direct/range {v7 .. v12}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->calculateTouchSlide(LMc/h;ZLcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V
    ...
    invoke-virtual {p1, p2}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->Q(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)F

    move-result p1

    iget p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->b1:F
    ...
    :goto_0
    iput p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->b1:F

    return-void
.end method

.method private calculateTouchSlide(LMc/h;ZLcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->getTouchPosXOnUI(LMc/h;)F

    move-result v0

    invoke-direct {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->getTouchPosYOnUI(LMc/h;)F
    ...
    iget-object p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->v0:LMc/h;

    if-eq p2, p1, :cond_0

    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->v0:LMc/h;

    iput-boolean v4, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->X0:Z

    :cond_0
    invoke-virtual {p4, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    iget-boolean p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->X0:Z

    if-nez p2, :cond_1

    iput-boolean v3, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->X0:Z

    invoke-virtual {p5, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    invoke-virtual {p3, v5, v5}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    return-void

    :cond_1
    invoke-virtual {p5}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->k0()F

    move-result p2

    sub-float p2, v0, p2

    invoke-virtual {p3, p2}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->X0(F)V

    invoke-virtual {p5}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->l0()F

    move-result p2

    sub-float p2, v1, p2

    invoke-virtual {p3, p2}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->Y0(F)V
    ...
    :cond_2
    iget-object p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->D0:LMc/h;

    if-eq p2, p1, :cond_3

    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->D0:LMc/h;

    iput-boolean v4, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Y0:Z

    :cond_3
    invoke-virtual {p4, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    iget-boolean p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Y0:Z

    if-nez p2, :cond_4

    iput-boolean v3, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Y0:Z
    ...
    invoke-static {p1, p2, p4}, Lgd/b;->E(FFF)F
    ...
    iget p2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Z0:F

    invoke-static {p1, p2}, Lgd/b;->j0(FF)F
    ...
    iget p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->a1:F

    invoke-virtual {p3, p1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->v0(F)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
...
.method private getTouchAt(I)LMc/h;
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {v0, v3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->getSelectedTouchAt(I)LMc/h;
...
.method private getTouchPosXOnUI(LMc/h;)F
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method private getTouchPosYOnUI(LMc/h;)F
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method private resetPinch()V
    ...
    invoke-virtual {v2, v1, v1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->v0:LMc/h;

    iput-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->D0:LMc/h;

    iput-boolean v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->X0:Z

    iput-boolean v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Y0:Z

    iput v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->b1:F
...
.method public getDeadzone()F
    ...
    iget v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Z0:F
...
.method public getIntensityMultiplier()F
    ...
    iget v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->a1:F
...
.method public preUpdate(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->getTouchAt(I)LMc/h;

    move-result-object v0

    invoke-direct {p0, p2}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->getTouchAt(I)LMc/h;
    ...
    invoke-direct {p0, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->calculate(LMc/h;LMc/h;)V
...
.method public setDeadzone(F)V
    ...
    iput p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->Z0:F
...
.method public setIntensityMultiplier(F)V
    ...
    iput p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->a1:F
...
.method public setRuntime(LJAVARuntime/Component;)V
    ...
    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->c1:LJAVARuntime/Component;
...
.method public toJAVARuntime()LJAVARuntime/Component;
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->c1:LJAVARuntime/Component;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIPinchDetector;->c1:LJAVARuntime/Component;
