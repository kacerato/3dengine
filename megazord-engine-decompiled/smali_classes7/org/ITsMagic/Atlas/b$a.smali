...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/ITsMagic/Atlas/b;->p(LMb/p;ILorg/ITsMagic/Atlas/c$b;)V
.end annotation
...
.field public final synthetic d:LMb/p;
...
# direct methods
.method public constructor <init>(IILMb/p;ILorg/ITsMagic/Atlas/c$b;Ljava/util/concurrent/CountDownLatch;Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
    ...
    iput-object p3, p0, Lorg/ITsMagic/Atlas/b$a;->d:LMb/p;
...
.method public run()V
    ...
    invoke-direct/range {v3 .. v8}, Lmc/a;-><init>(IIIIZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_5

    :try_start_1
    new-instance v18, Lmc/a;
    ...
    invoke-direct/range {v12 .. v17}, Lmc/a;-><init>(IIIIZ)V
    :try_end_1
    ...
    iget-object v0, v1, Lorg/ITsMagic/Atlas/b$a;->d:LMb/p;

    iget v3, v1, Lorg/ITsMagic/Atlas/b$a;->b:I

    iget v4, v1, Lorg/ITsMagic/Atlas/b$a;->c:I

    invoke-direct {v12, v0, v3, v4, v2}, Lorg/ITsMagic/Atlas/b;-><init>(LMb/p;IILorg/ITsMagic/Atlas/b$a;)V
    :try_end_2
    ...
    invoke-virtual {v11}, Lmc/a;->l()Lcom/itsmagic/engine/Engines/Engine/Texture/ColorTexture;
    ...
    invoke-direct {v13, v0, v3, v4, v2}, Lorg/ITsMagic/Atlas/b;-><init>(LMb/p;IILorg/ITsMagic/Atlas/b$a;)V
    :try_end_3
    ...
    invoke-virtual/range {v18 .. v18}, Lmc/a;->l()Lcom/itsmagic/engine/Engines/Engine/Texture/ColorTexture;
    ...
    invoke-direct {v14, v0, v3, v4, v2}, Lorg/ITsMagic/Atlas/b;-><init>(LMb/p;IILorg/ITsMagic/Atlas/b$a;)V
    :try_end_4
    ...
    invoke-direct/range {v3 .. v10}, Lorg/ITsMagic/Atlas/b$d;-><init>(Lorg/ITsMagic/Atlas/b;Lorg/ITsMagic/Atlas/b;Lorg/ITsMagic/Atlas/b;Lmc/a;Lmc/a;ILorg/ITsMagic/Atlas/b$a;)V
    ...
    :cond_0
    :goto_2
    iget-object v2, v1, Lorg/ITsMagic/Atlas/b$a;->d:LMb/p;
    ...
    invoke-static {v2, v3, v0, v4, v5}, Lorg/ITsMagic/Atlas/b;->d(LMb/p;Lorg/ITsMagic/Atlas/c$b;Lorg/ITsMagic/Atlas/b$d;Ljava/util/concurrent/CountDownLatch;Ljava/util/concurrent/atomic/AtomicReference;)V
    :try_end_5
    ...
    iget-boolean v2, v11, Lmc/a;->r:Z

    if-nez v2, :cond_4

    :try_start_9
    invoke-virtual {v11}, Lmc/a;->c()V
    :try_end_9
