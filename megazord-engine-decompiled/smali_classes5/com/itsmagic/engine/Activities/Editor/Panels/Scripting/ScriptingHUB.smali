...
.method public constructor <init>()V
    ...
    invoke-super {p0, v0}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->z0(Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;)Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;

    return-void
.end method

.method public static synthetic F0(Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;Ljava/lang/String;Z)Z
    .locals 0

    invoke-virtual {p0, p1, p2}, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;->I0(Ljava/lang/String;Z)Z
...
.method public static synthetic G0(Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;I)Lcom/itsmagic/engine/Activities/Editor/Interface/Panel/Panel;
    .locals 0

    invoke-super {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->C0(I)Lcom/itsmagic/engine/Activities/Editor/Interface/Panel/Panel;
...
.method public static synthetic H0(Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;Lcom/itsmagic/engine/Activities/Editor/Interface/Panel/Panel;)Z
    .locals 0

    invoke-super {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->p(Lcom/itsmagic/engine/Activities/Editor/Interface/Panel/Panel;)Z
...
.method public static J0(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;->K0(Ljava/lang/String;)Z
...
.method public static K0(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, LQ4/a;->q1(Ljava/lang/String;)Z
...
.method public static L0(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, LQ6/c;->z1(Ljava/lang/String;)Z
...
# virtual methods
.method public final I0(Ljava/lang/String;Z)Z
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->C0(I)Lcom/itsmagic/engine/Activities/Editor/Interface/Panel/Panel;
    ...
    invoke-virtual {v5}, LQ6/c;->v1()Ljava/lang/String;
    ...
    invoke-interface {p1, v4}, LC4/e;->t(Lcom/itsmagic/engine/Activities/Editor/Interface/Panel/Panel;)V
    ...
    invoke-direct {v1, p0, p2, v0, p1}, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB$d;-><init>(Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;ZLQ6/c;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-static {p1}, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;->K0(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, p0, p2, v0, p1}, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB$e;-><init>(Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;ZLQ4/a;Ljava/lang/String;)V
...
.method public b0(Landroid/app/Activity;Landroid/view/LayoutInflater;LC4/a;)Landroid/view/View;
    ...
    :cond_1
    invoke-super {p0, p1, p2, p3}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->b0(Landroid/app/Activity;Landroid/view/LayoutInflater;LC4/a;)Landroid/view/View;
...
.method public p0(LH4/f;)Z
    ...
    invoke-virtual {p0, p1, v0}, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;->I0(Ljava/lang/String;Z)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->p0(LH4/f;)Z
...
.method public v(LI4/e;)V
    ...
    invoke-super {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->v(LI4/e;)V

    const-string v0, "open-scripts"

    invoke-virtual {p1, v0}, LI4/e;->a(Ljava/lang/String;)Ljava/lang/Object;
...
.method public w0(Landroid/widget/LinearLayout;Landroid/widget/FrameLayout;Landroid/app/Activity;Landroid/content/Context;Landroid/view/LayoutInflater;LC4/a;FFFFFFFFLandroid/widget/FrameLayout;Landroid/view/View;LC4/e;)V
    ...
    invoke-virtual {v2}, LQ6/c;->v1()Ljava/lang/String;
...
.method public z(LI4/e;)V
    ...
    invoke-super {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Areas/HUBPanel;->z(LI4/e;)V

    const-string v0, "open-scripts"

    iget-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/Scripting/ScriptingHUB;->openScripts:Ljava/util/Set;

    invoke-virtual {p1, v0, v1}, LI4/e;->b(Ljava/lang/String;Ljava/lang/Object;)V
