...
.method public addPoint(FF)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->s(FF)V
...
.method public evaluate(F)F
    ...
    invoke-virtual {v0, p1}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->C(F)F
...
.method public fromJson(Ljava/lang/String;)LJAVARuntime/Curve;
    ...
    invoke-static {p1, v0}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->F(Ljava/lang/String;Landroid/content/Context;)Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;
...
.method public getWrapMode()LJAVARuntime/Curve$WrapMode;
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->G()Lcom/itsmagic/engine/Engines/Engine/Curve/Curve$a;

    move-result-object v0

    invoke-static {v0}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->y(Lcom/itsmagic/engine/Engines/Engine/Curve/Curve$a;)LJAVARuntime/Curve$WrapMode;
...
.method public pointAt(ILJAVARuntime/Vector2;)LJAVARuntime/Vector2;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->M(ILcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
...
.method public pointsCount()I
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->N()I
...
.method public setPoint(IFF)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->R(IFF)V
...
.method public setWrapMode(LJAVARuntime/Curve$WrapMode;)V
    ...
    invoke-static {p1}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->z(LJAVARuntime/Curve$WrapMode;)Lcom/itsmagic/engine/Engines/Engine/Curve/Curve$a;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->S(Lcom/itsmagic/engine/Engines/Engine/Curve/Curve$a;)V
...
.method public toJson()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Curve/Curve;->W(Landroid/content/Context;)Ljava/lang/String;
