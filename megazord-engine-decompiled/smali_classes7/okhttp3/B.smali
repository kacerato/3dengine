...
.method public constructor <init>(Lokhttp3/z;Lokhttp3/C;Z)V
    ...
    invoke-direct {p2, p1, p3}, Ldh/j;-><init>(Lokhttp3/z;Z)V

    iput-object p2, p0, Lokhttp3/B;->c:Ldh/j;

    new-instance p2, Lokhttp3/B$a;

    invoke-direct {p2, p0}, Lokhttp3/B$a;-><init>(Lokhttp3/B;)V

    iput-object p2, p0, Lokhttp3/B;->d:Llh/a;
    ...
    invoke-virtual {p2, v0, v1, p1}, Llh/z;->h(JLjava/util/concurrent/TimeUnit;)Llh/z;
...
.method public a0()Llh/z;
    ...
    iget-object v0, p0, Lokhttp3/B;->d:Llh/a;
...
.method public final b()V
    ...
    invoke-virtual {v0, v1}, Lhh/f;->o(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    iget-object v1, p0, Lokhttp3/B;->c:Ldh/j;

    invoke-virtual {v1, v0}, Ldh/j;->j(Ljava/lang/Object;)V
...
.method public cancel()V
    ...
    iget-object v0, p0, Lokhttp3/B;->c:Ldh/j;

    invoke-virtual {v0}, Ldh/j;->b()V
...
.method public d()Lokhttp3/E;
    ...
    invoke-direct {v0, v2}, Ldh/a;-><init>(Lokhttp3/n;)V
    ...
    invoke-virtual {v2}, Lokhttp3/z;->r()Lah/f;

    move-result-object v2

    invoke-direct {v0, v2}, Lah/a;-><init>(Lah/f;)V
    ...
    invoke-direct {v0, v2}, Lch/a;-><init>(Lokhttp3/z;)V
    ...
    invoke-direct {v0, v2}, Ldh/b;-><init>(Z)V

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v12, Ldh/g;
    ...
    invoke-virtual {v0}, Lokhttp3/z;->B()I

    move-result v10

    iget-object v0, p0, Lokhttp3/B;->b:Lokhttp3/z;

    invoke-virtual {v0}, Lokhttp3/z;->F()I
    ...
    invoke-direct/range {v0 .. v11}, Ldh/g;-><init>(Ljava/util/List;Lch/f;Ldh/c;Lch/c;ILokhttp3/C;Lokhttp3/e;Lokhttp3/r;III)V
...
.method public g()Lch/f;
    .locals 1

    iget-object v0, p0, Lokhttp3/B;->c:Ldh/j;

    invoke-virtual {v0}, Ldh/j;->k()Lch/f;
