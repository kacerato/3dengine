...
.field public static final g0:LUc/b;

.field public static final h0:LUc/b;


# instance fields
.field public X:Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;

.field public Y:Ly6/X;

.field public Z:Le8/e;

.field public a0:Le8/c;

.field public b0:Le8/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->g0:LUc/b;

    sget-object v0, Lcom/itsmagic/engine/Activities/Editor/Extensions/ThemeSystem/Theme$T;->PRIMARY_DARK:LUc/b;

    sput-object v0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->h0:LUc/b;
...
.method public static synthetic o1(Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;)Ly6/X;
    .locals 0

    iget-object p0, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Y:Ly6/X;

    return-object p0
.end method

.method public static synthetic p1(Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic q1(Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;)Ljava/util/List;
    .locals 0

    invoke-virtual {p0}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->s1()Ljava/util/List;
...
.method public B0()Landroid/view/View;
    ...
    invoke-direct {v5, v6}, Ly6/X;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Y:Ly6/X;
    ...
    iget-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Y:Ly6/X;

    invoke-virtual {v1, v4}, Ly6/X;->setCompileStatusView(Landroid/widget/TextView;)V

    iget-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->graphFile:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v4, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Y:Ly6/X;

    invoke-virtual {v4, v1}, Ly6/X;->w(Ljava/lang/String;)V

    const-string v1, "NoCode Graph"

    invoke-virtual {p0, v1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;->e1(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4}, Ly6/X;->v(Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;)V
    ...
    :goto_0
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->v1(Landroid/widget/LinearLayout;)V

    invoke-virtual {p0, v3}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->w1(Landroid/widget/LinearLayout;)V
...
.method public F0()V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Y:Ly6/X;
    ...
    invoke-virtual {v0, v2}, Ly6/X;->w(Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v0, v2}, Ly6/X;->v(Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;)V
...
.method public L0()V
    ...
    invoke-virtual {v0}, Ly6/X;->l0()V

    :cond_0
    iget-object v0, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->c0:Ljava/util/List;

    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->r1(Ljava/util/List;)V
...
.method public N0(LH4/f;)Z
    ...
    iget-object v0, p1, LH4/d;->b:Ljava/lang/String;

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->u1(Ljava/lang/String;)V

    goto :goto_0

    :cond_1
    iget-object p1, p1, LH4/d;->a:Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;

    invoke-virtual {p0, p1}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->t1(Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;)V
...
.method public m1()V
    ...
    invoke-virtual {v0, p0}, Ly6/X;->A0(Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;)V

    iget-object v0, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Y:Ly6/X;

    invoke-virtual {v0}, Ly6/X;->U()Z

    move-result v0

    xor-int/lit8 v0, v0, 0x1

    iget-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->a0:Le8/c;

    if-eqz v1, :cond_0

    invoke-virtual {v1, v0}, Le8/g;->o(Z)V

    :cond_0
    iget-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->b0:Le8/c;
...
.method public t1(Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {v0, p1}, Ly6/X;->v(Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;)V

    :cond_0
    invoke-virtual {p0}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->x1()V
...
.method public u1(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Ly6/X;->w(Ljava/lang/String;)V
...
.method public final v1(Landroid/widget/LinearLayout;)V
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-direct {v0, p1, v1}, Le8/h;-><init>(Landroid/widget/LinearLayout;Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->b0:Le8/c;
    ...
    invoke-direct {v1, v4, v2, v3, p1}, Le8/c;-><init>(ILe8/d;Le8/c$b;Landroid/content/Context;)V

    iput-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->a0:Le8/c;
    ...
    invoke-virtual {v0, p1}, Le8/h;->g(Ljava/util/List;)V
...
.method public final w1(Landroid/widget/LinearLayout;)V
    ...
    invoke-direct {v1, v4, v5, v2, v3}, Le8/e;-><init>(ILjava/lang/String;Le8/f;Landroid/content/Context;)V

    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->g0:LUc/b;

    invoke-virtual {v1, v2}, Le8/e;->T(LUc/b;)Le8/e;

    move-result-object v1

    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->h0:LUc/b;

    invoke-virtual {v1, v2}, Le8/e;->M(LUc/b;)Le8/e;

    move-result-object v1

    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Extensions/ThemeSystem/Theme$T;->HIGH_ICON_TINT:LUc/b;

    invoke-virtual {v1, v2}, Le8/e;->a0(LUc/b;)Le8/e;

    move-result-object v1

    iput-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Z:Le8/e;

    invoke-virtual {p0}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->x1()V

    iget-object v1, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->d0:Ljava/util/List;

    iget-object v2, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Z:Le8/e;
...
.method public final x1()V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->Z:Le8/e;
    ...
    invoke-static {v1, v2}, Lmd/b;->w(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v1}, LUc/c;->a(Ljava/lang/String;)LUc/b;

    move-result-object v1

    invoke-static {v1}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->m(LUc/b;)Ljava/lang/String;
