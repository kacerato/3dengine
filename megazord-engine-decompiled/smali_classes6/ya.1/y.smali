...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lya/y;->e:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lya/y;->f:Ljava/util/Map;

    new-instance v0, Lya/r;

    invoke-direct {v0}, Lya/r;-><init>()V

    new-instance v1, Lya/y$a;

    invoke-direct {v1}, Lya/y$a;-><init>()V

    const-class v2, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;

    invoke-static {v2, v0, v1}, Lya/y;->f(Ljava/lang/Class;Lya/y$j;Lya/y$i;)V

    new-instance v0, Lya/s;

    invoke-direct {v0}, Lya/s;-><init>()V

    new-instance v1, Lya/y$b;

    invoke-direct {v1}, Lya/y$b;-><init>()V
    ...
    new-instance v1, Lya/y$c;

    invoke-direct {v1}, Lya/y$c;-><init>()V
    ...
    new-instance v1, Lya/y$d;

    invoke-direct {v1}, Lya/y$d;-><init>()V
    ...
    new-instance v1, Lya/y$e;

    invoke-direct {v1}, Lya/y$e;-><init>()V
    ...
    new-instance v1, Lya/y$f;

    invoke-direct {v1}, Lya/y$f;-><init>()V
    ...
    new-instance v1, Lya/y$g;

    invoke-direct {v1}, Lya/y$g;-><init>()V
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lya/y;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lya/y;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/IdentityHashMap;

    invoke-direct {v0}, Ljava/util/IdentityHashMap;-><init>()V

    iput-object v0, p0, Lya/y;->c:Ljava/util/IdentityHashMap;

    new-instance v0, Lya/y$h;

    invoke-direct {v0, p0}, Lya/y$h;-><init>(Lya/y;)V

    iput-object v0, p0, Lya/y;->d:Ljava/util/function/Function;

    return-void
.end method

.method public static b(Ljava/lang/Class;)Lya/y$i;
    .locals 1
    ...
    sget-object v0, Lya/y;->f:Ljava/util/Map;

    invoke-interface {v0, p0}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lya/y$i;
...
.method public static c(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :try_start_0
    sget-object v0, Lya/y;->e:Ljava/util/Map;

    invoke-interface {v0, p0}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lya/y$j;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lya/y$j;->a()Ljava/lang/Object;
...
.method public static f(Ljava/lang/Class;Lya/y$j;Lya/y$i;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    sget-object p1, Lya/y;->f:Ljava/util/Map;
...
.method public a(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v1, p0, Lya/y;->a:Ljava/util/Map;
    ...
    :cond_2
    invoke-static {p1}, Lya/y;->b(Ljava/lang/Class;)Lya/y$i;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-interface {v1, v0}, Lya/y$i;->a(Ljava/lang/Object;)V

    :cond_3
    :goto_0
    iget-object v1, p0, Lya/y;->b:Ljava/util/Map;

    iget-object v2, p0, Lya/y;->d:Ljava/util/function/Function;
    ...
    iget-object v1, p0, Lya/y;->c:Ljava/util/IdentityHashMap;
...
.method public d(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lya/y;->c:Ljava/util/IdentityHashMap;
...
.method public e()V
    ...
    iget-object v0, p0, Lya/y;->b:Ljava/util/Map;
    ...
    iget-object v2, p0, Lya/y;->a:Ljava/util/Map;
    ...
    iget-object v4, p0, Lya/y;->d:Ljava/util/function/Function;
...
.method public g(Ljava/lang/Object;)V
    ...
    invoke-static {v1, p1}, Lya/y;->h(Ljava/util/ArrayDeque;Ljava/lang/Object;)V
