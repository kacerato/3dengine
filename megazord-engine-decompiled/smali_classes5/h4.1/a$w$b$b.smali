...
# instance fields
.field public final synthetic a:Lh4/a$w$b;


# direct methods
.method public constructor <init>(Lh4/a$w$b;)V
    .locals 0
    ...
    iput-object p1, p0, Lh4/a$w$b$b;->a:Lh4/a$w$b;
...
.method public onSelected(Landroid/view/View;)V
    ...
    new-instance v6, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIHorizontalScrollView;

    invoke-direct {v6}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIHorizontalScrollView;-><init>()V
    ...
    invoke-static {v5, v2, v4}, Lf4/b;->g(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Ljava/util/List;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    invoke-direct {v6, v1, v3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIRect;-><init>(ZZ)V

    new-instance v7, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Layouts/UIHorizontalLayout;

    invoke-direct {v7}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Layouts/UIHorizontalLayout;-><init>()V

    new-instance v8, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIFitParent;

    invoke-direct {v8, v3, v1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIFitParent;-><init>(ZZ)V
    ...
    invoke-static {p1, v2, v5}, Lf4/b;->g(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Ljava/util/List;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    move-result-object p1

    invoke-virtual {v4, p1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->B(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    new-instance p1, Lh4/a$w$b$b$a;

    invoke-direct {p1, p0, v4}, Lh4/a$w$b$b$a;-><init>(Lh4/a$w$b$b;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V

    invoke-static {p1}, Lc9/a;->I(Ljava/lang/Runnable;)V

    iget-object p1, p0, Lh4/a$w$b$b;->a:Lh4/a$w$b;

    iget-object p1, p1, Lh4/a$w$b;->b:Lh4/a$w;

    iget-object p1, p1, Lh4/a$w;->b:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    if-eqz p1, :cond_1

    invoke-virtual {v4, p1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->I1(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
