...
.method public final f(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)I
    ...
    invoke-virtual {v4}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GUID;->y()Ljava/lang/String;

    move-result-object v4

    iget-object v5, v2, Lcom/itsmagic/engine/Engines/Utils/ObjectReferencing/CompData;->uniqueGUID:Ljava/lang/String;

    invoke-virtual {p0, v4, v5}, Ljd/a;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v5}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GUID;->w()Ljava/lang/String;

    move-result-object v5

    iget-object v6, v2, Lcom/itsmagic/engine/Engines/Utils/ObjectReferencing/CompData;->duplicableGUID:Ljava/lang/String;

    invoke-virtual {p0, v5, v6}, Ljd/a;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3, v2}, Ljd/a;->d(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public final g(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Z
    ...
    invoke-virtual {p0, v0, v2}, Ljd/a;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2, v3}, Ljd/a;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3, v4}, Ljd/a;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {v7}, Ljd/c;-><init>()V

    iput-object p1, v7, Ljd/c;->a:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    if-eqz v0, :cond_1

    iget v0, v7, Ljd/c;->b:I

    add-int/2addr v0, v1

    iput v0, v7, Ljd/c;->b:I
    ...
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Utils/ObjectReferencing/AdvObjectReference;->c:Ljd/c;

    if-nez v2, :cond_6

    iput-object v7, p0, Lcom/itsmagic/engine/Engines/Utils/ObjectReferencing/AdvObjectReference;->c:Ljd/c;

    goto :goto_0

    :cond_6
    iget v2, v2, Ljd/c;->b:I
...
.method public k()Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Utils/ObjectReferencing/AdvObjectReference;->c:Ljd/c;
    ...
    :cond_2
    :goto_1
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Utils/ObjectReferencing/AdvObjectReference;->c:Ljd/c;

    if-eqz v1, :cond_3

    iget-object v1, v1, Ljd/c;->a:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
...
.method public final n(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Z
    ...
    invoke-virtual {p1, v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->j1(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Z
...
.method public q()V
    ...
    invoke-virtual {v2, v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->V(I)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;
    ...
    invoke-virtual {v1, v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->j1(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Z
