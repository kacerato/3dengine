...
.method public constructor <init>(Ljava/util/concurrent/Callable;LXe/o;LXe/g;Z)V
    ...
    iput-object p1, p0, Lef/t0;->b:Ljava/util/concurrent/Callable;

    iput-object p2, p0, Lef/t0;->c:LXe/o;

    iput-object p3, p0, Lef/t0;->d:LXe/g;

    iput-boolean p4, p0, Lef/t0;->e:Z
...
.method public t1(LTe/v;)V
    ...
    :try_start_0
    iget-object v0, p0, Lef/t0;->b:Ljava/util/concurrent/Callable;
    ...
    :try_start_1
    iget-object v1, p0, Lef/t0;->c:LXe/o;
    ...
    new-instance v2, Lef/t0$a;

    iget-object v3, p0, Lef/t0;->d:LXe/g;

    iget-boolean v4, p0, Lef/t0;->e:Z

    invoke-direct {v2, p1, v0, v3, v4}, Lef/t0$a;-><init>(LTe/v;Ljava/lang/Object;LXe/g;Z)V

    invoke-interface {v1, v2}, LTe/y;->d(LTe/v;)V
    ...
    iget-boolean v2, p0, Lef/t0;->e:Z

    if-eqz v2, :cond_0

    :try_start_2
    iget-object v2, p0, Lef/t0;->d:LXe/g;
    ...
    invoke-static {v2, p1}, LYe/e;->g(Ljava/lang/Throwable;LTe/v;)V

    return-void

    :cond_0
    :goto_0
    invoke-static {v1, p1}, LYe/e;->g(Ljava/lang/Throwable;LTe/v;)V

    iget-boolean p1, p0, Lef/t0;->e:Z

    if-nez p1, :cond_1

    :try_start_3
    iget-object p1, p0, Lef/t0;->d:LXe/g;
