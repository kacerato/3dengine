...
.method public constructor <init>([LBg/i;Leg/p;)V
    ...
    iput-object p1, p0, LBg/B$f;->b:[LBg/i;

    iput-object p2, p0, LBg/B$f;->c:Leg/p;
...
.method public a(LBg/j;LQf/f;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LBg/B$f;->b:[LBg/i;

    invoke-static {}, Lkotlin/jvm/internal/M;->w()V

    new-instance v1, LBg/B$j;

    iget-object v2, p0, LBg/B$f;->b:[LBg/i;

    invoke-direct {v1, v2}, LBg/B$j;-><init>([LBg/i;)V

    invoke-static {}, Lkotlin/jvm/internal/M;->w()V

    new-instance v2, LBg/B$k;

    iget-object v3, p0, LBg/B$f;->c:Leg/p;

    const/4 v4, 0x0

    invoke-direct {v2, v3, v4}, LBg/B$k;-><init>(Leg/p;LQf/f;)V
...
.method public d(LBg/j;LQf/f;)Ljava/lang/Object;
    ...
    new-instance v0, LBg/B$f$a;

    invoke-direct {v0, p0, p2}, LBg/B$f$a;-><init>(LBg/B$f;LQf/f;)V
