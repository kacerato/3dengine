...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UI3DInputSystem;->F:Lfd/c;
...
.method private touchForVertex(Ljava/util/Map;Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Camera/Camera;Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;[FLcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;)V
    ...
    invoke-direct {p0, v2}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UI3DInputSystem;->filterEditor(LMc/h;)Z
    ...
    :cond_0
    invoke-virtual {v2}, LMc/h;->b()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;

    move-result-object v4

    invoke-virtual {p2, v4}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Camera/Camera;->screenPointToWorldRay(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lsa/d;
    ...
    invoke-direct {v6, v4, v7}, Lsa/c;-><init>(Lsa/d;F)V

    sget-object v4, LJAVARuntime/Vertex$RayMode;->ClosestPoint:LJAVARuntime/Vertex$RayMode;

    invoke-virtual {p3, p4, v6, v4}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->N2([FLsa/c;LJAVARuntime/Vertex$RayMode;)Lsa/a;
    ...
    invoke-virtual {p5}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;->emitTouch()Lna/r;
    ...
    :cond_1
    invoke-virtual {p5, v3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;->emitTouch(Lna/r;)V

    :goto_1
    invoke-virtual {v4}, Lsa/a;->C()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
    ...
    invoke-virtual {v3, v6, v4}, LMc/h;->D(FF)V

    invoke-virtual {v3, v0}, LMc/h;->K(Z)V

    invoke-virtual {v2}, LMc/h;->k()Z

    move-result v4

    invoke-virtual {v3, v4}, LMc/h;->v(Z)V

    invoke-virtual {v2}, LMc/h;->q()Z

    move-result v4

    invoke-virtual {v3, v4}, LMc/h;->F(Z)V

    invoke-virtual {v2}, LMc/h;->t()Z

    move-result v2

    invoke-virtual {v3, v2}, LMc/h;->J(Z)V
    ...
    invoke-virtual {v3, v0}, LMc/h;->v(Z)V

    invoke-virtual {v3, v0}, LMc/h;->F(Z)V

    invoke-virtual {v3}, LMc/h;->u()Z

    move-result v2

    if-nez v2, :cond_3

    invoke-virtual {v3, v5}, LMc/h;->J(Z)V

    invoke-virtual {v3, v5}, LMc/h;->K(Z)V

    :cond_3
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UI3DInputSystem;->F:Lfd/c;

    invoke-virtual {v2, v3}, Lfd/c;->add(Ljava/lang/Object;)Z
...
.method public preUpdate(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Z)V
    ...
    invoke-virtual {p2, v2}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;->releaseTouch(LMc/h;)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UI3DInputSystem;->F:Lfd/c;
