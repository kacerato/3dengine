...
.method static constructor <clinit>()V
    ...
    sput-object v0, LR2/q;->e:Ljava/util/logging/Logger;

    new-instance v0, LR2/q$d;

    invoke-direct {v0}, LR2/q$d;-><init>()V

    new-instance v1, LR2/q$a;

    invoke-direct {v1}, LR2/q$a;-><init>()V

    new-instance v2, LR2/q$b;

    invoke-direct {v2}, LR2/q$b;-><init>()V

    const/4 v3, 0x3

    new-array v3, v3, [LR2/q$c;
    ...
    invoke-static {v3}, LR2/q;->f([LR2/q$c;)Ljava/lang/Class;

    move-result-object v0

    invoke-static {v0}, LR2/q;->e(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v0

    sput-object v0, LR2/q;->g:Ljava/lang/reflect/Method;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LR2/q;->b:Ljava/lang/ref/ReferenceQueue;
    ...
    iput-object v1, p0, LR2/q;->c:Ljava/lang/ref/PhantomReference;

    :try_start_0
    sget-object v2, LR2/q;->g:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sget-object v1, LR2/q;->e:Ljava/util/logging/Logger;
...
.method public static synthetic c()Ljava/util/logging/Logger;
    ...
    sget-object v0, LR2/q;->e:Ljava/util/logging/Logger;
...
.method public static varargs f([LR2/q$c;)Ljava/lang/Class;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-interface {v2}, LR2/q$c;->a()Ljava/lang/Class;
...
.method public close()V
    ...
    iget-object v0, p0, LR2/q;->c:Ljava/lang/ref/PhantomReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->enqueue()Z

    invoke-virtual {p0}, LR2/q;->d()V
...
.method public d()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, LR2/q;->b:Ljava/lang/ref/ReferenceQueue;
