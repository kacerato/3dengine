...
.field private transient reflected:Log/c;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/r;->getReflected()Log/c;

    move-result-object v0

    invoke-interface {v0, p1}, Log/c;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public compute()Log/c;
    .locals 1
    .annotation build LFf/l0;
        version = "1.1"
    .end annotation

    iget-object v0, p0, Lkotlin/jvm/internal/r;->reflected:Log/c;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/r;->computeReflected()Log/c;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/r;->reflected:Log/c;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()Log/c;
.end method
...
.method public getOwner()Log/g;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/n0;->g(Ljava/lang/Class;)Log/g;
...
.method public getReflected()Log/c;
    .locals 1
    .annotation build LFf/l0;
        version = "1.1"
    .end annotation

    invoke-virtual {p0}, Lkotlin/jvm/internal/r;->compute()Log/c;
...
.method public getReturnType()Log/r;
    .locals 1
    ...
    invoke-interface {v0}, Log/c;->getReturnType()Log/r;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Log/c;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Log/v;
    ...
    invoke-interface {v0}, Log/c;->getVisibility()Log/v;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Log/c;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Log/c;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Log/c;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Log/c;->isSuspend()Z
