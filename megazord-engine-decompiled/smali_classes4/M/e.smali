...
.method public bridge synthetic a(Ljava/lang/Object;IILB/h;)Lcom/bumptech/glide/load/engine/t;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, LM/e;->c(Landroid/net/Uri;IILB/h;)Lcom/bumptech/glide/load/engine/t;
...
.method public bridge synthetic b(Ljava/lang/Object;LB/h;)Z
    ...
    invoke-virtual {p0, p1, p2}, LM/e;->h(Landroid/net/Uri;LB/h;)Z
...
.method public c(Landroid/net/Uri;IILB/h;)Lcom/bumptech/glide/load/engine/t;
    ...
    invoke-virtual {p0, p1, p2}, LM/e;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, LM/e;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, LM/e;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, LM/a;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object p1, p0, LM/e;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p1, p2}, LM/e;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p2}, LM/e;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;LB/h;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
