...
# direct methods
.method public constructor <init>(LQ5/j$H;LI7/a;)V
    .locals 0
    ...
    iput-object p2, p0, LQ5/j$H$a;->b:LI7/a;
...
.method public run()V
    ...
    iget-object v3, p0, LQ5/j$H$a;->c:LQ5/j$H;

    iget-object v3, v3, LQ5/j$H;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, LQ5/j$H$a;->c:LQ5/j$H;

    iget-object v2, v2, LQ5/j$H;->a:Ljava/lang/String;

    invoke-static {v2}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->G1(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;
    ...
    invoke-virtual {v4, v5}, LU8/a;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v1}, LQ5/j$H$a;->a(Ljava/io/BufferedWriter;Ljava/lang/String;)V
    ...
    iget-object v4, p0, LQ5/j$H$a;->c:LQ5/j$H;

    iget-object v4, v4, LQ5/j$H;->a:Ljava/lang/String;
    ...
    invoke-direct {v1, v6}, LOc/q;-><init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;)V
    ...
    invoke-virtual {v1, v6}, LOc/q;->h(I)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    invoke-direct {v1, v6}, LOc/p;-><init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;)V

    move v6, v4

    :goto_2
    invoke-virtual {v1}, LOc/p;->b()I

    move-result v7

    if-ge v6, v7, :cond_2

    invoke-virtual {v1, v6}, LOc/p;->f(I)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;

    move-result-object v7

    const-string v8, "vt %.6f %.6f%n"

    invoke-virtual {v7}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->k0()F
    ...
    invoke-virtual {v7}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->l0()F
    ...
    invoke-direct {v1, v2}, LOc/n;-><init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;)V

    :goto_4
    invoke-virtual {v1}, LOc/n;->b()I

    move-result v2

    if-ge v4, v2, :cond_4

    invoke-virtual {v1, v4}, LOc/n;->e(I)LJAVARuntime/Point3;
    ...
    :goto_5
    iget-object v0, p0, LQ5/j$H$a;->b:LI7/a;
    ...
    :goto_a
    iget-object v1, p0, LQ5/j$H$a;->b:LI7/a;
