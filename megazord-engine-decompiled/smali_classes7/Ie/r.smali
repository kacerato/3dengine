...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, LIe/r;->a:Ljava/util/concurrent/Executor;
...
.method public static synthetic b(Landroid/widget/TextView;Landroid/text/Spanned;)Landroidx/core/text/PrecomputedTextCompat;
    ...
    invoke-static {p0, p1}, LIe/r;->f(Landroid/widget/TextView;Landroid/text/Spanned;)Landroidx/core/text/PrecomputedTextCompat;
...
.method public static synthetic c(Landroid/widget/TextView;Landroid/text/Spanned;Landroid/widget/TextView$BufferType;Ljava/lang/Runnable;)V
    ...
    invoke-static {p0, p1, p2, p3}, LIe/r;->d(Landroid/widget/TextView;Landroid/text/Spanned;Landroid/widget/TextView$BufferType;Ljava/lang/Runnable;)V
...
.method public static d(Landroid/widget/TextView;Landroid/text/Spanned;Landroid/widget/TextView$BufferType;Ljava/lang/Runnable;)V
    ...
    new-instance v0, LIe/r$b;

    invoke-direct {v0, p0, p1, p2, p3}, LIe/r$b;-><init>(Landroid/widget/TextView;Landroid/text/Spanned;Landroid/widget/TextView$BufferType;Ljava/lang/Runnable;)V
...
.method public static e(Ljava/util/concurrent/Executor;)LIe/r;
    .locals 1
    ...
    invoke-direct {v0, p0}, LIe/r;-><init>(Ljava/util/concurrent/Executor;)V
...
.method public static f(Landroid/widget/TextView;Landroid/text/Spanned;)Landroidx/core/text/PrecomputedTextCompat;
    ...
    invoke-static {p0}, LIe/q;->a(Landroid/widget/TextView;)Landroid/text/PrecomputedText$Params;
...
.method public a(Landroid/widget/TextView;Landroid/text/Spanned;Landroid/widget/TextView$BufferType;Ljava/lang/Runnable;)V
    ...
    iget-object p1, p0, LIe/r;->a:Ljava/util/concurrent/Executor;

    new-instance v6, LIe/r$a;
    ...
    invoke-direct/range {v0 .. v5}, LIe/r$a;-><init>(LIe/r;Ljava/lang/ref/WeakReference;Landroid/text/Spanned;Landroid/widget/TextView$BufferType;Ljava/lang/Runnable;)V
