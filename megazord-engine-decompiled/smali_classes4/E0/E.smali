...
# direct methods
.method public static final a(Lcom/google/android/filament/Engine;Landroid/graphics/Bitmap;LE0/F;)Lcom/google/android/filament/Texture;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/filament/Texture$b;->l(I)Lcom/google/android/filament/Texture$b;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/filament/Texture$b;->e(I)Lcom/google/android/filament/Texture$b;

    move-result-object v0

    sget-object v1, Lcom/google/android/filament/Texture$i;->SAMPLER_2D:Lcom/google/android/filament/Texture$i;

    invoke-virtual {v0, v1}, Lcom/google/android/filament/Texture$b;->h(Lcom/google/android/filament/Texture$i;)Lcom/google/android/filament/Texture$b;

    move-result-object v0

    invoke-static {p2}, LE0/E;->c(LE0/F;)Lcom/google/android/filament/Texture$f;

    move-result-object p2

    invoke-virtual {v0, p2}, Lcom/google/android/filament/Texture$b;->d(Lcom/google/android/filament/Texture$f;)Lcom/google/android/filament/Texture$b;

    move-result-object p2

    const/16 v0, 0xff

    invoke-virtual {p2, v0}, Lcom/google/android/filament/Texture$b;->g(I)Lcom/google/android/filament/Texture$b;

    move-result-object p2

    const/16 v0, 0x218

    invoke-virtual {p2, v0}, Lcom/google/android/filament/Texture$b;->k(I)Lcom/google/android/filament/Texture$b;

    move-result-object p2

    invoke-virtual {p2, p0}, Lcom/google/android/filament/Texture$b;->a(Lcom/google/android/filament/Engine;)Lcom/google/android/filament/Texture;
...
.method public static final c(LE0/F;)Lcom/google/android/filament/Texture$f;
    .locals 1
...
.method public static final d(Lcom/google/android/filament/Engine;Landroid/content/res/Resources;ILE0/F;)Lcom/google/android/filament/Texture;
    .locals 2
    ...
    sget-object v1, LE0/F;->COLOR:LE0/F;
    ...
    invoke-static {p0, p1, p3}, LE0/E;->a(Lcom/google/android/filament/Engine;Landroid/graphics/Bitmap;LE0/F;)Lcom/google/android/filament/Texture;
...
.method public static final e(Lcom/google/android/filament/Engine;[BLE0/F;II)Lcom/google/android/filament/Texture;
    .locals 2
    .param p0    # Lcom/google/android/filament/Engine;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0, p1, p2}, LE0/E;->a(Lcom/google/android/filament/Engine;Landroid/graphics/Bitmap;LE0/F;)Lcom/google/android/filament/Texture;
...
.method public static synthetic f(Lcom/google/android/filament/Engine;[BLE0/F;IIILjava/lang/Object;)Lcom/google/android/filament/Texture;
    .locals 0
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3, p4}, LE0/E;->e(Lcom/google/android/filament/Engine;[BLE0/F;II)Lcom/google/android/filament/Texture;
