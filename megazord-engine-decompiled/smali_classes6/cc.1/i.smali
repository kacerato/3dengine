...
.method public constructor <init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0}, Lcc/i;-><init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;F)V
...
.method public constructor <init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;F)V
    ...
    .line 3
    iput-object p1, p0, Lcc/i;->a:Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;

    .line 4
    iput-object p2, p0, Lcc/i;->b:Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;

    .line 5
    iput p3, p0, Lcc/i;->c:F

    .line 6
    invoke-virtual {p0}, Lcc/i;->j()V

    return-void
.end method

.method public static synthetic a(ILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lcc/i$a;Lcom/google/android/filament/Box;)V
    .locals 0

    invoke-static/range {p0 .. p5}, Lcc/i;->i(ILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lcc/i$a;Lcom/google/android/filament/Box;)V
...
.method public static synthetic i(ILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lcc/i$a;Lcom/google/android/filament/Box;)V
    .locals 8
    ...
    invoke-virtual {v0, p0, p1}, Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;->s(ILjava/nio/ByteBuffer;)V
    ...
    invoke-direct {p0, p1}, Lkc/d;-><init>(Lcom/google/android/filament/IndexBuffer$a;)V

    invoke-virtual {p0, p3}, Lkc/d;->s(Ljava/nio/ByteBuffer;)V

    invoke-interface {p4, v0, p0, p5}, Lcc/i$a;->a(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;Lkc/d;Lcom/google/android/filament/Box;)V
...
.method public b(Lcc/i$a;)V
    ...
    iget-object v6, p0, Lcc/i;->h:Lcom/google/android/filament/Box;

    if-eqz v6, :cond_1

    iget-object v0, p0, Lcc/i;->f:Ljava/nio/ByteBuffer;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lcc/i;->g:Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, Lcc/i;->g:Ljava/nio/ByteBuffer;
    ...
    new-instance v7, Lcc/h;

    move-object v0, v7

    move-object v5, p1

    invoke-direct/range {v0 .. v6}, Lcc/h;-><init>(ILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Lcc/i$a;Lcom/google/android/filament/Box;)V

    invoke-static {v7}, Lc9/a;->I(Ljava/lang/Runnable;)V
...
.method public f()Lcom/google/android/filament/Box;
    ...
    iget-object v0, p0, Lcc/i;->h:Lcom/google/android/filament/Box;
...
.method public final g()I
    ...
    iget-object v0, p0, Lcc/i;->b:Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;
...
.method public final h()I
    ...
    iget-object v0, p0, Lcc/i;->a:Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;
...
.method public final j()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcc/i;->h()I

    move-result v1

    invoke-virtual/range {p0 .. p0}, Lcc/i;->g()I
    ...
    iget-object v13, v0, Lcc/i;->a:Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;

    mul-int/lit8 v14, v11, 0x3

    invoke-virtual {v13, v14}, Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;->X(I)F

    move-result v13

    iget-object v15, v0, Lcc/i;->a:Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;

    add-int/lit8 v6, v14, 0x1

    invoke-virtual {v15, v6}, Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;->X(I)F
    ...
    invoke-virtual {v15, v14}, Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;->X(I)F
    ...
    iput-object v4, v0, Lcc/i;->h:Lcom/google/android/filament/Box;
    ...
    iget-object v6, v0, Lcc/i;->a:Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;
    ...
    iput-object v4, v0, Lcc/i;->f:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v0, Lcc/i;->b:Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;

    mul-int/lit8 v7, v5, 0x3

    invoke-virtual {v6, v7}, Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;->V(I)I

    move-result v6

    iget-object v8, v0, Lcc/i;->b:Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;

    add-int/lit8 v9, v7, 0x1

    invoke-virtual {v8, v9}, Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;->V(I)I

    move-result v8

    iget-object v9, v0, Lcc/i;->b:Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;

    add-int/2addr v7, v12

    invoke-virtual {v9, v7}, Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;->V(I)I

    move-result v7

    invoke-static {v4, v6, v8, v7}, Lcc/i;->k(Ljava/nio/IntBuffer;III)V

    invoke-static {v4, v8, v7, v6}, Lcc/i;->k(Ljava/nio/IntBuffer;III)V

    invoke-static {v4, v7, v6, v8}, Lcc/i;->k(Ljava/nio/IntBuffer;III)V
    ...
    invoke-static {v4, v1}, Lcc/i;->l(Ljava/nio/IntBuffer;Ljava/nio/IntBuffer;)V

    iget v1, v0, Lcc/i;->c:F
    ...
    invoke-static {v13, v9, v10, v11, v7}, Lcc/i;->d(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;III[F)V

    iget-object v11, v0, Lcc/i;->a:Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;

    invoke-static {v11, v9, v10, v14, v3}, Lcc/i;->d(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;III[F)V

    invoke-static {v7, v3}, Lcc/i;->e([F[F)F
    ...
    invoke-static {v11, v13, v14}, Lcc/i;->c(FFF)F
    ...
    iput-object v2, v0, Lcc/i;->g:Ljava/nio/ByteBuffer;
