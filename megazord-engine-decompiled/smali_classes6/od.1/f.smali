...
.method public static c(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lod/f;->e(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lod/f;->h(Landroid/net/Uri;)Z
    ...
    :cond_2
    invoke-static {p1}, Lod/f;->g(Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p0, p1}, Lod/f;->b(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v1, v1}, Lod/f;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, Lod/f;->j(Landroid/net/Uri;)Z
    ...
    invoke-static {p0, v1, v0, p1}, Lod/f;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lod/f;->i(Landroid/net/Uri;)Z
