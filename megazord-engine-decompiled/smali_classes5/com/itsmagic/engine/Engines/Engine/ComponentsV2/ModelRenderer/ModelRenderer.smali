...
# static fields
.field public static final D0:Ljava/lang/String; = "ModelRenderer"
...
.field public final W:Lva/d;

.field public final X:LVb/a;

.field public final Y:LAb/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->X0:Ljava/lang/Class;
    ...
    sput v0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->Y0:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->X:LVb/a;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->Y:LAb/h;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;ZZ)V
    ...
    iput-object p4, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;
    ...
    iput-object p4, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->X:LVb/a;
    ...
    iput-object p4, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->Y:LAb/h;
...
.method public static synthetic access$100(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)Lkc/c;
    .locals 0

    iget-object p0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
...
.method private addToGraphics()V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
    ...
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
...
.method private buildRenderable()V
    ...
    invoke-virtual {v2}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->T()Z
    ...
    iput-object v5, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
    ...
    invoke-virtual {v6}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->T()Z
    ...
    invoke-virtual {v6, v7}, Lcom/google/android/filament/RenderableManager$a;->v(Z)Lcom/google/android/filament/RenderableManager$a;

    move-result-object v7

    iget-object v9, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
    ...
    invoke-virtual {v1, v2}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->F0([F)[F
    ...
    invoke-virtual {v0, v4, v1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->L4([FI)I
...
.method private destroyRenderable(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentScene;Z)V
    ...
    invoke-virtual {p1, v0}, Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentScene;->y(Lkc/c;)Z
    ...
    .line 6
    :cond_1
    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
    ...
    .line 10
    :goto_1
    iput-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->R:Lkc/c;
...
.method private synthetic lambda$loadWireframeVertexForGizmoLowTask$0(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;Lkc/d;Lcom/google/android/filament/Box;)V
    .locals 2
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->f2(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;Lkc/d;Lcom/google/android/filament/Box;)V
    ...
    invoke-virtual {v1}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->j0()V
    :try_end_0
...
.method private loadWireframeVertexForGizmoLowTask()V
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->g1()Z
    ...
    :cond_b
    :try_start_6
    sget v1, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->Y0:I
    ...
    sput v2, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->Y0:I
    ...
    invoke-virtual {v1}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->d1()Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;

    move-result-object v1

    invoke-direct {v2, v3, v1}, Lcc/i;-><init>(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;)V
    ...
    invoke-direct {v1, p0}, Lu9/f;-><init>(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V

    invoke-virtual {v2, v1}, Lcc/i;->b(Lcc/i$a;)V
    :try_end_8
    ...
    :try_start_a
    invoke-static {v2, v0, v0, v3}, LYb/c;->p(Ljava/lang/String;ZZLYb/c$g;)Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;
    ...
    invoke-static {v2}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Data/MeshSerializer;->n(Ljava/lang/String;)Ljava/io/File;

    move-result-object v1

    invoke-static {v1, v3}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Data/MeshSerializer;->r(Ljava/io/File;Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;)Z
...
.method private requestWireframeVertexLoadTask()V
    ...
    invoke-direct {v0, p0}, Lu9/e;-><init>(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V
...
.method public static synthetic s(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V
    .locals 0
...
.method private setModelInternal(Lv9/a;Z)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->E:Lv9/a;

    if-eqz v0, :cond_0

    if-eqz p1, :cond_0

    invoke-virtual {v0}, Lv9/a;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lv9/a;->c()Z
    ...
    invoke-virtual {v0}, Lv9/a;->b()Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;

    move-result-object v0

    invoke-virtual {p1}, Lv9/a;->b()Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;
    ...
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->X:LVb/a;
    ...
    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->E:Lv9/a;
    ...
    invoke-virtual {p2, v1}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->J(LVb/a;)V

    invoke-virtual {p1}, Lv9/a;->b()Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;

    move-result-object p2

    invoke-static {p2}, LYb/c;->g(Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;)Z
    ...
    invoke-static {p2, p1}, LYb/c;->d(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;)Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;
    ...
    :cond_3
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->E:Lv9/a;
...
.method public static synthetic u(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;Lkc/d;Lcom/google/android/filament/Box;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->lambda$loadWireframeVertexForGizmoLowTask$0(Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;Lkc/d;Lcom/google/android/filament/Box;)V
...
.method private updateMaterial(Z)V
    ...
    invoke-static {v1}, Lva/g;->t(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Material/Material;
    ...
    invoke-virtual {v1, p0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->s(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V
    ...
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;

    invoke-virtual {p1, v1}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->w(Lva/d;)V
    :try_end_2
    ...
    invoke-virtual {v3, p0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->e0(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V

    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;

    invoke-virtual {v3, p1}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->h0(Lva/d;)V
    ...
    invoke-virtual {p1, p0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->e0(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V

    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->F:Lcom/itsmagic/engine/Engines/Engine/Material/Material;

    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;

    invoke-virtual {p1, v2}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->h0(Lva/d;)V
...
.method private updateMesh(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer$z;)V
    ...
    :try_start_0
    invoke-static {v4, v5, p1, v3, v2}, LYb/c;->n(Ljava/lang/String;ZLandroid/content/Context;ZLYb/c$g;)Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;

    move-result-object p1

    new-instance v1, Lv9/a;

    invoke-direct {v1, p1}, Lv9/a;-><init>(Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;)V

    invoke-direct {p0, v1, v3}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->setModelInternal(Lv9/a;Z)V
    :try_end_0
    ...
    invoke-static {v4, p1}, Lbd/l;->b(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_1
    invoke-static {v4, v1}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->H1(Ljava/lang/String;LYb/a;)Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;
...
.method public animEntriesCount()I
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->J()Lwc/l;
...
.method public drawGizmo()V
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->C2()LJAVARuntime/Vertex;
    ...
    invoke-static {v0}, Lk/a;->a(Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;)V
...
.method public getDisplayableTitle()Ljava/lang/String;
    ...
    sget-object v0, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->MODEL_RENDERER:LUc/b;
...
.method public getModelEntries(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {v0, v3, v1, v2}, LW5/b;-><init>(LX5/e;ILjava/lang/Object;)V
...
.method public getVec2FromAnimation(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
    ...
    :try_start_0
    invoke-virtual {v0, p1}, Lcom/itsmagic/engine/Engines/Graphics/MaterialShader/Generic/ShaderBinder;->M(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
...
.method public getVec3FromAnimation(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    :try_start_0
    invoke-virtual {v0, p1}, Lcom/itsmagic/engine/Engines/Graphics/MaterialShader/Generic/ShaderBinder;->N(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
...
.method public getVertex()Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->getModel()Lv9/a;
...
.method public loadAsync(Lec/a;)V
    ...
    invoke-interface {p1, v2}, Lec/a;->b(Ljava/lang/String;)V

    new-instance v2, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer$n;

    invoke-direct {v2, p0, p1}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer$n;-><init>(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;Lec/a;)V
    ...
    invoke-interface {p1, v2}, Lec/a;->a(F)V
...
.method public mousePick(Lsa/c;Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$k;)V
    ...
    invoke-interface/range {p2 .. p2}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$k;->d()Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$g;

    move-result-object v6

    invoke-interface/range {p2 .. p2}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$k;->a()Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$h;
    ...
    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->m0()Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;
    ...
    invoke-virtual {v5}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->H1()[F

    move-result-object v12

    invoke-virtual {v11, v12}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->u([F)Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;

    move-result-object v11

    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->E()F

    move-result v12

    invoke-virtual {v8, v12}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->e2(F)F

    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->F()F

    move-result v12

    invoke-virtual {v8, v12}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->i2(F)F

    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->G()F

    move-result v12

    invoke-virtual {v8, v12}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->j2(F)F

    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->z()F
    ...
    invoke-virtual {v9, v12}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->e2(F)F

    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->A()F

    move-result v12

    mul-float/2addr v12, v13

    invoke-virtual {v9, v12}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->i2(F)F

    invoke-virtual {v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/AABB;->B()F

    move-result v11

    mul-float/2addr v11, v13

    invoke-virtual {v9, v11}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->j2(F)F

    invoke-virtual/range {p1 .. p1}, Lsa/c;->u()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    invoke-virtual {v6}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->C2()LJAVARuntime/Vertex;
    ...
    invoke-virtual {v5, v9}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->P0(Lcom/itsmagic/engine/Engines/Engine/Quaternion/Quaternion;)Lcom/itsmagic/engine/Engines/Engine/Quaternion/Quaternion;

    invoke-virtual {v9}, Lcom/itsmagic/engine/Engines/Engine/Quaternion/Quaternion;->d1()LJAVARuntime/Quaternion;

    move-result-object v10

    invoke-virtual {v8, v10}, LJAVARuntime/GizmoTransform;->setRotation(LJAVARuntime/Quaternion;)V

    invoke-virtual {v5, v6}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->X0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    :goto_0
    invoke-virtual {v5}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Transform/Transform;->C0()LUb/f;
    ...
    invoke-virtual {v3, v5, v1, v6, v9}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->H2(LUb/f;Lsa/c;LJAVARuntime/Vertex$RayMode;Z)Lsa/a;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1, v4}, Lsa/a;->setGameObject(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V

    new-instance v3, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$j;

    invoke-direct {v3, v1, v8, v0}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$j;-><init>(Lsa/a;LJAVARuntime/GizmoObject;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V

    invoke-interface {v2, v3}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$k;->b(Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$j;)V
    ...
    invoke-interface {v2, v1}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$k;->c(Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$l;)V
    ...
    invoke-static {v10, v9}, Lgd/c;->q([FLcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V
    ...
    invoke-virtual {v8}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->M2()LJAVARuntime/Vector3;
    ...
    invoke-virtual {v9}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->M2()LJAVARuntime/Vector3;
    ...
    invoke-virtual {v6, v10, v1, v5, v8}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->O2([FLsa/c;LJAVARuntime/Vertex$RayMode;Z)Lsa/a;
    ...
    invoke-direct {v4, v1, v3, v0}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$j;-><init>(Lsa/a;LJAVARuntime/GizmoObject;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V

    invoke-interface {v2, v4}, Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$k;->b(Lcom/itsmagic/engine/Activities/Editor/Panels/Editor3DViewer/Axis/MousePicker/MousePicker$j;)V
...
.method public onAttach()V
    ...
    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->Y:LAb/h;
...
.method public onDetach()V
    ...
    invoke-virtual {v1, p0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->e0(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V

    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->F:Lcom/itsmagic/engine/Engines/Engine/Material/Material;

    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;

    invoke-virtual {v1, v2}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->h0(Lva/d;)V
...
.method public onVertexChangedRenderables()V
    ...
    invoke-virtual {v2, v5, v3, v4, v0}, Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentRenderable;->setGeometryAt(ILcom/google/android/filament/RenderableManager$b;Lcom/itsmagic/engine/Engines/Graphics/Filament/NativeObjects/FilamentVertexBuffer;Lkc/d;)V
...
.method public setMaterial(Lcom/itsmagic/engine/Engines/Engine/Material/Material;)V
    ...
    invoke-virtual {v0, p0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->e0(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->F:Lcom/itsmagic/engine/Engines/Engine/Material/Material;

    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;

    invoke-virtual {v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->h0(Lva/d;)V
    ...
    invoke-virtual {p1, p0}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->s(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;)V

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->F:Lcom/itsmagic/engine/Engines/Engine/Material/Material;

    iget-object v1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->W:Lva/d;

    invoke-virtual {v0, v1}, Lcom/itsmagic/engine/Engines/Engine/Material/Material;->w(Lva/d;)V
...
.method public setModel(Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;)V
    ...
    invoke-direct {v0, p1}, Lv9/a;-><init>(Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;)V

    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->setModel(Lv9/a;)V

    return-void
.end method

.method public setModel(Lv9/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->setModelInternal(Lv9/a;Z)V
...
.method public setRuntime(LJAVARuntime/Component;)V
    ...
    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->q0:LJAVARuntime/Component;
...
.method public setVec2FromAnimation(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1, p2}, Lcom/itsmagic/engine/Engines/Graphics/MaterialShader/Generic/ShaderBinder;->t0(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setVec3FromAnimation(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V
    ...
    :try_start_0
    invoke-virtual {v0, p1, p2}, Lcom/itsmagic/engine/Engines/Graphics/MaterialShader/Generic/ShaderBinder;->u0(Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public toJAVARuntime()LJAVARuntime/Component;
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->q0:LJAVARuntime/Component;
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/ModelRenderer/ModelRenderer;->q0:LJAVARuntime/Component;

    :cond_0
    return-object v0
.end method

.method public updateForThumb(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;LW7/e;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-super {p0, p1, p2}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;->updateForThumb(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;LW7/e;)V
