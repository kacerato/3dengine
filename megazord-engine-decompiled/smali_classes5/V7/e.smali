...
.method static constructor <clinit>()V
    ...
    sput-object v0, LV7/e;->a:Ljava/util/Queue;
    ...
    sput-object v0, LV7/e;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static synthetic a()Ljava/util/Queue;
    ...
    sget-object v0, LV7/e;->a:Ljava/util/Queue;

    return-object v0
.end method

.method public static synthetic b(LV7/e$d;)V
    .locals 0

    invoke-static {p0}, LV7/e;->f(LV7/e$d;)V
...
.method public static synthetic c()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v0, LV7/e;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static e(Ljava/io/File;Landroid/widget/ImageView;)V
    ...
    check-cast v2, LV7/e$d;

    iget-object v2, v2, LV7/e$d;->a:Ljava/io/File;
    ...
    :cond_1
    sget-object v1, LV7/e;->a:Ljava/util/Queue;

    new-instance v2, LV7/e$d;

    invoke-direct {v2, p0, p1}, LV7/e$d;-><init>(Ljava/io/File;Landroid/widget/ImageView;)V
...
.method public static f(LV7/e$d;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    :try_start_0
    iget-object v0, p0, LV7/e$d;->a:Ljava/io/File;

    invoke-virtual {p0}, LV7/e$d;->a()Ljava/io/File;

    move-result-object v1

    invoke-static {v0, v1}, LV7/e;->i(Ljava/io/File;Ljava/io/File;)Z
    ...
    iget-object v1, p0, LV7/e$d;->a:Ljava/io/File;

    invoke-static {v1}, LV7/e;->g(Ljava/io/File;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1, v0}, LW7/f;->b(Ljava/lang/String;Lcom/itsmagic/engine/Activities/Editor/Utils/ThumbBuilder/Core/Manifest;)V

    iget-object v0, p0, LV7/e$d;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v1, v0, p0}, LV7/e$b;-><init>(Landroid/widget/ImageView;Ljava/io/File;)V
...
.method public static h()V
    ...
    invoke-direct {v1}, LV7/e$a;-><init>()V
...
.method public static i(Ljava/io/File;Ljava/io/File;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lp8/a;->x(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v4, v2}, LMb/n;-><init>(IILcom/itsmagic/engine/Engines/Engine/Texture/Utils/TextureConfig;)V

    new-instance v2, LV7/e$c;

    invoke-direct {v2}, LV7/e$c;-><init>()V

    invoke-virtual {p0, v3, v2}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Styles/UIStyle;->x0(LMb/n;Lma/c;)Z
    ...
    invoke-virtual {v3, v5, p0}, LMb/n;->v(II)Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;
