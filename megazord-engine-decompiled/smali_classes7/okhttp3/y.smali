...
.method public constructor <init>(Llh/f;Lokhttp3/x;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/y;->a:Llh/f;
    ...
    invoke-static {p3}, LYg/c;->u(Ljava/util/List;)Ljava/util/List;
...
.method private o(Llh/d;Z)J
    ...
    invoke-interface {p1, v8}, Llh/d;->write([B)Llh/d;

    iget-object v8, p0, Lokhttp3/y;->a:Llh/f;

    invoke-interface {p1, v8}, Llh/d;->K(Llh/f;)Llh/d;
    ...
    invoke-interface {p1, v10}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v10

    sget-object v11, Lokhttp3/y;->k:[B

    invoke-interface {v10, v11}, Llh/d;->write([B)Llh/d;
    ...
    invoke-interface {v10, v11}, Llh/d;->J(Ljava/lang/String;)Llh/d;
    ...
    invoke-interface {p1, v8}, Llh/d;->J(Ljava/lang/String;)Llh/d;
    ...
    invoke-interface {v8, v7}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v7

    sget-object v8, Lokhttp3/y;->l:[B

    invoke-interface {v7, v8}, Llh/d;->write([B)Llh/d;
    ...
    invoke-interface {p1, v9}, Llh/d;->J(Ljava/lang/String;)Llh/d;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Llh/d;->O(J)Llh/d;

    move-result-object v9

    sget-object v10, Lokhttp3/y;->l:[B

    invoke-interface {v9, v10}, Llh/d;->write([B)Llh/d;
    ...
    invoke-interface {p1, v9}, Llh/d;->write([B)Llh/d;
    ...
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/D;->h(Llh/d;)V
    ...
    invoke-interface {p1, v1}, Llh/d;->write([B)Llh/d;

    iget-object v2, p0, Lokhttp3/y;->a:Llh/f;

    invoke-interface {p1, v2}, Llh/d;->K(Llh/f;)Llh/d;
...
.method public a()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/y;->o(Llh/d;Z)J
...
.method public h(Llh/d;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/y;->o(Llh/d;Z)J
...
.method public j()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/y;->a:Llh/f;
