...
# direct methods
.method public static final synthetic a(Lag/l;)Z
    .locals 0

    invoke-static {p0}, Lag/o;->c(Lag/l;)Z
...
.method public static final synthetic b(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lag/o;->d(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/lang/Object;
...
.method public static final c(Lag/l;)Z
    .locals 4

    invoke-virtual {p0}, Lag/l;->c()Lag/l;
    ...
    invoke-virtual {v0}, Lag/l;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lag/l;->b()Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v0}, Lag/l;->d()Ljava/nio/file/Path;

    move-result-object v1

    invoke-virtual {p0}, Lag/l;->d()Ljava/nio/file/Path;
    ...
    :catch_0
    :cond_1
    invoke-virtual {v0}, Lag/l;->c()Lag/l;
