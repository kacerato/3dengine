...
.method public constructor <init>(I)V
    ...
    .line 2
    invoke-direct {p0, p1}, Loe/i;-><init>(I)V
...
.method public constructor <init>(IF)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Loe/i;-><init>(IF)V

    return-void
.end method

.method public constructor <init>(IFCB)V
    .locals 0

    .line 4
    invoke-direct {p0, p1, p2, p3, p4}, Loe/i;-><init>(IFCB)V
...
.method public constructor <init>(Lwe/i;)V
    ...
    invoke-direct {p0, v0}, Loe/i;-><init>(I)V
    ...
    .line 12
    iget-char v1, v0, Loe/i;->r:C

    iput-char v1, p0, Loe/i;->r:C

    .line 13
    iget-byte v0, v0, Loe/i;->s:B

    iput-byte v0, p0, Loe/i;->s:B

    if-eqz v1, :cond_0

    .line 14
    iget-object v0, p0, Loe/i;->q:[C

    invoke-static {v0, v1}, Ljava/util/Arrays;->fill([CC)V

    .line 15
    :cond_0
    iget-byte v0, p0, Loe/i;->s:B
    ...
    .line 18
    :cond_2
    invoke-virtual {p0, p1}, Lye/i;->pa(Lwe/i;)V
...
.method public constructor <init>([C[B)V
    ...
    invoke-virtual {p0, v2, v3}, Lye/i;->Q5(CB)B
...
.method public static synthetic Fe(Lye/i;)C
    .locals 0

    iget-char p0, p0, Loe/i;->r:C
...
.method public Cb(CB)Z
    ...
    invoke-virtual {p0, p1}, Loe/i;->Ae(C)I
...
.method public H(C)Z
    ...
    invoke-virtual {p0, p1}, Loe/i;->b1(C)Z
...
.method public final Me(CBI)B
    .locals 2

    iget-byte p1, p0, Loe/i;->s:B
...
.method public Q5(CB)B
    ...
    invoke-virtual {p0, p1}, Loe/i;->Ce(C)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lye/i;->Me(CBI)B
...
.method public c4(Lze/j;)Z
    ...
    invoke-interface {p1, v3, v5}, Lze/j;->a(CB)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Loe/i;->i()B

    move-result v3

    invoke-interface {p1}, Lwe/i;->i()B
    ...
    iget-object v5, p0, Loe/i;->q:[C

    aget-char v5, v5, v6

    invoke-interface {p1, v5}, Lwe/i;->m0(C)B
...
.method public ja(Lze/j;)Z
    ...
    invoke-interface {p1, v4, v7}, Lze/j;->a(CB)Z
...
.method public l0(Lze/q;)Z
    ...
    invoke-virtual {p0, p1}, Loe/i;->T0(Lze/q;)Z
...
.method public pa(Lwe/i;)V
    ...
    invoke-interface {p1}, Lre/k;->key()C

    move-result v0

    invoke-interface {p1}, Lre/k;->value()B

    move-result v1

    invoke-virtual {p0, v0, v1}, Lye/i;->Q5(CB)B
...
.method public putAll(Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v1, v0}, Lye/i;->Q5(CB)B
...
.method public readExternal(Ljava/io/ObjectInput;)V
    ...
    invoke-super {p0, p1}, Loe/i;->readExternal(Ljava/io/ObjectInput;)V
    ...
    invoke-virtual {p0, v0, v2}, Lye/i;->Q5(CB)B
...
.method public te(I)V
    ...
    invoke-virtual {p0, v1}, Loe/i;->Ce(C)I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lye/i;->c4(Lze/j;)Z
...
.method public ue(I)V
    ...
    iget-byte v1, p0, Loe/i;->s:B

    aput-byte v1, v0, p1

    invoke-super {p0, p1}, Loe/i;->ue(I)V
...
.method public we(I)I
    ...
    invoke-super {p0, p1}, Loe/i;->we(I)I
...
.method public writeExternal(Ljava/io/ObjectOutput;)V
    ...
    invoke-super {p0, p1}, Loe/i;->writeExternal(Ljava/io/ObjectOutput;)V
...
.method public z0(C)Z
    ...
    invoke-virtual {p0, p1, v0}, Lye/i;->Cb(CB)Z
