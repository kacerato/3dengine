...
.method public static F(LMg/a;)Ljava/lang/String;
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {v2}, LTg/b;->j()Ljava/lang/String;
...
.method public static R(Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-direct {v2, p0}, LMg/a;-><init>(Ljava/io/File;)V
    :try_end_0
    ...
    invoke-virtual {v4}, LTg/b;->j()Ljava/lang/String;
...
.method public static X(Ljava/io/File;)V
    ...
    :try_start_1
    invoke-static {v1}, Lcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/a;->F(LMg/a;)Ljava/lang/String;
    ...
    invoke-direct {v4, v3}, LMg/a;-><init>(Ljava/io/File;)V

    new-instance v5, LTg/s;

    invoke-direct {v5}, LTg/s;-><init>()V

    sget-object v6, LUg/d;->DEFLATE:LUg/d;

    invoke-virtual {v5, v6}, LTg/s;->y(LUg/d;)V

    sget-object v6, LUg/c;->NORMAL:LUg/c;

    invoke-virtual {v5, v6}, LTg/s;->x(LUg/c;)V

    const/4 v6, 0x1

    invoke-virtual {v5, v6}, LTg/s;->J(Z)V
    ...
    invoke-virtual {v7}, LTg/b;->j()Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {v5, v8}, LTg/s;->G(Ljava/lang/String;)V
    ...
    :try_start_4
    invoke-virtual {v4, v7, v5}, LMg/a;->k(Ljava/io/InputStream;LTg/s;)V
    :try_end_4
    ...
    invoke-virtual {v1, v7}, LMg/a;->X(LTg/j;)LRg/k;
...
.method public static d0(Ljava/io/File;)V
    ...
    invoke-direct {v5, v4}, LMg/a;-><init>(Ljava/io/File;)V

    new-instance v8, LTg/s;

    invoke-direct {v8}, LTg/s;-><init>()V

    sget-object v9, LUg/d;->DEFLATE:LUg/d;

    invoke-virtual {v8, v9}, LTg/s;->y(LUg/d;)V

    sget-object v9, LUg/c;->NORMAL:LUg/c;

    invoke-virtual {v8, v9}, LTg/s;->x(LUg/c;)V

    invoke-virtual {v8, v7}, LTg/s;->J(Z)V
    ...
    check-cast v10, LTg/j;

    invoke-virtual {v10}, LTg/b;->j()Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v8, v11}, LTg/s;->G(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-virtual {v5, v10, v8}, LMg/a;->k(Ljava/io/InputStream;LTg/s;)V
    :try_end_2
    ...
    invoke-virtual {v1, v10}, LMg/a;->X(LTg/j;)LRg/k;
...
.method public static e0(Ljava/io/File;)V
    ...
    new-instance v6, LTg/s;

    invoke-direct {v6}, LTg/s;-><init>()V

    sget-object v7, LUg/d;->DEFLATE:LUg/d;

    invoke-virtual {v6, v7}, LTg/s;->y(LUg/d;)V

    sget-object v7, LUg/c;->NORMAL:LUg/c;

    invoke-virtual {v6, v7}, LTg/s;->x(LUg/c;)V

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, LTg/s;->J(Z)V
    ...
    invoke-virtual {v8}, LTg/b;->j()Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v6, v9}, LTg/s;->G(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-virtual {v5, v8, v6}, LMg/a;->k(Ljava/io/InputStream;LTg/s;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    invoke-virtual {v1, v8}, LMg/a;->X(LTg/j;)LRg/k;
...
.method public static g0(Ljava/lang/String;ZLcom/itsmagic/engine/Activities/Editor/Extensions/PackageManager/a$p;)V
    ...
    invoke-static {p0}, Ln6/b;->D(Ljava/lang/String;)Lcom/itsmagic/engine/Activities/Editor/Panels/Marketplace/BackendAPI/v2/Package;
    ...
    invoke-static {v1}, Ln6/b;->P(Lcom/itsmagic/engine/Activities/Editor/Panels/Marketplace/BackendAPI/v2/Package;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v1}, Ln6/b;->N(Lcom/itsmagic/engine/Activities/Editor/Panels/Marketplace/BackendAPI/v2/Package;)Ljava/lang/String;
