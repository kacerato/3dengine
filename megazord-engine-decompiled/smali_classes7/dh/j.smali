...
.method public constructor <init>(Lokhttp3/z;Z)V
    ...
    iput-object p1, p0, Ldh/j;->a:Lokhttp3/z;

    iput-boolean p2, p0, Ldh/j;->b:Z
...
.method public a(Lokhttp3/w$a;)Lokhttp3/E;
    ...
    invoke-virtual {p1}, Ldh/g;->call()Lokhttp3/e;

    move-result-object v7

    invoke-virtual {p1}, Ldh/g;->i()Lokhttp3/r;

    move-result-object v8

    new-instance v9, Lch/f;

    iget-object v1, p0, Ldh/j;->a:Lokhttp3/z;
    ...
    invoke-virtual {p0, v1}, Ldh/j;->c(Lokhttp3/v;)Lokhttp3/a;

    move-result-object v3

    iget-object v6, p0, Ldh/j;->d:Ljava/lang/Object;
    ...
    invoke-direct/range {v1 .. v6}, Lch/f;-><init>(Lokhttp3/k;Lokhttp3/a;Lokhttp3/e;Lokhttp3/r;Ljava/lang/Object;)V

    iput-object v9, p0, Ldh/j;->c:Lch/f;
    ...
    :goto_0
    iget-boolean v3, p0, Ldh/j;->e:Z

    if-nez v3, :cond_8

    :try_start_0
    invoke-virtual {p1, v0, v9, v11, v11}, Ldh/g;->k(Lokhttp3/C;Lch/f;Ldh/c;Lch/c;)Lokhttp3/E;
    ...
    invoke-virtual {v1}, Lokhttp3/E;->s()Lokhttp3/E$a;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v9}, Lch/f;->o()Lokhttp3/G;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Ldh/j;->d(Lokhttp3/E;Lokhttp3/G;)Lokhttp3/C;
    ...
    invoke-virtual {p0, v0, v1}, Ldh/j;->i(Lokhttp3/E;Lokhttp3/v;)Z
    ...
    :cond_2
    invoke-virtual {v9}, Lch/f;->c()Ldh/c;
    ...
    invoke-virtual {p0, v3, v9, v4, v0}, Ldh/j;->g(Ljava/io/IOException;Lch/f;ZLokhttp3/C;)Z
    ...
    invoke-virtual {p0, v4, v9, v10, v0}, Ldh/j;->g(Ljava/io/IOException;Lch/f;ZLokhttp3/C;)Z
    ...
    :goto_2
    invoke-virtual {v9, v11}, Lch/f;->q(Ljava/io/IOException;)V
...
.method public b()V
    ...
    iput-boolean v0, p0, Ldh/j;->e:Z

    iget-object v0, p0, Ldh/j;->c:Lch/f;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lch/f;->b()V
...
.method public final c(Lokhttp3/v;)Lokhttp3/a;
    ...
    iget-object v0, p0, Ldh/j;->a:Lokhttp3/z;

    invoke-virtual {v0}, Lokhttp3/z;->E()Ljavax/net/ssl/SSLSocketFactory;
    ...
    iget-object v2, p0, Ldh/j;->a:Lokhttp3/z;
    ...
    iget-object p1, p0, Ldh/j;->a:Lokhttp3/z;
    ...
    invoke-virtual {p1}, Lokhttp3/z;->D()Ljavax/net/SocketFactory;
    ...
    invoke-virtual {p1}, Lokhttp3/z;->A()Ljava/net/ProxySelector;
...
.method public final d(Lokhttp3/E;Lokhttp3/G;)Lokhttp3/C;
    ...
    :cond_2
    invoke-virtual {p1}, Lokhttp3/E;->u()Lokhttp3/E;
    ...
    invoke-virtual {p0, p1, p2}, Ldh/j;->h(Lokhttp3/E;I)I
    ...
    :cond_d
    :pswitch_0
    iget-object p2, p0, Ldh/j;->a:Lokhttp3/z;
    ...
    invoke-static {v1}, Ldh/f;->b(Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_14

    invoke-static {v1}, Ldh/f;->d(Ljava/lang/String;)Z

    move-result v2

    invoke-static {v1}, Ldh/f;->c(Ljava/lang/String;)Z
    ...
    :cond_14
    invoke-virtual {p0, p1, p2}, Ldh/j;->i(Lokhttp3/E;Lokhttp3/v;)Z
...
.method public final g(Ljava/io/IOException;Lch/f;ZLokhttp3/C;)Z
    .locals 2

    invoke-virtual {p2, p1}, Lch/f;->q(Ljava/io/IOException;)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p3}, Ldh/j;->f(Ljava/io/IOException;Z)Z
