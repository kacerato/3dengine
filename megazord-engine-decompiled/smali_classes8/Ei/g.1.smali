...
.method public static H([F[F)Z
    ...
    invoke-static {p0, p1}, LEi/g;->E([F[F)F
...
.method public static V(LEi/W;LEi/W;)[F
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p1, v0}, LEi/W;->a(I)F
    ...
    invoke-virtual {p0, v2}, LEi/W;->a(I)F

    move-result v3

    invoke-virtual {p1, v2}, LEi/W;->a(I)F
    ...
    invoke-virtual {p0, v4}, LEi/W;->a(I)F

    move-result p0

    invoke-virtual {p1, v4}, LEi/W;->a(I)F
...
.method public static c([F[F[F[F)Ljava/util/Optional;
    ...
    invoke-static {p3, p1}, LEi/g;->W([F[F)[F
    ...
    invoke-static {p0, p1}, LEi/g;->W([F[F)[F
...
.method public static d([F[FI[F[F)Z
    ...
    :cond_2
    invoke-static {v0, v1, v8, v7}, LEi/g;->e([F[FII)LEi/U;

    move-result-object v7

    iget-object v8, v7, LEi/U;->a:Ljava/lang/Object;
    ...
    iget-object v7, v7, LEi/U;->b:Ljava/lang/Object;
...
.method public static e([F[FII)LEi/U;
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1, p2}, LEi/U;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    return-object p0
.end method

.method public static f([F[F[F)LEi/U;
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static h([F[F[F[F)Ljava/util/Optional;
    ...
    invoke-static {p1, p0}, LEi/g;->W([F[F)[F

    move-result-object p1

    invoke-static {p3, p2}, LEi/g;->W([F[F)[F

    move-result-object p3

    invoke-static {p0, p2}, LEi/g;->W([F[F)[F

    move-result-object p0

    invoke-static {p1, p3}, LEi/g;->X([F[F)F
    ...
    :cond_0
    invoke-static {p3, p0}, LEi/g;->X([F[F)F

    move-result p3

    div-float/2addr p3, p2

    invoke-static {p1, p0}, LEi/g;->X([F[F)F
    ...
    invoke-direct {p1, p2, p0}, LEi/U;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public static i([F[F[FI)LEi/g$a;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {v1, p0}, LEi/W;-><init>([F)V
    ...
    invoke-direct {v3, p2, v4}, LEi/W;-><init>([FI)V

    new-instance v4, LEi/W;

    mul-int/lit8 v5, p0, 0x3

    invoke-direct {v4, p2, v5}, LEi/W;-><init>([FI)V

    invoke-static {v4, v3}, LEi/g;->V(LEi/W;LEi/W;)[F

    move-result-object v4

    invoke-static {v1, v3}, LEi/g;->V(LEi/W;LEi/W;)[F

    move-result-object v3

    invoke-static {v4, v3}, LEi/g;->S([F[F)F

    move-result v3

    invoke-static {p1, v4}, LEi/g;->S([F[F)F
    ...
    iget v4, v0, LEi/g$a;->b:F

    cmpl-float v4, v3, v4

    if-lez v4, :cond_2

    iput v3, v0, LEi/g$a;->b:F

    iput v2, v0, LEi/g$a;->d:I

    iget v2, v0, LEi/g$a;->c:F
    ...
    :cond_1
    iget v4, v0, LEi/g$a;->c:F

    cmpg-float v4, v3, v4

    if-gez v4, :cond_2

    iput v3, v0, LEi/g$a;->c:F

    iput v2, v0, LEi/g$a;->e:I

    iget v2, v0, LEi/g$a;->b:F
    ...
    iput-boolean p0, v0, LEi/g$a;->a:Z
...
.method public static m([FI[FI)Z
    ...
    invoke-static {v7, p0, p1}, LEi/g;->q([F[FI)[F

    move-result-object v5

    invoke-static {v7, p2, p3}, LEi/g;->q([F[FI)[F
    ...
    invoke-static {v7, v5, v8, v6, v9}, LEi/g;->o(FFFFF)Z
    ...
    invoke-static {v8, v5, v9, v7, v10}, LEi/g;->o(FFFFF)Z
...
.method public static q([F[FI)[F
    ...
    invoke-static {p0, p1, v0}, LEi/g;->G([F[FI)F
    ...
    invoke-static {p0, p1, v5}, LEi/g;->G([F[FI)F
...
.method public static r([FI[FFF)[F
    ...
    invoke-static {p0, v0, v7, v8}, LEi/g;->t([FIII)F
