...
.method public constructor <init>(LC4/b$a;)V
    ...
    iput-object p1, p0, LC4/b$a$b;->a:LC4/b$a;
...
.method public a(LH4/f;Lcom/itsmagic/engine/Activities/Editor/Interface/PanelsController;)Z
    ...
    check-cast v0, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;

    const/4 v1, 0x1

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->N0(LH4/f;)Z

    invoke-virtual {p2, v0}, Lcom/itsmagic/engine/Activities/Editor/Interface/PanelsController;->u0(Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;)V

    return v1

    :cond_0
    new-instance p2, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;

    invoke-direct {p2}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;-><init>()V

    iget-object v0, p1, LH4/d;->b:Ljava/lang/String;

    if-eqz v0, :cond_1

    invoke-virtual {p2, v0}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->u1(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1}, Lcom/itsmagic/engine/Activities/Editor/Panels/NoCode/NoCodePanel;->t1(Lcom/itsmagic/engine/Engines/Engine/NoCode/Components/NoCodeExecutor;)V
