...
.method public a(Lokhttp3/w$a;)Lokhttp3/E;
    ...
    invoke-virtual {p1}, Ldh/g;->j()Ldh/c;

    move-result-object v0

    invoke-virtual {p1}, Ldh/g;->l()Lch/f;

    move-result-object v1

    invoke-virtual {p1}, Ldh/g;->f()Lokhttp3/j;

    move-result-object v2

    check-cast v2, Lch/c;

    invoke-virtual {p1}, Ldh/g;->b0()Lokhttp3/C;
    ...
    invoke-interface {v0, v3}, Ldh/c;->c(Lokhttp3/C;)V
    ...
    invoke-static {v6}, Ldh/f;->b(Ljava/lang/String;)Z
    ...
    invoke-interface {v0, v6}, Ldh/c;->e(Z)Lokhttp3/E$a;
    ...
    new-instance v2, Ldh/b$a;

    invoke-interface {v0, v3, v8, v9}, Ldh/c;->b(Lokhttp3/C;J)Llh/x;

    move-result-object v6

    invoke-direct {v2, v6}, Ldh/b$a;-><init>(Llh/x;)V
    ...
    invoke-virtual {v8, v6}, Lokhttp3/D;->h(Llh/d;)V

    invoke-interface {v6}, Llh/x;->close()V
    ...
    :cond_1
    invoke-virtual {v2}, Lch/c;->q()Z

    move-result v2

    if-nez v2, :cond_2

    invoke-virtual {v1}, Lch/f;->j()V

    :cond_2
    :goto_0
    invoke-interface {v0}, Ldh/c;->a()V
    ...
    invoke-interface {v0, v2}, Ldh/c;->e(Z)Lokhttp3/E$a;
    ...
    invoke-virtual {v1}, Lch/f;->d()Lch/c;

    move-result-object v7

    invoke-virtual {v7}, Lch/c;->c()Lokhttp3/t;
    ...
    invoke-virtual {v3}, Lch/c;->c()Lokhttp3/t;
    ...
    invoke-virtual {v6}, Lokhttp3/E;->s()Lokhttp3/E$a;
    ...
    invoke-interface {v0, v6}, Ldh/c;->d(Lokhttp3/E;)Lokhttp3/F;
