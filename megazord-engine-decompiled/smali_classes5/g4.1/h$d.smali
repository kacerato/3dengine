...
.method public constructor <init>(Lg4/h;)V
    ...
    iput-object p1, p0, Lg4/h$d;->a:Lg4/h;
...
.method public bridge synthetic a(Lw7/b;Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lg4/h$d;->c(Lg4/i;Ljava/lang/String;I)V
...
.method public bridge synthetic b(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Lw7/b;
    ...
    invoke-virtual {p0, p1, p2}, Lg4/h$d;->d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Lg4/i;
...
.method public c(Lg4/i;Ljava/lang/String;I)V
    ...
    invoke-static {p2}, Lg4/h;->x1(Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    iget-object v1, p0, Lg4/h$d;->a:Lg4/h;

    invoke-virtual {v1}, Lcom/itsmagic/engine/Activities/Editor/Interface/Objects/EditorPanel;->M()Landroid/content/Context;

    move-result-object v1

    invoke-static {p3, v0, v1}, Lod/e;->g0(Landroid/widget/ImageView;Ljava/io/File;Landroid/content/Context;)V

    iget-object p3, p1, Lg4/i;->b:Landroid/widget/ImageView;

    new-instance v0, Lg4/h$d$a;

    invoke-direct {v0, p0, p1, p2}, Lg4/h$d$a;-><init>(Lg4/h$d;Lg4/i;Ljava/lang/String;)V
    ...
    iget-object p3, p0, Lg4/h$d;->a:Lg4/h;

    invoke-static {p3}, Lg4/h;->r1(Lg4/h;)Ljava/lang/String;
    ...
    iget-object p2, p0, Lg4/h$d;->a:Lg4/h;

    invoke-static {p2}, Lg4/h;->p1(Lg4/h;)[Landroid/widget/ImageView;
