...
.method private updateTextures()V
    ...
    invoke-virtual {v3}, Lna/q;->a()LMb/g;

    move-result-object v3

    invoke-virtual {p0, v2, v3}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/BaseComponents/ImGuiBaseComponent;->or(LMb/p;LMb/p;)LMb/p;
    ...
    invoke-virtual {p0, v3, v4}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/BaseComponents/ImGuiBaseComponent;->or9p(Lcom/itsmagic/engine/Engines/Engine/ImGUI/Utils/UIImageHandler;LMb/p;)Z
    ...
    invoke-virtual {v4}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->getSelectedTouch()LMc/h;

    move-result-object v4

    instance-of v5, v4, Lna/r;

    if-eqz v5, :cond_2

    check-cast v4, Lna/r;

    invoke-virtual {v4}, Lna/r;->M()Z
    ...
    invoke-virtual {v1}, Lna/q;->b()LMb/g;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/BaseComponents/ImGuiBaseComponent;->or9p(Lcom/itsmagic/engine/Engines/Engine/ImGUI/Utils/UIImageHandler;LMb/p;)Z
    ...
    :cond_5
    :goto_2
    iget-object v4, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIHoverButton;->P:LMb/p;

    if-eq v4, v2, :cond_6

    iput-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIHoverButton;->P:LMb/p;
...
.method public getClickedTexture()LMb/p;
    .locals 1
    .annotation runtime LK8/a;
    .end annotation
...
.method public getDependencyFiles(Lbd/h;)Lbd/k;
    ...
    invoke-virtual {v1, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Utils/UIFontHandler;->d(Lbd/h;)Lbd/k;
...
.method public getHoverTexture()LMb/p;
    .locals 1
    .annotation runtime LK8/a;
    .end annotation
...
.method public getNormalTexture()LMb/p;
    .locals 1
    .annotation runtime LK8/a;
    .end annotation
...
.method public onGuiStart(Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;)V
    ...
    iget-object v2, v0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIHoverButton;->P:LMb/p;
    ...
    :goto_0
    instance-of v7, v6, Lna/r;

    if-eqz v7, :cond_2

    check-cast v6, Lna/r;

    invoke-virtual {v6}, Lna/r;->M()Z
    ...
    invoke-virtual {v3}, Lna/q;->b()LMb/g;
    ...
    invoke-virtual {v4}, Lna/q;->b()LMb/g;
    ...
    invoke-virtual {v7}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UITouchTrigger;->getSelectedTouch()LMc/h;
    ...
    invoke-static/range {v7 .. v20}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/ImGui;->J(Ljava/lang/String;LMb/p;FFFLcom/itsmagic/engine/Engines/Engine/Color/ColorINT;Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;FFFJZLcom/itsmagic/engine/Engines/Engine/ImGUI/Utils/UIImageHandler;)Z
    ...
    invoke-virtual {v9}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->k0()F
    ...
    invoke-virtual {v10}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->l0()F
    ...
    invoke-static/range {v7 .. v19}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/ImGui;->d(Ljava/lang/String;LMb/p;FFLcom/itsmagic/engine/Engines/Engine/Color/ColorINT;Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;FFFJZLcom/itsmagic/engine/Engines/Engine/ImGUI/Utils/UIImageHandler;)Z
...
.method public setClickedTexture(LMb/p;)V
    .locals 1
    .annotation runtime LK8/a;
    .end annotation
...
.method public setHoverTexture(LMb/p;)V
    .locals 1
    .annotation runtime LK8/a;
    .end annotation
...
.method public setNormalTexture(LMb/p;)V
    .locals 1
    .annotation runtime LK8/a;
    .end annotation
