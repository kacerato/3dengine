...
.field public final f:Lgf/V0$a$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lgf/V0$a<",
            "TT;>.a;"
...
.method public constructor <init>(LTe/I;Ltf/i;LTe/G;)V
    ...
    iput-object p1, p0, Lgf/V0$a;->b:LTe/I;

    iput-object p2, p0, Lgf/V0$a;->e:Ltf/i;

    iput-object p3, p0, Lgf/V0$a;->h:LTe/G;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Lgf/V0$a;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Lio/reactivex/internal/util/c;

    invoke-direct {p1}, Lio/reactivex/internal/util/c;-><init>()V

    iput-object p1, p0, Lgf/V0$a;->d:Lio/reactivex/internal/util/c;

    new-instance p1, Lgf/V0$a$a;

    invoke-direct {p1, p0}, Lgf/V0$a$a;-><init>(Lgf/V0$a;)V

    iput-object p1, p0, Lgf/V0$a;->f:Lgf/V0$a$a;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lgf/V0$a;->g:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public a()V
    ...
    iget-object v0, p0, Lgf/V0$a;->f:Lgf/V0$a$a;

    invoke-static {v0}, LYe/d;->a(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object v0, p0, Lgf/V0$a;->b:LTe/I;

    iget-object v1, p0, Lgf/V0$a;->d:Lio/reactivex/internal/util/c;
...
.method public b()V
    ...
    iget-object v0, p0, Lgf/V0$a;->g:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public f()V
    ...
    invoke-virtual {p0}, Lgf/V0$a;->h()V
...
.method public h()V
    ...
    iget-object v0, p0, Lgf/V0$a;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    invoke-virtual {p0}, Lgf/V0$a;->d()Z
    ...
    :cond_1
    iget-boolean v0, p0, Lgf/V0$a;->i:Z

    if-nez v0, :cond_2

    const/4 v0, 0x1

    iput-boolean v0, p0, Lgf/V0$a;->i:Z

    iget-object v0, p0, Lgf/V0$a;->h:LTe/G;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lgf/V0$a;->e:Ltf/i;
