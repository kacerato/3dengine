...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lp/b;->q:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lp/b;->r:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lp/b;->i:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lp/b;->l:Ljava/util/SortedMap;
    ...
    iput-object p1, p0, Lp/b;->m:Ljava/util/Map;
    ...
    iput-object p1, p0, Lp/b;->n:Ljava/util/List;

    .line 9
    new-instance p1, Lp/b$b;

    invoke-direct {p1, p0}, Lp/b$b;-><init>(Lp/b;)V
    ...
    invoke-direct {p1, p0}, Lp/b$c;-><init>(Lp/b;)V

    iput-object p1, p0, Lp/b;->p:Landroid/text/TextWatcher;

    .line 11
    invoke-virtual {p0}, Lp/b;->x()V
...
.method public static synthetic a(Lp/b;)Z
    .locals 0

    iget-boolean p0, p0, Lp/b;->f:Z

    return p0
.end method

.method public static synthetic b(Lp/b;Ljava/lang/CharSequence;Landroid/text/Spanned;II)Ljava/lang/CharSequence;
    .locals 0

    invoke-virtual {p0, p1, p2, p3, p4}, Lp/b;->m(Ljava/lang/CharSequence;Landroid/text/Spanned;II)Ljava/lang/CharSequence;
...
.method public static synthetic c(Lp/b;)I
    .locals 0
...
.method public static synthetic d(Lp/b;Landroid/text/Editable;)V
    .locals 0

    invoke-virtual {p0, p1}, Lp/b;->w(Landroid/text/Editable;)V

    return-void
.end method

.method public static synthetic e(Lp/b;Landroid/text/Editable;II)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lp/b;->q(Landroid/text/Editable;II)V

    return-void
.end method

.method public static synthetic f(Lp/b;Z)Z
    .locals 0
...
.method public static synthetic g(Lp/b;)Ljava/lang/Runnable;
    .locals 0

    iget-object p0, p0, Lp/b;->o:Ljava/lang/Runnable;

    return-object p0
.end method

.method public static synthetic h(Lp/b;)I
    .locals 0
...
.method public static synthetic i(Lp/b;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lp/b;->i:Landroid/os/Handler;

    return-object p0
.end method

.method public static synthetic j(Lp/b;)Z
    .locals 0

    iget-boolean p0, p0, Lp/b;->h:Z
...
.method public A()V
    ...
    invoke-virtual {p0, v0}, Lp/b;->v(Landroid/text/Editable;)V
...
.method public B()V
    ...
    iget-object v0, p0, Lp/b;->l:Ljava/util/SortedMap;
...
.method public C(Ljava/util/regex/Pattern;)V
    ...
    iget-object v0, p0, Lp/b;->m:Ljava/util/Map;
...
.method public getAutoIndentCharacterList()Ljava/util/List;
    ...
    iget-object v0, p0, Lp/b;->n:Ljava/util/List;
...
.method public getTextWithoutTrailingSpace()Ljava/lang/String;
    ...
    sget-object v0, Lp/b;->r:Ljava/util/regex/Pattern;
...
.method public final m(Ljava/lang/CharSequence;Landroid/text/Spanned;II)Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Lp/b;->n:Ljava/util/List;
...
.method public n()V
    ...
    iget-object v0, p0, Lp/b;->i:Landroid/os/Handler;

    iget-object v1, p0, Lp/b;->o:Ljava/lang/Runnable;
...
.method public final q(Landroid/text/Editable;II)V
    ...
    new-instance v1, Lp/b$d;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lp/b$d;-><init>(Lp/b;Lp/b$a;)V
...
.method public removeErrorLine(I)V
    ...
    iget-object p1, p0, Lp/b;->l:Ljava/util/SortedMap;
...
.method public setAutoCompleteTokenizer(Landroid/widget/MultiAutoCompleteTextView$Tokenizer;)V
    ...
    iput-object p1, p0, Lp/b;->j:Landroid/widget/MultiAutoCompleteTextView$Tokenizer;
...
.method public setTextHighlighted(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v0}, Lp/b;->t(Landroid/text/Editable;)Landroid/text/Editable;
...
.method public final t(Landroid/text/Editable;)Landroid/text/Editable;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lp/b;->p(Landroid/text/Editable;)V

    invoke-virtual {p0, p1}, Lp/b;->u(Landroid/text/Editable;)V

    invoke-virtual {p0, p1}, Lp/b;->v(Landroid/text/Editable;)V
    :try_end_0
...
.method public final u(Landroid/text/Editable;)V
    ...
    sget-object v1, Lp/b;->q:Ljava/util/regex/Pattern;
    ...
    iget-object v3, p0, Lp/b;->l:Ljava/util/SortedMap;
    ...
    invoke-virtual {p0, p1, v1, v3}, Lp/b;->r(Landroid/text/Editable;Ljava/util/regex/Matcher;I)V
...
.method public final v(Landroid/text/Editable;)V
    ...
    iget-object v2, p0, Lp/b;->m:Ljava/util/Map;
    ...
    invoke-virtual {p0, p1, v1, v2}, Lp/b;->s(Landroid/text/Editable;Ljava/util/regex/Matcher;I)V
...
.method public final w(Landroid/text/Editable;)V
    ...
    invoke-virtual {p0, p1}, Lp/b;->t(Landroid/text/Editable;)Landroid/text/Editable;
...
.method public final x()V
    ...
    iget-object v1, p0, Lp/b;->j:Landroid/widget/MultiAutoCompleteTextView$Tokenizer;
    ...
    iput-object v1, p0, Lp/b;->j:Landroid/widget/MultiAutoCompleteTextView$Tokenizer;
    ...
    invoke-direct {v1, p0}, Lp/b$a;-><init>(Lp/b;)V
    ...
    iget-object v0, p0, Lp/b;->p:Landroid/text/TextWatcher;
...
.method public z()V
    ...
    invoke-virtual {p0, v0}, Lp/b;->u(Landroid/text/Editable;)V
