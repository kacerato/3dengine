...
.method public b(Lcom/jme3/scene/Mesh;)Z
    ...
    :cond_2
    instance-of p1, p1, LDf/l;

    goto :goto_0

    :cond_3
    instance-of p1, p1, LDf/j;

    goto :goto_0

    :cond_4
    instance-of p1, p1, LDf/i;
...
.method public c(FZZ)Lcom/jme3/scene/Mesh;
    ...
    invoke-direct {v0, v1, p1}, LDf/l;-><init>(IF)V
    ...
    invoke-direct {v0, v1, p1}, LDf/j;-><init>(IF)V
    ...
    invoke-direct {v0, v1, p1}, LDf/i;-><init>(IF)V

    :goto_0
    invoke-static {v0}, LAf/p;->q(Lcom/jme3/scene/Mesh;)Z
    ...
    invoke-static {v0}, LAf/p;->b(Lcom/jme3/scene/Mesh;)V

    :cond_6
    :goto_1
    invoke-static {v0}, LAf/p;->t(Lcom/jme3/scene/Mesh;)Z
