...
.method public static final a(J[BIII)V
    ...
    invoke-static/range {p0 .. p5}, Lvg/f;->s(J[BIII)V
...
.method public static final b([BI)J
    ...
    invoke-static {p0, p1}, Lvg/f;->t([BI)J
...
.method public static final c(Ljava/nio/ByteBuffer;)Lvg/c;
    .locals 5
...
.method public static final d(Ljava/nio/ByteBuffer;I)Lvg/c;
    .locals 4
    .param p0    # Ljava/nio/ByteBuffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final e(Ljava/nio/ByteBuffer;ILvg/c;)Ljava/nio/ByteBuffer;
    .locals 5
    .param p0    # Ljava/nio/ByteBuffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p2}, Lvg/c;->e()J

    move-result-wide v0

    invoke-virtual {p2}, Lvg/c;->c()J
...
.method public static final f(Ljava/nio/ByteBuffer;Lvg/c;)Ljava/nio/ByteBuffer;
    .locals 5
    .param p0    # Ljava/nio/ByteBuffer;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p1}, Lvg/c;->e()J

    move-result-wide v0

    invoke-virtual {p1}, Lvg/c;->c()J
...
.method public static final h([B)V
    ...
    invoke-virtual {v0}, Lvg/b;->a()Ljava/security/SecureRandom;
...
.method public static final i(Lvg/c;)Ljava/lang/Object;
    .locals 5
    .param p0    # Lvg/c;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lvg/g;-><init>(JJ)V
...
.method public static final j([BIJ)V
    ...
    invoke-static {p0, p1, p2, p3}, Lvg/f;->v([BIJ)V

    return-void
.end method

.method public static final k(Lvg/c;)Ljava/util/UUID;
    .locals 4
    .param p0    # Lvg/c;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final l(Ljava/util/UUID;)Lvg/c;
    .locals 5
...
.method public static final m(Ljava/lang/String;)Lvg/c;
    .locals 1
    ...
    invoke-static {p0}, Lvg/f;->A(Ljava/lang/String;)Lvg/c;
...
.method public static final n(Ljava/lang/String;)Lvg/c;
    .locals 1
    .param p0    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0}, Lvg/f;->C(Ljava/lang/String;)Lvg/c;
...
.method public static final o(Ljava/lang/String;)Lvg/c;
    .locals 1
    .param p0    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0}, Lvg/f;->E(Ljava/lang/String;)Lvg/c;
...
.method public static final p(Ljava/lang/String;)Lvg/c;
    .locals 1
    .param p0    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0}, Lvg/f;->F(Ljava/lang/String;)Lvg/c;
