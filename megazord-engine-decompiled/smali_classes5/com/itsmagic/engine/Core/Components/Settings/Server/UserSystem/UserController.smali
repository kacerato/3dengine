...
.method public constructor <init>(La9/d;)V
    ...
    .line 7
    iput-object p1, p0, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->c:La9/d;
...
.method public static M()Z
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->K()Ljava/lang/String;
...
.method public static O()Z
    ...
    iget-object v2, v0, LU8/a;->d:Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;
...
.method public static X(La9/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static Y(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->P()Z
    ...
    :cond_1
    :goto_0
    invoke-static {}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->V()V
...
.method public static synthetic c(Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;)V
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->W()V
...
.method public static t(La9/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public C(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->i0()V
...
.method public F(Landroid/content/Context;)Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public U()V
    ...
    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->Z(Z)V
    ...
    :try_start_1
    invoke-interface {v2}, La9/a;->update()V
    :try_end_1
...
.method public Z(Z)V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->c:La9/d;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, La9/d;->a(Z)V

    :cond_0
    return-void
.end method

.method public a0(La9/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public d0(ZLandroid/content/Context;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p0, p2}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->C(Landroid/content/Context;)Ljava/lang/String;

    invoke-virtual {p0, p3}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->Z(Z)V
...
.method public i0()V
    ...
    invoke-virtual {p0, v0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->j0(Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController$g;)V

    :cond_0
    return-void
.end method

.method public j0(Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController$g;)V
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {v2, v0}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->F(Landroid/content/Context;)Ljava/util/HashMap;
    ...
    invoke-direct {v2, v3, p1, v0}, LAd/e;-><init>(Ljava/lang/String;Ljava/util/Map;Landroid/content/Context;)V

    invoke-virtual {v1, v2}, Lxd/c;->d(LAd/e;)V
...
.method public u(Landroid/content/Context;)V
    ...
    iget-object v3, v2, LU8/a;->d:Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;

    invoke-virtual {v3, p1}, Lcom/itsmagic/engine/Core/Components/Settings/Server/UserSystem/UserController;->F(Landroid/content/Context;)Ljava/util/HashMap;
    ...
    iget-object v2, v2, LU8/a;->c:LZ8/a;

    const-string v2, "backend/view/users/configs/"

    const-string v4, "addRewardedEarn.php"

    invoke-static {v2, v4}, LZ8/a;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v3, v2, v1, p1}, LAd/e;-><init>(Ljava/lang/String;Ljava/util/Map;Landroid/content/Context;)V

    invoke-virtual {v0, v3}, Lxd/c;->d(LAd/e;)V
...
.method public z()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lgd/b;->x1(Ljava/lang/String;I)I
    ...
    invoke-static {v0}, Lgd/b;->t0(F)Ljava/lang/String;
