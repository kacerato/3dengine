...
.method private ensureWebView(II)V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->P:Lbd/V;
    ...
    invoke-direct {v0, v1, p1, p2, v2}, Lbd/V;-><init>(Landroid/content/Context;IILjava/lang/String;)V

    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->P:Lbd/V;

    iget-boolean p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->allowHibernate:Z

    invoke-virtual {v0, p1}, Lbd/V;->B(Z)V

    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->P:Lbd/V;

    invoke-direct {p0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->getSafeFps()I

    move-result p2

    invoke-virtual {p1, p2}, Lbd/V;->C(I)V
...
.method private internalizePosition(LMc/h;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    :cond_0
    instance-of v3, p1, Lna/r;

    if-eqz v3, :cond_1

    invoke-virtual {p1, v2}, LMc/h;->h(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;

    goto :goto_0

    :cond_1
    invoke-virtual {v1, p1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;->getTouchPos(LMc/h;)Lcom/itsmagic/engine/Engines/Engine/ImGUI/Vectors/UVec2I;
    ...
    invoke-virtual {v2, v1, p1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;->S0(FF)V
...
.method private updateKeyboardRequest()V
    ...
    invoke-virtual {v0}, Lbd/V;->v()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, LKc/a;->e(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V

    goto :goto_0

    :cond_0
    invoke-static {p0}, LKc/a;->H(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V
...
.method private updateKeyboardToWebView()V
    ...
    invoke-virtual {v5, v4}, LKc/a$f;->f(Ljava/lang/String;)LMc/e;
    ...
    :cond_1
    invoke-virtual {v4}, LMc/e;->r()I

    move-result v5

    iget-boolean v6, v4, LMc/e;->j:Z

    if-eqz v6, :cond_2

    iget-object v4, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->P:Lbd/V;

    const/4 v6, 0x1

    invoke-virtual {v4, v6, v5}, Lbd/V;->z(II)V

    goto :goto_1

    :cond_2
    iget-boolean v6, v4, LMc/e;->d:Z

    if-nez v6, :cond_3

    iget-boolean v4, v4, LMc/e;->e:Z
    ...
    invoke-virtual {v4, v2, v5}, Lbd/V;->z(II)V
...
.method private updateTouchToWebView()V
    ...
    :cond_1
    invoke-direct {p0, v0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->internalizePosition(LMc/h;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
    ...
    invoke-virtual {v0, v3, v2, v1}, Lbd/V;->A(IFF)V
...
.method public getInspectorEntries(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {p1}, Lbd/V;->t()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->P:Lbd/V;

    invoke-virtual {v2}, Lbd/V;->t()Ljava/lang/String;
...
.method public getLoadedUrl()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v0}, Lbd/V;->t()Ljava/lang/String;
...
.method public getTexture()LMb/p;
    ...
    :cond_0
    invoke-virtual {v0}, Lbd/V;->s()LMb/l;
...
.method public onGuiStart(Lcom/itsmagic/engine/Engines/Engine/ImGUI/Controller/UIController;)V
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->getTexture()LMb/p;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, LMb/p;->W()Z
    ...
    invoke-virtual {p1}, Lna/q;->i()LMb/g;
    ...
    invoke-static {p1, v2, v0, v1}, Lcom/itsmagic/engine/Engines/Engine/ImGUI/ImGui;->k(LMb/p;Lcom/itsmagic/engine/Engines/Engine/Color/ColorINT;FF)V
...
.method public preUpdate(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Z)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p1}, Lbd/V;->y(II)V
    ...
    invoke-virtual {p1, p2}, Lbd/V;->B(Z)V

    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ImGUI/Widgets/UIWebView;->P:Lbd/V;

    invoke-virtual {p1}, Lbd/V;->E()V
...
.method public setFps(I)V
    ...
    invoke-virtual {v0, p1}, Lbd/V;->C(I)V
...
.method public setUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lbd/V;->w(Ljava/lang/String;)V
