...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;->c:Ljava/lang/String;
...
# virtual methods
.method public a(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$i;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;)V
    .locals 3
    ...
    :goto_0
    invoke-virtual {p2}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;->d()Ljava/lang/String;

    move-result-object v1

    const-string v2, "Attempted to acquire multiple locks with the same rank %s"

    invoke-static {v0, v2, v1}, LR2/H;->x0(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-static {}, Lcom/google/common/collect/D2;->z()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {p2, p0, v0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;->c(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;Ljava/util/Set;)Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;

    move-result-object v0

    if-nez v0, :cond_3

    iget-object p1, p0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;->a:Ljava/util/Map;

    new-instance v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;

    invoke-direct {v0, p2, p0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;-><init>(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;)V
...
.method public b(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$i;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;->a(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$i;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;)V
...
.method public final c(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;Ljava/util/Set;)Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3, p1, p2}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;->c(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;Ljava/util/Set;)Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;
    ...
    invoke-direct {p1, v3, p0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;-><init>(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$g;)V
