...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LN4/c;->c:Ljava/util/List;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v0

    iput-object v0, p0, LN4/c;->a:Landroid/view/LayoutInflater;

    invoke-static {p1}, LIe/e;->a(Landroid/content/Context;)LIe/e$a;

    move-result-object v0

    invoke-static {p1}, LMe/d;->n(Landroid/content/Context;)LMe/d;

    move-result-object p1

    invoke-interface {v0, p1}, LIe/e$a;->c(LIe/i;)LIe/e$a;

    move-result-object p1

    invoke-static {}, LPe/a;->n()LPe/a;

    move-result-object v0

    invoke-interface {p1, v0}, LIe/e$a;->c(LIe/i;)LIe/e$a;

    move-result-object p1

    invoke-interface {p1}, LIe/e$a;->build()LIe/e;

    move-result-object p1

    iput-object p1, p0, LN4/c;->b:LIe/e;

    return-void
.end method

.method public static synthetic g(LN4/c;)LIe/e;
    .locals 0

    iget-object p0, p0, LN4/c;->b:LIe/e;
...
.method public h(Lcom/itsmagic/engine/Activities/Editor/Panels/AIAgent/AIAgentChatMessage;)V
    ...
    iget-object p1, p0, LN4/c;->c:Ljava/util/List;
...
.method public final j(Ljava/lang/String;)I
    ...
    iget-object v2, p0, LN4/c;->c:Ljava/util/List;
...
.method public l()Z
    ...
    invoke-virtual {p0, v0}, LN4/c;->i(I)I
...
.method public o(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, p1}, LN4/c;->j(Ljava/lang/String;)I
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    instance-of v0, p1, LN4/c$d;

    if-eqz v0, :cond_0

    check-cast p1, LN4/c$d;

    invoke-static {p1, p2}, LN4/c$d;->a(LN4/c$d;Lcom/itsmagic/engine/Activities/Editor/Panels/AIAgent/AIAgentChatMessage;)V

    return-void

    :cond_0
    instance-of v0, p1, LN4/c$c;

    if-eqz v0, :cond_1

    check-cast p1, LN4/c$c;

    invoke-static {p1, p2}, LN4/c$c;->a(LN4/c$c;Lcom/itsmagic/engine/Activities/Editor/Panels/AIAgent/AIAgentChatMessage;)V

    return-void

    :cond_1
    instance-of v0, p1, LN4/c$b;

    if-eqz v0, :cond_2

    check-cast p1, LN4/c$b;

    invoke-static {p1, p2}, LN4/c$b;->a(LN4/c$b;Lcom/itsmagic/engine/Activities/Editor/Panels/AIAgent/AIAgentChatMessage;)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object p2, p0, LN4/c;->a:Landroid/view/LayoutInflater;
    ...
    new-instance p2, LN4/c$d;

    invoke-direct {p2, p0, p1, v1}, LN4/c$d;-><init>(LN4/c;Landroid/view/View;LN4/c$a;)V
    ...
    new-instance p2, LN4/c$c;

    invoke-direct {p2, p0, p1, v1}, LN4/c$c;-><init>(LN4/c;Landroid/view/View;LN4/c$a;)V
    ...
    new-instance p2, LN4/c$b;

    invoke-direct {p2, p0, p1, v1}, LN4/c$b;-><init>(LN4/c;Landroid/view/View;LN4/c$a;)V
