...
.method public constructor <init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Landroid/view/View;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroidx/recyclerview/widget/RecyclerView;Landroid/app/Activity;Landroid/view/LayoutInflater;)V
    ...
    invoke-direct/range {v0 .. v6}, LV5/a;-><init>(Landroid/view/View;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroidx/recyclerview/widget/RecyclerView;Landroid/app/Activity;Landroid/view/LayoutInflater;)V

    iput-object p1, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    return-void
.end method

.method public static synthetic i(LV5/c;)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    .locals 0

    iget-object p0, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    return-object p0
.end method

.method public static synthetic j(LV5/c;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)LW5/d;
    .locals 0

    invoke-virtual {p0, p1}, LV5/c;->n(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)LW5/d;
...
.method public a()V
    ...
    invoke-super {p0}, LV5/a;->a()V

    invoke-virtual {p0}, LV5/c;->k()V

    invoke-virtual {p0}, LV5/c;->l()V
...
.method public b(I)V
    ...
    new-instance v0, LV5/c$f;

    invoke-direct {v0, p0, p1}, LV5/c$f;-><init>(LV5/c;I)V
...
.method public c()V
    ...
    new-instance v0, LV5/c$g;

    invoke-direct {v0, p0}, LV5/c$g;-><init>(LV5/c;)V
...
.method public d()V
    ...
    sget-object v1, Ls8/b$a;->GameObject:Ls8/b$a;

    if-ne v0, v1, :cond_0

    invoke-virtual {p0}, LV5/c;->u()V
...
.method public h()V
    ...
    invoke-super {p0}, LV5/a;->h()V

    iget-object v0, p0, LV5/c;->g:LW5/c;
    ...
    :goto_0
    iget-object v1, p0, LV5/c;->g:LW5/c;

    invoke-virtual {v1}, LW5/c;->getItemCount()I
    ...
    invoke-virtual {v1, v0}, LW5/c;->i(I)LW5/d;
...
.method public final l()V
    ...
    invoke-virtual {v0}, LW5/c;->h()V

    :cond_0
    return-void
.end method

.method public final m()LW5/d;
    .locals 5

    iget-object v0, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->OPTIONS:LUc/b;

    invoke-static {v2}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->l(LUc/b;)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    invoke-direct {v0, v2, v1, v3}, LW5/a;-><init>(Ljava/lang/String;ZLcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;)V
    ...
    iget-object v2, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    sget-object v3, LW5/d$a;->Component:LW5/d$a;

    const/4 v4, 0x0

    invoke-direct {v1, v2, v3, v0, v4}, LW5/d;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;LW5/d$a;LW5/a;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V

    return-object v1
.end method

.method public final n(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)LW5/d;
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-direct {v1, v0, v2, v3}, LW5/a;-><init>(Ljava/lang/String;ZLcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;)V

    const/4 v0, 0x0

    iput-boolean v0, v1, LW5/a;->e:Z
    ...
    new-instance v3, LV5/c$d;

    invoke-direct {v3, p0, p1}, LV5/c$d;-><init>(LV5/c;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V

    invoke-virtual {p1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;->getEditor()Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;

    move-result-object v4

    invoke-direct {v1, v0, v2, v3, v4}, LW5/a;-><init>(Ljava/lang/String;ZLX5/h;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;)V
    ...
    new-instance v0, LV5/c$e;

    invoke-direct {v0, p0}, LV5/c$e;-><init>(LV5/c;)V

    iput-object v0, v1, LW5/a;->h:LX5/g;
    ...
    iput-object v0, v1, LW5/a;->q:LJAVARuntime/Color;
    ...
    iput-object v3, v1, LW5/a;->o:Ljava/util/List;
    ...
    sget-object v6, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->DEPRECATED_PREFIX:LUc/b;
    ...
    invoke-direct {v4, v5, v2, v0}, LW5/b;-><init>(Ljava/lang/String;II)V
    ...
    :cond_3
    :goto_1
    iget-object v3, p0, LV5/a;->e:Landroid/app/Activity;
    ...
    iget-object v4, v1, LW5/a;->o:Ljava/util/List;
    ...
    sget-object v5, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->ERROR_SOMETHING_WENT_WRONG:LUc/b;
    ...
    :cond_4
    :goto_4
    iget-object v0, v1, LW5/a;->o:Ljava/util/List;
    ...
    iput-object v0, v1, LW5/a;->o:Ljava/util/List;

    :cond_5
    iget-object v0, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;

    iget-object v2, v1, LW5/a;->o:Ljava/util/List;
    ...
    iget-object v2, v1, LW5/a;->l:Ljava/util/List;
    ...
    iget-object v2, v1, LW5/a;->m:Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3, v1, p1}, LW5/d;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;LW5/d$a;LW5/a;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V

    iput-object v0, p1, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;->u:LW5/d;

    return-object v0
.end method

.method public final o()LW5/d;
    .locals 6
    ...
    sget-object v4, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->DONT_DESTROY_ON_LOAD:LUc/b;
    ...
    new-instance v3, LV5/c$b;

    invoke-direct {v3, p0}, LV5/c$b;-><init>(LV5/c;)V
    ...
    invoke-direct {v3, p0}, LV5/c$c;-><init>(LV5/c;)V
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->TAG:LUc/b;

    invoke-static {v3}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->l(LUc/b;)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, LV5/a;->e:Landroid/app/Activity;

    invoke-virtual {v2, v3, v4}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->P0(Ljava/lang/String;Landroid/content/Context;)LW5/b;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->CHANGING_META_ID:LUc/b;
...
.method public final p()LW5/d;
    ...
    sget-object v4, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->RECT:LUc/b;

    invoke-static {v4}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->l(LUc/b;)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    invoke-direct {v1, v4, v3, v5}, LW5/a;-><init>(Ljava/lang/String;ZLcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;)V
    ...
    sget-object v4, LW5/d$a;->Component:LW5/d$a;

    invoke-direct {v0, v3, v4, v1, v2}, LW5/d;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;LW5/d$a;LW5/a;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V
    ...
    sget-object v1, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->TRANSFORM:LUc/b;

    invoke-static {v1}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->l(LUc/b;)Ljava/lang/String;

    move-result-object v1

    iget-object v4, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    invoke-direct {v0, v1, v3, v4}, LW5/a;-><init>(Ljava/lang/String;ZLcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/InspectorEditor;)V

    iget-object v1, p0, LV5/c;->h:Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    iput-object v1, v0, LW5/a;->o:Ljava/util/List;
    ...
    invoke-direct {v1, v3, v4, v0, v2}, LW5/d;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;LW5/d$a;LW5/a;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V
...
.method public s(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V
    ...
    new-instance v0, LV5/c$h;

    invoke-direct {v0, p0, p1}, LV5/c$h;-><init>(LV5/c;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)V
...
.method public t(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
    ...
    iget-object v0, p0, LV5/a;->a:Landroid/widget/LinearLayout;
...
.method public final v()V
    ...
    invoke-virtual {v3, v1}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->V(I)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;
    ...
    :cond_0
    invoke-virtual {p0, v3}, LV5/c;->n(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)LW5/d;

    move-result-object v3

    iget-object v4, v3, LW5/d;->d:LW5/a;

    new-instance v5, LV5/c$o;

    invoke-direct {v5, p0}, LV5/c$o;-><init>(LV5/c;)V

    iput-object v5, v4, LW5/a;->h:LX5/g;
    ...
    :cond_2
    invoke-virtual {p0}, LV5/c;->q()Z

    move-result v1

    if-nez v1, :cond_3

    invoke-virtual {p0}, LV5/c;->p()LW5/d;
    ...
    invoke-virtual {p0}, LV5/c;->o()LW5/d;
    ...
    invoke-virtual {v1, v2}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->V(I)Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;
    ...
    :cond_4
    invoke-virtual {p0, v1}, LV5/c;->n(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;)LW5/d;
    ...
    :cond_9
    invoke-virtual {p0}, LV5/c;->m()LW5/d;
    ...
    iget-object v2, p0, LV5/a;->e:Landroid/app/Activity;

    new-instance v3, LV5/c$p;

    invoke-direct {v3, p0}, LV5/c$p;-><init>(LV5/c;)V

    invoke-direct {v1, v0, v2, v3}, LW5/c;-><init>(Ljava/util/List;Landroid/content/Context;LW5/j;)V

    iput-object v1, p0, LV5/c;->g:LW5/c;

    iget-object v0, p0, LV5/a;->d:Landroidx/recyclerview/widget/RecyclerView;

    new-instance v1, LV5/c$q;

    iget-object v2, p0, LV5/a;->e:Landroid/app/Activity;

    invoke-direct {v1, p0, v2}, LV5/c$q;-><init>(LV5/c;Landroid/content/Context;)V
...
.method public final x()V
    ...
    iget-object v0, p0, LV5/a;->c:Landroid/view/View;

    const/16 v1, 0x8

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, LV5/a;->b:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;->i1()Z
    ...
    iget-object v0, p0, LV5/a;->f:Landroid/view/LayoutInflater;
    ...
    iget-object v2, p0, LV5/a;->a:Landroid/widget/LinearLayout;
    ...
    new-instance v4, LV5/c$i;

    invoke-direct {v4, p0, v3}, LV5/c$i;-><init>(LV5/c;Lcom/google/android/material/textfield/TextInputEditText;)V
    ...
    new-instance v4, LV5/c$j;

    invoke-direct {v4, p0, v1}, LV5/c$j;-><init>(LV5/c;Landroid/view/View;)V
    ...
    new-instance v1, LV5/c$k;

    invoke-direct {v1, p0}, LV5/c$k;-><init>(LV5/c;)V
    ...
    new-instance v1, LV5/c$l;

    invoke-direct {v1, p0}, LV5/c$l;-><init>(LV5/c;)V
    ...
    new-instance v2, LV5/c$m;

    invoke-direct {v2, p0, v1}, LV5/c$m;-><init>(LV5/c;Lcom/google/android/material/textfield/TextInputEditText;)V
    ...
    new-instance v2, LV5/c$n;

    invoke-direct {v2, p0, v0}, LV5/c$n;-><init>(LV5/c;Landroid/view/View;)V

    invoke-virtual {v1, v2}, Landroid/view/View;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    :goto_0
    invoke-virtual {p0}, LV5/c;->w()V
