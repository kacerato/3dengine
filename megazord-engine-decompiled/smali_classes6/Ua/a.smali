...
# static fields
.field public static final i:Ljava/lang/String; = "TraceRay"
...
.method public constructor <init>()V
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_POSITION:LUc/b;
    ...
    sget-object v4, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_DIRECTION:LUc/b;
    ...
    invoke-direct {v4, v6, v5}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;-><init>(Ljava/lang/String;Lya/H;)V

    sget-object v7, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_DISTANCE:LUc/b;

    invoke-static {v7}, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang;->l(LUc/b;)Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v4, v8}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;->c(Ljava/lang/String;)Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    move-result-object v4

    filled-new-array {v1, v3, v4}, [Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    move-result-object v1

    iput-object v1, v0, LUa/a;->g:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    new-instance v1, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    sget-object v3, Lya/H;->BRANCH:Lya/H;

    const-string v4, "On Hit"

    invoke-direct {v1, v4, v3}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;-><init>(Ljava/lang/String;Lya/H;)V

    sget-object v4, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_ON_HIT:LUc/b;
    ...
    const-string v4, "No Hit"

    invoke-direct {v1, v4, v3}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;-><init>(Ljava/lang/String;Lya/H;)V

    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_NO_HIT:LUc/b;
    ...
    sget-object v3, Lya/H;->GAME_OBJECT:Lya/H;

    const-string v4, "Object"

    invoke-direct {v1, v4, v3}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;-><init>(Ljava/lang/String;Lya/H;)V

    sget-object v4, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_OBJECT:LUc/b;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_COLLIDER_OBJECT:LUc/b;
    ...
    const-string v3, "Collider"

    sget-object v4, Lya/H;->COMPONENT_COLLIDER:Lya/H;

    invoke-direct {v1, v3, v4}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;-><init>(Ljava/lang/String;Lya/H;)V

    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_COLLIDER:LUc/b;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_POINT:LUc/b;
    ...
    sget-object v3, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_FACE_NORMAL:LUc/b;
    ...
    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_NORMAL:LUc/b;
    ...
    invoke-direct {v1, v6, v5}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;-><init>(Ljava/lang/String;Lya/H;)V
    ...
    sget-object v2, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_SLOT_UV_COORD:LUc/b;
    ...
    filled-new-array/range {v8 .. v17}, [Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    move-result-object v1

    iput-object v1, v0, LUa/a;->h:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    const-string v1, "TraceRay"
...
.method public static H0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
    .locals 0
...
.method public static I0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public F()[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;
    ...
    iget-object v0, p0, LUa/a;->g:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;
...
.method public final G0()V
    ...
    iget-object v0, p0, LUa/a;->h:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;
...
.method public final J0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {p0, v0}, LUa/a;->L0(I)Z
    ...
    invoke-virtual {p1, v1, v1, v0}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->T1(FFF)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;

    :goto_1
    return-void

    :cond_2
    iget-object v1, p0, LUa/a;->g:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;
    ...
    invoke-static {v0, p1}, Lya/m;->o0(Ljava/lang/Object;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;

    return-void
.end method

.method public final K0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public final L0(I)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeNode;->D(I)Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeInputDefault;
    ...
    invoke-virtual {v0, v3, p1}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeData;->Q(Ljava/lang/String;I)Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeNodeConnection;
...
.method public m0()V
    ...
    :try_start_2
    invoke-virtual {p0, v2}, LUa/a;->K0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V

    invoke-virtual {p0, v0}, LUa/a;->J0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)V

    iget-object v3, p0, LUa/a;->g:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;
    ...
    :try_start_3
    iput-object v2, v5, Lsa/d;->b:Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;

    iput-object v0, v5, Lsa/d;->c:Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;

    const-class v6, Lsa/c;
    ...
    :try_start_4
    iput-object v5, v6, Lsa/c;->b:Lsa/d;

    iput v3, v6, Lsa/c;->c:F

    iput-object v1, v6, Lsa/c;->d:Lcom/itsmagic/engine/Engines/Engine/Settings/Physics/Layer;

    sget-object v3, LUa/a;->j:Lsa/e;

    const/4 v7, 0x1

    invoke-virtual {v3, v6, v7}, Lsa/e;->L(Lsa/c;Z)Lsa/a;

    move-result-object v3

    if-nez v3, :cond_2

    invoke-virtual {p0}, LUa/a;->G0()V

    iget-object v1, p0, LUa/a;->h:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;
    ...
    invoke-virtual {p0, v2}, Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeNode;->q0(Ljava/lang/Object;)V
    ...
    :cond_2
    :try_start_5
    iget-object v7, p0, LUa/a;->h:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    aget-object v4, v7, v4

    invoke-virtual {v3}, Lsa/a;->getGameObject()Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    iget-object v4, p0, LUa/a;->h:[Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeSlot;

    const/4 v7, 0x3

    aget-object v4, v4, v7

    invoke-virtual {v3}, Lsa/a;->r()Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;
    ...
    invoke-virtual {v3}, Lsa/a;->q()Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/Collider/Collider;
    ...
    invoke-static {v4}, LUa/a;->I0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    invoke-virtual {v3}, Lsa/a;->s()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    invoke-virtual {v3}, Lsa/a;->u()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    invoke-virtual {v3}, Lsa/a;->getDistance()F
    ...
    invoke-static {v3}, LUa/a;->H0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector2;
...
.method public x(Lcom/itsmagic/engine/Engines/Engine/NoCode/NoCodeData;)Ljava/lang/String;
    ...
    sget-object p1, Lcom/itsmagic/engine/Activities/Editor/Extensions/LanguageSystem/Lang$T;->NOCODE_TRACE_RAY:LUc/b;
