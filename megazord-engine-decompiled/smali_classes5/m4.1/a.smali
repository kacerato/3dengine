...
.method public static synthetic o1(Lm4/a;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lm4/a;->X:Ljava/util/List;

    return-object p0
.end method

.method public static synthetic p1(Lm4/a;Lcom/itsmagic/engine/Activities/Editor/Extensions/Settings/Base/a;)V
    .locals 0

    invoke-virtual {p0, p1}, Lm4/a;->s1(Lcom/itsmagic/engine/Activities/Editor/Extensions/Settings/Base/a;)V

    return-void
.end method

.method public static synthetic q1(Lm4/a;Ljava/util/List;)V
    .locals 0

    invoke-virtual {p0, p1}, Lm4/a;->u1(Ljava/util/List;)V
...
.method public B0()Landroid/view/View;
    ...
    invoke-direct {v1, p0}, Lm4/a$a;-><init>(Lm4/a;)V
    ...
    iput-object v1, p0, Lm4/a;->a0:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lm4/a;->Y:Landroid/widget/LinearLayout;
...
.method public m1()V
    ...
    iget-object v0, p0, Lm4/a;->b0:Ljava/lang/String;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lm4/a;->Z:LX7/l;
    ...
    :goto_0
    iget-object v1, p0, Lm4/a;->Z:LX7/l;
    ...
    iget-object v3, p0, Lm4/a;->b0:Ljava/lang/String;
    ...
    iput-object v0, p0, Lm4/a;->b0:Ljava/lang/String;
...
.method public r1(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lm4/a;->b0:Ljava/lang/String;

    return-void
.end method

.method public final s1(Lcom/itsmagic/engine/Activities/Editor/Extensions/Settings/Base/a;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object v0, p0, Lm4/a;->a0:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v0}, Lm4/a;->u1(Ljava/util/List;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lm4/a;->Y:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v0, p0, p1}, Lm4/a$c;-><init>(Lm4/a;Lcom/itsmagic/engine/Activities/Editor/Extensions/Settings/Base/a;)V

    invoke-virtual {p1, v0}, Lcom/itsmagic/engine/Activities/Editor/Extensions/Settings/Base/a;->C(Lm4/b;)V
...
.method public t1(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lm4/a;->X:Ljava/util/List;
    ...
    invoke-virtual {v2, v0}, LX7/i;->q(I)V

    iget-object v2, v2, LX7/i;->f:LX7/h;

    iput-boolean v4, v2, LX7/h;->c:Z
...
.method public final u1(Ljava/util/List;)V
    ...
    iget-object v2, p0, Lm4/a;->Y:Landroid/widget/LinearLayout;
    ...
    invoke-static {v2, v3, v5, v0, v4}, LW5/h;->y(Landroid/widget/LinearLayout;Landroid/view/LayoutInflater;LW5/b;ILandroid/content/Context;)V
    ...
    iget-object v3, p0, Lm4/a;->Y:Landroid/widget/LinearLayout;
    ...
    new-instance v8, Lm4/a$d;

    invoke-direct {v8, p0, p1}, Lm4/a$d;-><init>(Lm4/a;Ljava/util/List;)V
