...
# direct methods
.method public static final a(LVd/b;Landroidx/lifecycle/Lifecycle;Ljava/lang/String;F)V
    .locals 1
    .param p0    # LVd/b;
    ...
    :goto_0
    invoke-static {p0, p1, p2, p3}, LYd/g;->b(LVd/b;ZLjava/lang/String;F)V

    return-void
.end method

.method public static final synthetic b(LVd/b;ZLjava/lang/String;F)V
    .locals 1
    .param p0    # LVd/b;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p0, p2, p3}, LVd/b;->f(Ljava/lang/String;F)V

    goto :goto_0

    :cond_0
    invoke-interface {p0, p2, p3}, LVd/b;->c(Ljava/lang/String;F)V
