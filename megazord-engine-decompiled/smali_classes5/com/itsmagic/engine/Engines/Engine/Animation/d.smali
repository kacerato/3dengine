...
.method public constructor <init>(Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationData;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->m:Lye/V;
    ...
    invoke-virtual {p1}, Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationData;->w()I
...
.method public B()LJAVARuntime/Animation;
    .locals 1
...
.method public final C()V
    ...
    invoke-virtual {v0}, Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationData;->v()I
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->w()V
...
.method public q(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Ld9/b;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {p0, p1, v0}, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->r(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)Ld9/b;
...
.method public r(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)Ld9/b;
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p1, v0, p2}, Ld9/a;->l(Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationData;ILcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)Ld9/b;
    ...
    invoke-virtual {p1, p2}, Ld9/b;->f(Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationMask;)V
    ...
    invoke-virtual {v0}, Ld9/c;->j()LUc/b;

    move-result-object v1

    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->m:Lye/V;
    ...
    invoke-virtual {v2, v3, v4}, Lye/V;->J(J)Z
    ...
    invoke-virtual {v2, v3, v4}, Lye/V;->s(J)I

    move-result v2

    invoke-virtual {v0}, Ld9/c;->m()I
    ...
    invoke-virtual {v0, v2}, Ld9/c;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4, v0}, Lye/V;->fa(JI)I
    ...
    invoke-virtual {p0}, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->C()V
...
.method public u()Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationData;
    .locals 1
...
.method public v()Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationMask;
    .locals 1
...
.method public w()V
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->m:Lye/V;
...
.method public x(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;ILd9/e;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->y(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;ILd9/e;Lcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)V

    return-void
.end method

.method public y(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;ILd9/e;Lcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {v0, p2, p4}, Ld9/a;->l(Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationData;ILcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)Ld9/b;

    move-result-object p2

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/Animation/d;->o:Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationMask;

    invoke-virtual {p2, v0}, Ld9/b;->f(Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationMask;)V

    invoke-static {p2, p1, p3, p4}, Ld9/a;->e(Ld9/b;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Ld9/e;Lcom/itsmagic/engine/Engines/Engine/JavaPool/MiniJP;)Z
...
.method public z(Lcom/itsmagic/engine/Engines/Engine/Animation/AnimationMask;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
