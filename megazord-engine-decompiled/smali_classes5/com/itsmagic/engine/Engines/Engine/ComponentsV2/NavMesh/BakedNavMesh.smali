...
.method public static synthetic access$1200(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;LEi/v;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->saveNM(LEi/v;II)V

    return-void
.end method

.method public static synthetic access$1300(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;LEi/v;II)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->createGizmo(LEi/v;II)V

    return-void
.end method

.method public static synthetic access$1402(Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;LEi/v;)LEi/v;
    .locals 0

    iput-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->G:LEi/v;
...
.method private createGizmo(LEi/v;II)V
    .locals 11
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p1, v0}, LEi/v;->I(I)LEi/s;
    ...
    iget-object v3, v2, LEi/q;->c:[LEi/G;
    ...
    :goto_1
    iget-object v4, v2, LEi/q;->c:[LEi/G;
    ...
    invoke-virtual {v0, p3}, Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;->j0(I)V
    ...
    invoke-virtual {p1, v2}, LEi/v;->I(I)LEi/s;
    ...
    iget-object v4, v3, LEi/q;->c:[LEi/G;
    ...
    :goto_3
    iget-object v5, v3, LEi/q;->c:[LEi/G;
    ...
    iget-object v9, v3, LEi/q;->b:[F

    mul-int/lit8 v8, v8, 0x3

    aget v9, v9, v8

    invoke-virtual {v0, v9}, Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;->l0(F)V
    ...
    invoke-virtual {v0, v8}, Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;->l0(F)V
    ...
    invoke-virtual {p1, p2, p2}, Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;->l0(II)V
    ...
    invoke-virtual {p1, p3}, Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;->c0(I)V
    ...
    invoke-virtual {p2, v0}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->w2(Lcom/itsmagic/engine/Engines/Native/Base/NativeFloatBuffer;)V

    invoke-virtual {p2, p1}, Lcom/itsmagic/engine/Engines/Engine/Vertex/Vertex;->o2(Lcom/itsmagic/engine/Engines/Native/Base/NativeIntBuffer;)V
...
.method private getPolyCenter(LEi/v;J)[F
    .locals 9
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p1, p2, p3}, LEi/v;->J(J)LEi/O;

    move-result-object p1

    invoke-virtual {p1}, LEi/O;->j()Z
...
.method private loadFile()V
    ...
    invoke-static {v0}, Lp8/a;->o(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-virtual {v1, v0, v2}, LKi/e;->c(Ljava/io/InputStream;I)LEi/v;

    move-result-object v0

    iput-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->G:LEi/v;

    if-nez v0, :cond_0

    invoke-virtual {v0}, LEi/v;->C()LEi/y;
...
.method private saveNM(LEi/v;II)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :try_start_1
    invoke-virtual {p1}, LEi/v;->C()LEi/y;

    move-result-object v0

    iput p2, v0, LEi/y;->d:I

    iput p3, v0, LEi/y;->e:I

    new-instance p2, LKi/g;

    invoke-direct {p2}, LKi/g;-><init>()V

    sget-object p3, Ljava/nio/ByteOrder;->LITTLE_ENDIAN:Ljava/nio/ByteOrder;

    const/4 v0, 0x1

    invoke-virtual {p2, v1, p1, p3, v0}, LKi/g;->h(Ljava/io/OutputStream;LEi/v;Ljava/nio/ByteOrder;Z)V
    :try_end_1
...
.method public findDirection(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
    ...
    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->G:LEi/v;
    ...
    invoke-direct {v2, v0, v3}, LEi/A;-><init>(LEi/v;I)V
    ...
    invoke-virtual {p1, p2}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->j0(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)F
    ...
    invoke-virtual {p1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->L2()[F

    move-result-object v3

    invoke-virtual {p2}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->L2()[F

    move-result-object v6

    invoke-virtual {v2, v3, v0, v7}, LEi/A;->j([F[FLEi/L;)LEi/O;

    move-result-object p2

    invoke-virtual {v2, v6, v0, v7}, LEi/A;->j([F[FLEi/L;)LEi/O;
    ...
    :cond_2
    iget-object v3, p2, LEi/O;->a:Ljava/lang/Object;

    check-cast v3, LEi/k;

    invoke-virtual {v3}, LEi/k;->b()J
    ...
    invoke-virtual {v0}, LEi/k;->b()J

    move-result-wide v8

    iget-object v0, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->G:LEi/v;

    invoke-virtual {v0, v3, v4}, LEi/v;->S(J)Z
    ...
    invoke-virtual {v0, v8, v9}, LEi/v;->S(J)Z
    ...
    invoke-virtual {p2}, LEi/k;->a()[F

    move-result-object v5

    invoke-virtual/range {v2 .. v7}, LEi/A;->L(J[F[FLEi/L;)LEi/O;
    ...
    invoke-virtual {p1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;->C1()Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;
...
.method public findEntirePath(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lxa/a;
    .locals 12
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iget-object v2, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->G:LEi/v;

    iget v3, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->maxPathFails:I

    invoke-direct {v0, v2, v3}, LEi/A;-><init>(LEi/v;I)V
    ...
    invoke-virtual {v0, v10, p1, v9}, LEi/A;->j([F[FLEi/L;)LEi/O;

    move-result-object p2

    invoke-virtual {v0, v11, p1, v9}, LEi/A;->j([F[FLEi/L;)LEi/O;
    ...
    invoke-virtual {p1}, LEi/k;->b()J

    move-result-wide v5

    iget-object p1, p0, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->G:LEi/v;

    invoke-virtual {p1, v3, v4}, LEi/v;->S(J)Z
    ...
    invoke-virtual {p1, v5, v6}, LEi/v;->S(J)Z
    ...
    invoke-virtual/range {v2 .. v9}, LEi/A;->k(JJ[F[FLEi/L;)LEi/O;
    ...
    invoke-virtual/range {v2 .. v7}, LEi/A;->t([F[FLjava/util/List;II)LEi/O;
    ...
    invoke-virtual {v1}, LEi/S;->b()[F

    move-result-object v1

    invoke-direct {v2, v1}, Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;-><init>([F)V

    invoke-virtual {p2, v2}, Lxa/a;->a(Lcom/itsmagic/engine/Engines/Engine/Vector/Vector3;)Lxa/a;
...
.method public getInspectorEntries(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {p1, v2, v3, v4}, LW5/b;-><init>(LX5/b;Ljava/lang/String;LW5/b$a;)V
    ...
    invoke-direct {p1, v2, v5, v3, v4}, LW5/b;-><init>(LX5/h;Ljava/lang/String;LW5/b$a;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v2, v4, v3}, LW5/b;-><init>(LX5/h;Ljava/lang/String;LW5/b$a;)V
    ...
    invoke-virtual {p1, v1, p0, v2, v4}, LW5/b;->d(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Animation/c;)LW5/b;
    ...
    invoke-direct {p1, v2, v5, v4}, LW5/b;-><init>(LX5/h;Ljava/lang/String;LW5/b$a;)V
    ...
    invoke-virtual {p1, v1, p0, v2, v5}, LW5/b;->d(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/Components/Component;Ljava/lang/String;Lcom/itsmagic/engine/Engines/Engine/Animation/c;)LW5/b;
    ...
    invoke-direct {p1, v2, v5, v3}, LW5/b;-><init>(LX5/h;Ljava/lang/String;LW5/b$a;)V
...
.method public preUpdate(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Z)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/itsmagic/engine/Engines/Engine/ComponentsV2/NavMesh/BakedNavMesh;->createGizmo(LEi/v;II)V
