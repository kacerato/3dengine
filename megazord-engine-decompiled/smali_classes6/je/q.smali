...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lje/q;->a:Landroid/graphics/Paint;

    const/4 v0, -0x1

    iput v0, p0, Lje/q;->e:I

    iput v0, p0, Lje/q;->f:I

    invoke-static {p1}, Landroid/renderscript/RenderScript;->create(Landroid/content/Context;)Landroid/renderscript/RenderScript;

    move-result-object p1

    iput-object p1, p0, Lje/q;->b:Landroid/renderscript/RenderScript;
    ...
    iput-object p1, p0, Lje/q;->c:Landroid/renderscript/ScriptIntrinsicBlur;
...
.method public c(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    ...
    iget-object v1, p0, Lje/q;->a:Landroid/graphics/Paint;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lje/q;->c:Landroid/renderscript/ScriptIntrinsicBlur;

    invoke-virtual {v0}, Landroid/renderscript/BaseObj;->destroy()V

    iget-object v0, p0, Lje/q;->b:Landroid/renderscript/RenderScript;

    invoke-virtual {v0}, Landroid/renderscript/RenderScript;->destroy()V

    iget-object v0, p0, Lje/q;->d:Landroid/renderscript/Allocation;
...
.method public e(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1}, Lje/q;->f(Landroid/graphics/Bitmap;)Z

    move-result v1

    if-nez v1, :cond_1

    iget-object v1, p0, Lje/q;->d:Landroid/renderscript/Allocation;
    ...
    :cond_0
    iget-object v1, p0, Lje/q;->b:Landroid/renderscript/RenderScript;
    ...
    iput-object v1, p0, Lje/q;->d:Landroid/renderscript/Allocation;

    invoke-virtual {p1}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v1

    iput v1, p0, Lje/q;->e:I

    invoke-virtual {p1}, Landroid/graphics/Bitmap;->getHeight()I

    move-result v1

    iput v1, p0, Lje/q;->f:I

    :cond_1
    iget-object v1, p0, Lje/q;->c:Landroid/renderscript/ScriptIntrinsicBlur;

    invoke-virtual {v1, p2}, Landroid/renderscript/ScriptIntrinsicBlur;->setRadius(F)V

    iget-object p2, p0, Lje/q;->c:Landroid/renderscript/ScriptIntrinsicBlur;
    ...
    iget-object p2, p0, Lje/q;->d:Landroid/renderscript/Allocation;
