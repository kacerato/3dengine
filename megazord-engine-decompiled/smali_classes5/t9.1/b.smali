...
.method public static synthetic a(Ljava/util/List;Lt9/b$f;)Ljava/lang/Integer;
    .locals 0

    invoke-static {p0, p1}, Lt9/b;->e(Ljava/util/List;Lt9/b$f;)Ljava/lang/Integer;
...
.method public static b(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Landroid/content/Context;Lorg/luaj/vm2/Globals;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)Ljava/util/List;
    ...
    invoke-static {v5, v0, v1}, Lt9/b;->d(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Globals;)Ljava/util/List;
    ...
    check-cast v7, Lt9/b$f;

    invoke-virtual {v7}, Lt9/b$f;->b()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v7}, Lt9/b$f;->c()Lorg/luaj/vm2/LuaValue;

    move-result-object v9

    invoke-static {v9}, Lt9/b;->c(Lorg/luaj/vm2/LuaValue;)Ljava/lang/String;
    ...
    new-instance v11, Lh9/q;

    move-object/from16 v12, p4

    invoke-direct {v11, v12}, Lh9/q;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V

    invoke-static {}, Lh9/g;->b()[Lh9/l;
    ...
    iget-object v2, v0, Lh9/l;->a:Lh9/m;

    invoke-interface {v2}, Lh9/m;->getFullName()Ljava/lang/String;
    ...
    new-instance v3, Lt9/b$d;

    invoke-direct {v3, v9, v0, v7}, Lt9/b$d;-><init>(Lorg/luaj/vm2/LuaValue;Lh9/l;Lt9/b$f;)V
    :try_end_0
    ...
    :try_start_1
    invoke-interface {v2, v5, v3, v8, v11}, Lh9/m;->getInspector(Landroid/content/Context;Lh9/k;Ljava/lang/String;Lh9/q;)LW5/b;
    ...
    invoke-direct {v2, v1, v8, v7}, Lt9/b$c;-><init>(Lorg/luaj/vm2/Globals;Ljava/lang/String;Lt9/b$f;)V

    sget-object v3, LW5/b$a;->SLBoolean:LW5/b$a;

    invoke-direct {v0, v2, v8, v3}, LW5/b;-><init>(LX5/h;Ljava/lang/String;LW5/b$a;)V
    ...
    invoke-direct {v2, v1, v8, v7}, Lt9/b$b;-><init>(Lorg/luaj/vm2/Globals;Ljava/lang/String;Lt9/b$f;)V

    sget-object v3, LW5/b$a;->SLString:LW5/b$a;
    ...
    invoke-direct {v2, v1, v8, v7}, Lt9/b$a;-><init>(Lorg/luaj/vm2/Globals;Ljava/lang/String;Lt9/b$f;)V
...
.method public static d(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Globals;)Ljava/util/List;
    ...
    invoke-direct {p2, p0}, Lt9/a;-><init>(Ljava/util/List;)V
    ...
    invoke-virtual {v4, v2}, LUc/b;->p0(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_2

    new-instance v2, Lt9/b$f;

    invoke-virtual {v1}, Lorg/luaj/vm2/LuaValue;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-direct {v2, v3, p2}, Lt9/b$f;-><init>(Ljava/lang/String;Lorg/luaj/vm2/Globals;)V
...
.method public static synthetic e(Ljava/util/List;Lt9/b$f;)Ljava/lang/Integer;
    .locals 3
    ...
    invoke-static {p1}, Lt9/b$f;->a(Lt9/b$f;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, LUc/b;->p0(Ljava/lang/String;)Z
...
.method public static f(Ljava/util/List;Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lorg/luaj/vm2/Globals;)V
    ...
    invoke-static {p0, p2, p4}, Lt9/b;->d(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Globals;)Ljava/util/List;
    ...
    check-cast v1, Lt9/b$f;

    invoke-virtual {v1}, Lt9/b$f;->b()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1}, Lt9/b$f;->c()Lorg/luaj/vm2/LuaValue;

    move-result-object v1

    invoke-static {v1}, Lt9/b;->c(Lorg/luaj/vm2/LuaValue;)Ljava/lang/String;
    ...
    invoke-direct {v1, p3}, Lh9/q;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
    ...
    iget-object v8, v7, Lh9/l;->a:Lh9/m;

    invoke-interface {v8}, Lh9/m;->getFullName()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v7, v7, Lh9/l;->a:Lh9/m;

    invoke-interface {v7, v3, v1}, Lh9/m;->restore(Lcom/itsmagic/engine/Engines/Utils/Variable;Lh9/q;)Ljava/lang/Object;
...
.method public static g(Ljava/util/List;Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Globals;)V
    ...
    invoke-static {p0, p1, p2, v0, p3}, Lt9/b;->f(Ljava/util/List;Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lorg/luaj/vm2/Globals;)V
...
.method public static h(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lorg/luaj/vm2/Globals;)Ljava/util/List;
    ...
    invoke-static {v0, v3, v4}, Lt9/b;->d(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Globals;)Ljava/util/List;
    ...
    check-cast v0, Lt9/b$f;

    invoke-virtual {v0}, Lt9/b$f;->b()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v0}, Lt9/b$f;->c()Lorg/luaj/vm2/LuaValue;

    move-result-object v7

    invoke-static {v7}, Lt9/b;->c(Lorg/luaj/vm2/LuaValue;)Ljava/lang/String;
    ...
    new-instance v9, Lh9/q;

    move-object/from16 v10, p2

    invoke-direct {v9, v10}, Lh9/q;-><init>(Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;)V
    ...
    iget-object v15, v0, Lh9/l;->a:Lh9/m;

    invoke-interface {v15}, Lh9/m;->getFullName()Ljava/lang/String;
    ...
    invoke-interface {v15}, Lh9/m;->getCls()Ljava/lang/Class;
    ...
    iget-object v4, v0, Lh9/l;->a:Lh9/m;

    invoke-interface {v4, v6, v15, v9}, Lh9/m;->save(Ljava/lang/String;Ljava/lang/Object;Lh9/q;)Lcom/itsmagic/engine/Engines/Utils/Variable;

    move-result-object v13

    if-eqz v13, :cond_3

    iget-object v0, v0, Lh9/l;->a:Lh9/m;

    invoke-interface {v0}, Lh9/m;->getFullName()Ljava/lang/String;
...
.method public static i(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lorg/luaj/vm2/Globals;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v0, p2}, Lt9/b;->h(Ljava/util/List;Lorg/luaj/vm2/LuaValue;Lcom/itsmagic/engine/Engines/Engine/ObjectOriented/GameObject/GameObject;Lorg/luaj/vm2/Globals;)Ljava/util/List;
