...
.method public final e(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0, p1}, LA1/S;->f(Lcom/google/android/gms/common/api/Status;)V

    goto :goto_0

    :cond_1
    invoke-static {p2}, LA1/N;->b(Landroid/os/Parcel;)Ljava/util/ArrayList;

    move-result-object p1

    invoke-static {p2}, LA1/N;->c(Landroid/os/Parcel;)V

    invoke-interface {p0, p1}, LA1/S;->e0(Ljava/util/List;)V
