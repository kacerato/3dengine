...
# direct methods
.method public constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILv2/o;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lv2/o;
...
.method public static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    sget-object v1, LR1/a$o;->ql:[I

    invoke-virtual {p0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v1, LR1/a$o;->rl:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    sget v2, LR1/a$o;->tl:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v2

    sget v3, LR1/a$o;->sl:I

    invoke-virtual {p1, v3, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v3

    sget v4, LR1/a$o;->ul:I
    ...
    sget v1, LR1/a$o;->vl:I

    invoke-static {p0, p1, v1}, Ls2/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    sget v1, LR1/a$o;->Al:I

    invoke-static {p0, p1, v1}, Ls2/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v7

    sget v1, LR1/a$o;->yl:I

    invoke-static {p0, p1, v1}, Ls2/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v8

    sget v1, LR1/a$o;->zl:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v9

    sget v1, LR1/a$o;->wl:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    sget v2, LR1/a$o;->xl:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v0

    invoke-static {p0, v1, v0}, Lv2/o;->b(Landroid/content/Context;II)Lv2/o$b;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILv2/o;Landroid/graphics/Rect;)V
...
.method public f(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lv2/o;

    invoke-virtual {v0, v2}, Lv2/j;->setShapeAppearanceModel(Lv2/o;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lv2/o;

    invoke-virtual {v1, v2}, Lv2/j;->setShapeAppearanceModel(Lv2/o;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lv2/j;->n0(Landroid/content/res/ColorStateList;)V
